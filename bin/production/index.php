...
//define('SMS_URL', 'apidev.cd121.com/sms');
...
//金品url JINPING_URL
define('JINPIN_URL', 'http://jpapi.cd121.com:7082');

//define('SMS_URL', 'http://sms.cd121.com/mc-receiver-web/message/sendsms');

//define('PROXY_URL', '10.26.238.109:8080');
define('PROTOCOL', 'http://');

//经纪人平台 PC端URL
define('MLS_NAME', 'house.cd121.com');

//管理平台 PC端URL
define('MLS_ADMIN_NAME', 'house-admin.cd121.com');

//签约平台 PC端URL
define('MLS_SIGN_NAME', 'house-sign.cd121.com');

//对外接口API URL
define('MLS_API_NAME', 'house-api.cd121.com');

//JOBAPI URL
define('MLS_JOB_NAME', 'house-job.cd121.com');

//移动端API URL
define('MLS_MOBILE_NAME', 'house-mobile.cd121.com');

//静态资源URL
define('MLS_SOURCE_NAME', 'house-source.cd121.com');

//文件上传URL
define('MLS_FILE_SERVER_NAME', 'house-fileserver.cd121.com');

//java接口文件上传URL
define('JAVA_FILE_UPLOAD_URL', 'http://jpapi.cd121.com:7082/house/uploadPic');

//金融端URL
define('MLS_FINANCE_NAME', 'house-finance-api.cd121.com');
...
if (MLS_ADMIN_NAME == $_SERVER['SERVER_NAME']) {
  ...
  $app = 'mls_guli';
} elseif (MLS_NAME == $_SERVER['SERVER_NAME']) {
  $app = 'mls';
}
