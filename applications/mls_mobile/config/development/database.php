...
/**********************************公用主库 mls********************************/
//MLS公用主库
$db['db']['hostname'] = 'fang.mysql.com';
$db['db']['port'] = '3307';
$db['db']['username'] = 'llq_app_test';
$db['db']['password'] = 'Codi1234';
$db['db']['database'] = 'mls';
...
foreach ($open_city as $v) {
  $db['db_' . $v]['hostname'] = 'fang.mysql.com';
  $db['db_' . $v]['port'] = '3307';
  $db['db_' . $v]['username'] = 'llq_app_test';
  $db['db_' . $v]['password'] = 'Codi1234';
  ...
  //MLS城市
  $db['dbback_' . $v]['hostname'] = 'fang.mysql.com';
  $db['dbback_' . $v]['port'] = '3307';
  $db['dbback_' . $v]['username'] = 'llq_app_test';
  $db['dbback_' . $v]['password'] = 'Codi1234';
