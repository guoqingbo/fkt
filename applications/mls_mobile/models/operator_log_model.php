...
class Operator_log_model extends Operator_log_base_model
{
  ...
  {
    //查询字段
    $this->db_city->select("{$this->_tbl1}.*,{$this->_tbl2}.truename,{$this->_tbl3}.name AS agency_name,{$this->_tbl4}.name AS operator_name");
    ...
    $this->db_city->join($this->_tbl4, "{$this->_tbl1}.type_id = {$this->_tbl4}.id");
