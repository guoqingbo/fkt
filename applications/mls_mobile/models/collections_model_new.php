 ...
 * @author          angel_in_us
 */
class Collections_model_new extends MY_Model
{
  ...
  public function __construct()
  {
    ...
    $this->collect_set = 'collect_set';//采集设置表
  ...
  public function get_collect_set_num($id, $type)
  {
    $where = "broker_id = " . $id . " and type = " . "'$type'";
    $this->dbback_city->select('count(*) as num');
    $this->dbback_city->from('collect_set');
    $this->dbback_city->where($where);
    $result = $this->dbback_city->get()->row_array();
    return $result['num'];
  }
  ...
  public function get_collect_set_info($broker_id, $type)
  {
    ...
    $result = $this->get_data(array('form_name' => $this->collect_set, 'where' => $where), 'dbback_city');
    return $result;
  }
  ...
  {
    $result = $this->get_data(array('form_name' => $this->collect_set, 'where' => $post_param, 'select' => array('id')), 'dbback_city');
    return $result;
  }
  ...
  {
    if ($this->db_city->insert('collect_set', $param)) {
      return $this->db_city->insert_id();
    }
    return 0;
  }
  ...
  {
    $this->db_city->where('id', $id);
    $this->db_city->delete('collect_set');
    $num = $this->db_city->affected_rows();
    return $num;
  }
}
