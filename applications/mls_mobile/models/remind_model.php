...
class Remind_model extends MY_Model
{
   ...
   * @return  array
   */
  function get_remind($where = array(), $where_in, $like = array(), $offset = 0, $limit = 0, $database = 'db_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_remind_num($where = array(), $where_in = array(), $like = array(), $database = 'db_city')
  {
