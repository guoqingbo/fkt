...
class Rent_customer_brower_model extends MY_Model
{
   ...
   */
  public function get_brower_log($where = array(), $offset = 0, $pagesize = 0, $order_by = array(), $group_by = '', $database = 'db_city')
  {
  ...
  {
    $comm = $this->get_data(array('form_name' => $this->brower_rent_customer_log, 'where' => $where, 'select' => array('count(*) as num')), 'db_city');
    return $comm[0]['num'];
  }
