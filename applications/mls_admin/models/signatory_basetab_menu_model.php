 ...
 * @author          sun
 */
load_m("Purview_tab_menu_base_model");

class Signatory_basetab_menu_model extends Purview_tab_menu_base_model
{
  ...
  {
    parent::__construct();
    $this->_tbl1 = 'purview_base_tab';
    $this->_tbl2 = 'purview_module';
    $this->_tbl3 = 'purview_list';
  }
