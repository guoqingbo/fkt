 ...
 * @author          sun
 */
load_m("permission_secondtab_menu_base_model");

class permission_secondtab_menu_model extends permission_secondtab_menu_base_model
{
  ...
  {
    parent::__construct();
    $this->_tbl1 = 'permission_secondtab';
    $this->_tbl2 = 'permission_tab';
    $this->_tbl3 = 'permission_module';
  }
...
/* End of file permission_secondtab_menu_model.php */
/* Location: ./app/models/permission_secondtab_menu_model.php */
