...
define('WEB_AUTH', "esfdatacenter");

define('USER_SESSION_KEY', 'mls_admin_user');
...
define('FRAME_MODULE', MLS_ADMIN_URL . "/module");
define("FRAME_LOGIN", MLS_ADMIN_URL . "/login");
define("FRAME_LOGOUT", MLS_ADMIN_URL . "/login?submit_flag=logout");
define("FRAME_INDEX", MLS_ADMIN_URL . "/user");
define("FRAME_MAIN", MLS_ADMIN_URL . "/main");
