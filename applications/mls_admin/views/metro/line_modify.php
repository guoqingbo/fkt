							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   地铁线路名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="line_name" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['line_name']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
