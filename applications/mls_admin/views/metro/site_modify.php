							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   地铁站点名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="site_name" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $site_data['site_name']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                       所属线路：
                                       <select name="metro_id" class="form-control input-sm" aria-controls="dataTables-example">
                                           <?php
                                           foreach($all_metro_line as $k => $v){
                                           ?>
                                           <option value="<?php echo $v['id'];?>" <?php if($v['id']==$site_data['metro_id']){echo 'selected="selected"';}?>><?php echo $v['line_name'];?></option>
                                           <?php }?>
                                       </select>
									  </label>
									  </div>
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   排序:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="order" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $site_data['order']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                       ...
                                       <select name="is_show" class="form-control input-sm" aria-controls="dataTables-example">
                                           <option value="1"<?php if($site_data['is_show']=='1'){echo 'selected="selected"';}?>>有效</option>
                                           <option value="2"<?php if($site_data['is_show']!='1'){echo 'selected="selected"';}?>>无效</option>
                                       </select>
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   是否设为线路中心站台<font color="red">*</font>:
                                       <select name="line_center_point" class="form-control input-sm" aria-controls="dataTables-example">
                                           <option value="1"<?php if($site_data['line_center_point']=='1'){echo 'selected="selected"';}?>>是</option>
                                           <option value="2"<?php if($site_data['line_center_point']!='1'){echo 'selected="selected"';}?>>否</option>
                                       </select>
								...
								<div class="col-sm-6" style="width:100%">
										<div class="dataTables_length" id="dataTables-example_length">
										  <label>
										   ...
										   <input type="text" id="txtCity" value="<?php echo $site_data['site_name'];?>" aria-controls="dataTables-example" class="form-control input-sm " style="width:180px;display: inline-block;" >
											&nbsp;&nbsp;&nbsp;&nbsp;
											<span class="text1"><font color="red">*</font>经度:</span><input type="text" value="<?php echo $site_data['b_map_x'];?>" aria-controls="dataTables-example" class="form-control input-sm " style="width:90px;display: inline-block;"  name="b_map_x" id="b_map_x" value=<?php echo $site_data['b_map_x'];?>> <!--<input type="search" name="b_map_x" class="form-control input-sm" aria-controls="dataTables-example" value=""/>-->
											&nbsp;&nbsp;&nbsp;&nbsp;
											<span class="text1"><font color="red">*</font>纬度:</span><input type="text" value="<?php echo $site_data['b_map_y'];?>" aria-controls="dataTables-example" class="form-control input-sm " style="width:90px;display: inline-block;"  name="b_map_y" id="b_map_y" value=<?php echo $site_data['b_map_y'];?>><!--<input type="search" name="b_map_y" class="form-control input-sm" aria-controls="dataTables-example" value=""/>-->
											 &nbsp;&nbsp;
										  </label>
										 </div>
								</div>
								<div class="col-sm-6" style="width:100%;">
									...
									<script type="text/javascript">
										var lng = "<?php echo $site_data['b_map_x'] > 0 ? $site_data['b_map_x'] : $lng;?>";
										var lat = "<?php echo $site_data['b_map_y'] > 0 ? $site_data['b_map_y'] : $lat;?>";
										// 百度地图API功能
