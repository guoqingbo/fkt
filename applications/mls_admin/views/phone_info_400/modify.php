							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   绑定号码:&nbsp&nbsp<input type="search" name="phone" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $phone_info_data['phone']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                          备注:&nbsp&nbsp <font style="color:red;">如需绑定多个号码，以‘|’分隔开，例：13833333333|13822222222</font>
									  </label>
									  </div>
									  </div>
