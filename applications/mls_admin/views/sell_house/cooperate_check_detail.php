...
function submit(submit_flag,id){
    var cooperate_check = $('#cooperate_check').val();
	var data = {submit_flag:submit_flag,cooperate_check:cooperate_check}; 
	$.ajax({ 
		type: "POST", 
		url: "/sell_house/cooperate_check_detail/"+id, 
		data:data, 
		cache:false, 
		error:function(){ 
			alert("系统错误");
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6" style="width:100%">
												<div class="dataTables_length" id="dataTables-example_length">
                                                    <label>业主姓名：<?php echo $house_detail['owner']; ?></label>
                                                </div>
												<div class="dataTables_length" id="dataTables-example_length">
                                                    <label>联系电话：<?php echo $house_detail['telno1']; ?></label>
                                                </div>
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <?php if(is_full_array($pic_type_3)){?>
                                                    <label>委托协议书：
                                                        <?php 
                                                        foreach($pic_type_3 as $key => $value){
                                                        ?>
                                                        <img width="200" height="200" src="<?php echo $value; ?>" />
                                                        <?php
                                                        }  
                                                        ?>
                                                    </label>
                                                    <?php } ?>
                                                    <br>
                                                    <?php if(isset($pic_type_4) && !empty($pic_type_4)){?>
                                                    <label>身份证：<img width="200" height="200" src="<?php echo $pic_type_4; ?>" /></label>
                                                    <?php } ?>
                                                    <?php if(isset($pic_type_5) && !empty($pic_type_5)){?>
                                                    <label>房产证：<img width="200" height="200" src="<?php echo $pic_type_5; ?>" /></label>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="col-sm-6" style="width:100%">
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <label>操&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;作：</label>
                                                    <label>  
                                                        <select  class="form-control input-sm" style="width:168px" aria-controls="dataTables-example" name="cooperate_check" id="cooperate_check">
                                                            <option value="2" <?php if($house_detail['cooperate_check'] == 2){echo 'selected="selected"';}?>>待审核</option>
                                                            <option value="3" <?php if($house_detail['cooperate_check'] == 3){echo 'selected="selected"';}?>>审核通过</option>
                                                            <option value="4" <?php if($house_detail['cooperate_check'] == 4){echo 'selected="selected"';}?>>驳回</option>
                                                        </select>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6" style="width:100%">
												<div class="dataTables_length" id="dataTables-example_length">
													<a class="btn btn-primary" href="#" onclick="submit('modify',<?=$house_detail['id'];?>)">提交</a>
													<a class="btn btn-primary" href="/sell_house/cooperate_check">返回</a>
												</div>
											</div>							  
                                        </div>
                                    </div>
