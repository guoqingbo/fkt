                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
									...
									<?php if($val['is_check'] == 1){?>
										<a href='/seek_sell_review/edit_entrust_review/<?=$val['id']?>'>查看</a> | <a href='/seek_sell_review/edit_entrust/<?=$val['id']?>'>审核</a>
									<?php }else{?>
										<a href='/seek_sell_review/edit_entrust_review/<?=$val['id']?>'>查看</a>
									<?php }?>
									</td>
                                </tr>
                                <?php }}else{
