                            ...
                            <div class="table-responsive">
                                <form name="search_form" method="post" action="">
                                    ...
                                    <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                                        ...
                                        <div class="col-sm-6" style="width:100%">
											<div class="dataTables_length" id="dataTables-example_length">
												<label><span>状态:&nbsp;</span>  <?php switch($list['is_check']){case 1:echo "<font color='black'>待审核</font>";break;case 2:echo "<font color='green'>通过</font>";break;case 3:echo "<font color='red'>驳回</font>";break;}?> 
												</label>
											</div>
										</div>
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                <a class="btn btn-primary" href="/seek_sell_review/index">返回</a>
                                            </div>
                                        </div>							  
                                    </div>
                                </form>
