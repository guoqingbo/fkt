                        ...
                        <table id="dataTables-example" class="table table-striped table-bordered table-hover">
                            <thead>
                                 <tr>
                                    ...
                                    <th style="width:200px;text-align:center">小区名称</th>
                                    <th style="width:75px;text-align:center">面积(㎡)</th>
                                    <th style="width:90px;text-align:center">期望售价(万元)</th>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><?php switch($val['is_check']){
									case 1:echo "<a href='/entrust_sell_review/edit_entrust_review/".$val['id']."'>查看</a> | <a href='/entrust_sell_review/edit_entrust/".$val['id']."'>审核</a>";break;
									case 2:echo "<a href='/entrust_sell_review/edit_entrust_review/".$val['id']."'>查看</a>";break;
									case 3:echo "<a href='/entrust_sell_review/edit_entrust_review/".$val['id']."'>查看</a>";break;}?></td>
                                </tr>
                                <?php }}else{
