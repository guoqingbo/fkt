...
$(function() {
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">出租合作订单</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                                ...
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    ...
                                                    <label>
                                                        <div class="dataTables_length" id="dataTables-example_length">
                                                            ...
                                                            <input class="btn btn-primary" type="submit" value="查询">&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="button" onclick="javascript:location.href = '/cooperate_order/rent/'" value="重置">
                                                        </div>
                                                    </label>
													<label>
                                                        <div class="dataTables_length" id="dataTables-example_length">
                                                            &nbsp;&nbsp;<a class="btn btn-primary" href='/cooperate_order/exportReport/1/<?php if(isset($where_cond['order_sn']) || isset($where_cond['broker_name_a']) ||  isset($where_cond['company_id']) || isset($where_cond['agency_id']) || isset($where_cond['esta'])|| (isset($_POST['time_e']) && isset($_POST['time_s']))){?><?php echo '?';?><?php }?>
														<?php
