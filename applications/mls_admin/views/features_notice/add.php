                                    ...
                                    <div class="row">
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <input type="hidden" name="notice_upload_file_1" id="notice_upload_file_1"/>
                                                <input type="hidden" name="notice_upload_file_2" id="notice_upload_file_2"/>
                                                <div>
                                                    <b>标题：</b><input type="text" name="title" value="" style="width:500px;">
                                                </div>
                                                <br>
                                                <div>
                                                    <b>作者：</b><input type="text" name="author_name" value="<?php echo $this_user_name; ?>" >
                                                </div>
                                                <br>
                                                <div>
                                                    <b>内&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;容：</b>
                                                ...
                                                <div>
                                                    <textarea name="content" id="content" cols="100" rows="4" style="visibility:hidden;"></textarea>
                                                </div>
                                                <div>
                                                    <label>
                                                    上传图片：
                                                    ...
                                                    <label>
                                                        <form name="fileform_photo" id="fileform_photo" action="/features_notice/upload_photo" enctype="multipart/form-data" target="filepost_iframe" method="post">
                                                ...
                                                <div>
                                                    <b>关键词：</b><input type="text" name="key_word" value="" >
                                                </div>
                                                <br>
                                                <div>
    ...
    <script>
        $(function(){
            $("#btn-save").click(function(){
                ...
                $.post(
                    "<?php echo MLS_ADMIN_URL;?>/features_notice/add_notice",
                    {title:title,content:content,author_name:author_name,key_word:key_word,notice_upload_file_1:notice_upload_file_1,notice_upload_file_2:notice_upload_file_2},
                    function(data){
                        if(data.status == 1){
                            alert('新增成功！');
