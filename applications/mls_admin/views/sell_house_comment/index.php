                        ...
                        <table id="dataTables-example" class="table table-striped table-bordered table-hover">
                            <thead>
                                 <tr>
                                    ...
                                    <th style="width:450px;text-align:center">评论内容</th>
                            ...
                            <tbody>
                                ...
                                <?php }}else{
                                       echo "<tr class='gradeA'><td colspan=15 style='text-align:center;color:red;font-weight:bold;'>暂无您查询的出售评论数据~！</td></tr>";
                                }?>
                            </tbody>
                        </table>
                        <div class="row">
