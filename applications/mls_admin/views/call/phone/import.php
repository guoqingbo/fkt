...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:block;" >
    <div class="mod">
        <div class="up_m_b_tex">为保证顺利导入，请使用我们提供的标准模板，且勿对模板样式做任何删改。</br><a href="<?php echo MLS_SOURCE_URL;?>/xls/virtual_phone.xls" target="_blank">
                <img alt="" src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/page_white_excel.png">点击下载虚拟号码导入模板</a>
        </div>
        <div class="up_m_b_file clearfix">
            <form action="/call/phone/importExcel" enctype="multipart/form-data" target="new" method="post">
