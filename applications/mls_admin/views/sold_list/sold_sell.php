<?php require APPPATH.'views/header.php'; ?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">出售成交房源</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
							...
							<form name="search_form" method="post" action="" >
							  ...
							  <div class="row">
									...
									<div class="col-sm-6" style="width:20%">
									   ...
									   <input class="btn btn-primary" type="submit" value="查询">&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="button" onclick="javascript:location.href='/sell_house_sold/'" value="重置">
                               </form>
								</div>
										...
										if(isset($sold_list) && !empty($sold_list)){
											...
											<tr class="gradeA">
												...
												<td style="width:120px;">
													...
													<a href="<?php echo MLS_ADMIN_URL;?>/sell_house_sold/reward_real_price/<?php echo $value['id'];?>">价格真实奖励</a>
												</td>
											</tr>
										<?php }}else{echo "<tr class='gradeA'><td colspan=9 style='text-align:center;color:red;font-weight:bold;'>暂无您查询的二手房成交数据~！</td></tr>";}?>
                                    </tbody>
                                </table>
