...
<div id="wrapper">
    <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<div class="dataTables_length" id="dataTables-example_length">
                                                    <label>合同编号：<input type="text" value="<?php echo $success_applay['order_sn'] ?>" readonly/></label>
                                                </div>
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <label>甲乙双方：
                                                        <font style="color:red;">
							    甲方经纪人：姓名： <?php echo $success_applay['broker_name_a'] ?>
							    门店名：<?php echo $success_applay['agency_name_a'] ?>
							    <?php if($success_applay['agency_type_a'] == 1){
								    echo '[直营]';
							    }else if($success_applay['agency_type_a'] == 2){
								    echo '[加盟]';
							    }?>
							    公司名：<?php echo $success_applay['company_name_a'] ?>
							</font><br>
							<font style="color:red;">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
							    乙方经纪人：姓名：<?php echo $success_applay['broker_name_b'] ?>
							    门店名：<?php echo $success_applay['agency_name_b'] ?>
							    <?php if($success_applay['agency_type_b'] == 1){
								    echo '[直营]';
							    }else if($success_applay['agency_type_b'] == 2){
								    echo '[加盟]';
							    }?>
							    公司名：<?php echo $success_applay['company_name_b'] ?>
							</font>
                                                    </label>
                                                </div>
						<div class="dataTables_length" id="dataTables-example_length">
						...
						<div class="dataTables_length" id="dataTables-example_length">
						    ...
						    <a class="btn btn-primary" href="/cooperate_chushen/index">返回</a>
						</div>
					    </div>
                                        </div>
                                    </div>
        ...
        <?php } else if ($modifyResult == 'success') { ?>
            ...
            <a href="/cooperate_chushen/index" >点此返回</a>
        <?php } else { ?>
...
<?php if($modifyResult !== ''){?>
<script>
     setTimeout(function(){window.location.href='/cooperate_chushen/index';},2000);
</script>
<?php }?>
<script>
	$(function(){
