...
<style>
    #input{width:140px}
    #r_s_popUP {position: absolute;top: -40px; left:220px;display: none}
                        ...
                        <div class="table-responsive">
                            ...
                            <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                                ...
                                <div class="col-sm-6" style="width:100%">
                                    <div class="dataTables_length" id="dataTables-example_length">
                                        <label>
                                            本地赶集区属:&nbsp&nbsp&nbsp<input type="search" id ='input' class="form-control input-sm" aria-controls="dataTables-example" value="<?=$dist_mess['district_id']?>&nbsp&nbsp&nbsp&nbsp&nbsp<?=$dist_mess['district_name']?>" readOnly>
                                        </label>&nbsp&nbsp&nbsp&nbsp
                                        <label>
                                            本地赶集板块:&nbsp&nbsp&nbsp<input type="search" id ='input'class="form-control input-sm" aria-controls="dataTables-example" value="<?=$street_mess['street_id']?>&nbsp&nbsp&nbsp&nbsp&nbsp<?=$street_mess['street_name']?>" readOnly>
                                        ...
                                        <label>
                                            赶集区属:&nbsp&nbsp&nbsp&nbsp<input type="search"id ='input'class="form-control input-sm" aria-controls="dataTables-example" value="<?=$dist_mess['district_id']?>&nbsp&nbsp&nbsp&nbsp&nbsp<?=$dist_mess['district_name']?>" readOnly>
                                        </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <label>
                                            赶集板块:&nbsp&nbsp&nbsp
                                            <select id="gj_street" name = 'street' class="form-control input-sm" aria-controls="dataTables-example">
                                                <option value="0">请选择...</option>
                                                 <?php if(!empty($gj_street)&&$gj_street){
                                                 foreach ($gj_street as $value) {?>
                                                    <option value="<?=$value[0];?>&<?=$value[1];?>" <?php if($value[0]==$street_mess['street_id']){echo 'selected="selected"';}?> ><?=$value[0];?>&nbsp&nbsp&nbsp&nbsp&nbsp<?=$value[1];?></option>
                                                 <?php }}?>
                                            </select>
                                        </label>
                                    </div>
