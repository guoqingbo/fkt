...
<div id="wrapper">
    ...
    <form name="search_form" method="post" action="<?php echo MLS_ADMIN_URL;?>/buy_customer_info/add_info" >
    ...
    <div class="form-group">
        姓名：
        <input type="text" class="form-control" name="truename" placeholder="Enter name">
    </div>
    <?php if(is_array($conf_customer['sex']) && !empty($conf_customer['sex'])) { ?>
        <?php foreach($conf_customer['sex'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="sex" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    ...
    <div class="form-group" style="display: none;" id="tel_form2">
        <input type="text" class="form-control" name="telno[]">
    ...
    <div class="form-group" style="display: none;" id="tel_form3">
        <input type="text" class="form-control" name="telno[]">
    ...
    <?php if(is_array($conf_customer['job_type']) && !empty($conf_customer['job_type'])) { ?>
        <?php foreach($conf_customer['job_type'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="job_type" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['user_level']) && !empty($conf_customer['user_level'])) { ?>
        <?php foreach($conf_customer['user_level'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="user_level" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['age_group']) && !empty($conf_customer['age_group'])) { ?>
        <?php foreach($conf_customer['age_group'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="age_group" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br><br>
    ...
    <?php if(is_array($conf_customer['public_type']) && !empty($conf_customer['public_type'])) { ?>
        ...
        foreach($conf_customer['public_type'] as $key => $value)
        {
            ?>
            <label class="radio-inline">
                <input type="radio" name="public_type" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php
        }?>
    <?php } ?>
    ...
    户型：
    <div class="form-group">
        <input type="text" class="form-control" name="room_min">——<input type="text" class="form-control" name="room_max">室
    </div>
    <br>
    <!-------------------第七行----------------->
    面积：
    <div class="form-group">
        <input type="text" class="form-control" name="area_min">——<input type="text" class="form-control" name="area_max">平方米
    </div>
    价格：
    <div class="form-group">
        <input type="text" class="form-control" name="price_min">——<input type="text" class="form-control" name="price_max">万元
    </div>
    <br>
    <!-------------------第八行----------------->
    <div style="height:40px;">
        ...
        <div style="float: left;" id="box_dist1">
            <select class="form-control" name="dist_id[]" onchange ="get_street_by_id(this , 'street_id1')">
            ...
            <select class="form-control" name="street_id[]" id="street_id1">
        ...
        <div style="float: left; display: none;" id="box_dist2">
            <select class="form-control" name="dist_id[]" id="dist_id2" onchange ="get_street_by_id(this , 'street_id2')">
                <option value="0">请选择区属</option>
                <?php if( is_array($district_arr) && !empty($district_arr) ){ ?>
                    <?php foreach($district_arr as $key => $value){?>
                        <option value="<?php echo $value['id'];?>"><?php echo $value['district'];?></option>
            ...
            <select class="form-control" name="street_id[]" id="street_id2">
                <option value="0">请选择板块</option>
        ...
        <div style="float: left;display: none;" id="box_dist3">
            <select class="form-control" name="dist_id[]" id="dist_id3" onchange ="get_street_by_id(this , 'street_id3')">
                <option value="0">请选择区属</option>
                <?php if( is_array($district_arr) && !empty($district_arr) ){ ?>
                    <?php foreach($district_arr as $key => $value){?>
                        <option value="<?php echo $value['id'];?>"><?php echo $value['district'];?></option>
            ...
            <select class="form-control" name="street_id[]" id="street_id3">
                <option value="0">请选择板块</option>
    ...
    意向楼盘：
    <div class="form-group">
        <input type="text" class="form-control" name="cmt_name[]" id="block01" value="">
        <input type="hidden" class="form-control" name="cmt_id[]" value="">
        <a href="javascript:void(0)" class="iconfont addTel" id="btn_add_cmt1">&#xe608;</a>
    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="form-group" id="box_cmt1" style="display: none;">
        <input type="text" class="form-control" name="cmt_name[]" id="block02" value="">
        <input type="hidden" class="form-control" name="cmt_id[]" value="">
    ...
    <div class="form-group" id="box_cmt2" style="display: none;">
        <input type="text" class="form-control" name="cmt_name[]" id="block03" value="">
        <input type="hidden" class="form-control" name="cmt_id[]" value="">
    ...
    <?php if(is_array($conf_customer['forward']) && !empty($conf_customer['forward'])) { ?>
        <?php foreach($conf_customer['forward'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="forward" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['fitment']) && !empty($conf_customer['fitment'])) { ?>
        <?php foreach($conf_customer['fitment'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="fitment" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    楼层：
    <div class="form-group">
        <input type="text" class="form-control" name="floor_min" value="">——<input type="text" class="form-control" name="floor_max" value="">
    </div>
    <br>
    地段：
    <?php if(is_array($conf_customer['location']) && !empty($conf_customer['location'])) { ?>
        <?php foreach($conf_customer['location'] as $key => $value){ ?>
            <label class="checkbox-inline">
                <input type="checkbox" name="location" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['house_type']) && !empty($conf_customer['house_type'])) { ?>
        <?php foreach($conf_customer['house_type'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="house_type" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['property_type']) && !empty($conf_customer['property_type'])) { ?>
        <?php foreach($conf_customer['property_type'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio"  name="property_type" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['house_age']) && !empty($conf_customer['house_age'])) { ?>
        <?php foreach($conf_customer['house_age'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="house_age" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['payment']) && !empty($conf_customer['payment'])) { ?>
        <?php foreach($conf_customer['payment'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="payment" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    付佣方式：
    <?php if(is_array($conf_customer['pay_commission']) && !empty($conf_customer['pay_commission'])) { ?>
        <?php foreach($conf_customer['pay_commission'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="pay_commission" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['intent']) && !empty($conf_customer['intent'])) { ?>
        <?php foreach($conf_customer['intent'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="intent" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['deadline']) && !empty($conf_customer['deadline'])) { ?>
        <?php foreach($conf_customer['deadline'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="deadline" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    ...
    <?php if(is_array($conf_customer['infofrom']) && !empty($conf_customer['infofrom'])) { ?>
        <?php foreach($conf_customer['infofrom'] as $key => $value){ ?>
            <label class="radio-inline">
                <input type="radio" name="infofrom" value='<?php echo $key;?>'> <?php echo $value;?>
            </label>
        <?php } ?>
    <?php } ?>
    <br>
    <div class="form-group">
        委托时间：
        <input type="text" class="form-control" name="creattime" value="">(格式：1993-05-12)
    </div><br>
    备注：
    <textarea class="form-control" name="remark" rows="5" cols="100"></textarea>
    <br>

                                                <input class="btn btn-default" type="submit" value="修改客源信息">
