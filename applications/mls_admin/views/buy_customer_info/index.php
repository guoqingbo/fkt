                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <form name="search_form" method="post" action="<?php echo MLS_ADMIN_URL;?>/buy_customer_info/index" >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                总价：<input type="text" name='price_min' class="input w30" value='<?php echo $post_param['price_min'];?>' style="width:50px;">
                                                —
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px;">
                            ...
                            <tr>
                                ...
                                <th style="width:81px;">意向区属板块</th>
                                <th style="width:68px;">户型（室）</th>
                                <th style="width:68px;">面积（m²）</th>
                                <th style="width:68px;">价格（W）</th>
                            ...
                            <?php if (isset($customer_list) && !empty($customer_list)) {
                                foreach ($customer_list as $key => $value) { ?>
                                    <tr class="gradeA">
                                        ...
                                        <td>
                                            <?php echo floor($value['area_min'])==$value['area_min']?intval($value['area_min']):$value['area_min'];?>-<?php echo floor($value['area_max'])==$value['area_max']?intval($value['area_max']):$value['area_max'];?>
                                        </td>
                                        <td>
                                            <?php echo floor($value['price_min'])==$value['price_min']?intval($value['price_min']):$value['price_min'];?>-<?php echo floor($value['price_max'])==$value['price_max']?intval($value['price_max']):$value['price_max'];?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="<?php echo MLS_ADMIN_URL; ?>/buy_customer_info/modify/<?php echo $value['id']; ?>" >详情</a>
                                            <a href="<?php echo MLS_ADMIN_URL; ?>/buy_customer_info/follow/<?php echo $value['id']; ?>" >跟进</a>
                                            <a href="<?php echo MLS_ADMIN_URL; ?>/buy_customer_info/del_customer/<?php echo $value['id']; ?>">关联失效</a>
                                        </td>
                                    </tr>
                                <?php }} ?>
                            </tbody>
                        ...
                        <div class="row">
                            ...
                            <div style="color:blue;position:absolute;right:33px;">
                                <b>共查到<?php echo $total_count;?>条数据</b>
                            </div>
                        </div>
                    </div>
                </div>
