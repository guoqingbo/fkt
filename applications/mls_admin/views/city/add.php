						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                       ...
                                       省份<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="province" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   城市名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="cityname" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   城市拼音<font color="red">*</font>:<input type="search" name="spell" class="form-control input-sm" aria-controls="dataTables-example" value="">（对应相关数据库名）
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   排序:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="order" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
