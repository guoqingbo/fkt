							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  ...
									  <label>
									   省份<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="province" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['province']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   城市名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="cityname" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['cityname']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   城市拼音<font color="red">*</font>:<input type="search" name="spell" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['spell']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    ...
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                       ...
                                       <select name="status" class="form-control input-sm" aria-controls="dataTables-example">
                                           <option value="1"<?php if($city_data['status']=='1'){echo 'selected="selected"';}?>>有效</option>
                                           <option value="0"<?php if($city_data['status']=='0'){echo 'selected="selected"';}?>>无效</option>
                                       </select>
