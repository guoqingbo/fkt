                ...
                <div class="panel panel-default">
                                    ...
                                    <div class="dataTables_length" id="dataTables-example_length">
                                        ...
                                        <label>
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                <a class="btn btn-primary" href='<?php echo MLS_ADMIN_URL; ?>/signatory_basetab_menu/add/'>添加</a>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php
                                if (isset($signatory_basetab_menu) && !empty($signatory_basetab_menu)) {
                                    foreach ($signatory_basetab_menu as $key => $value) {
                                        ?>
                                        <tr class="gradeA">
                                            ...
                                            <td>
                                                <a href="<?php echo MLS_ADMIN_URL; ?>/signatory_basetab_menu/modify/<?php echo $value['id']; ?>" >修改</a>
                                                <a href="<?php echo MLS_ADMIN_URL; ?>/signatory_basetab_menu/del/<?php echo $value['id']; ?>" onclick="return checkdel()">删除</a>
                                                <a href="<?php echo MLS_ADMIN_URL; ?>/signatory_secondtab_menu/index/<?php echo $value['module_id']; ?>/<?php echo $value['id']; ?>">菜单功能</a>
                                            </td>
                                        </tr>
                                    <?php }
                                } ?>
...
<?php echo page_uri($page, $pages, MLS_ADMIN_URL . '/signatory_basetab_menu/index'); ?>
                                    </ul>
                                </div>
                            </div>
                        </div>
