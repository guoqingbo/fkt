                                    ...
                                    <div class="col-sm-6" style="width:100%">
                                        <div class="dataTables_length" id="dataTables-example_length">
                                            <label>
                                                ...
                                                板块名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="streetname" class="form-control input-sm" aria-controls="dataTables-example" value="">
                                            </label>
                                            <label>
                                                板块拼音<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="name_spell" class="form-control input-sm" aria-controls="dataTables-example" value="">
                                            </label>
                                            <label>
