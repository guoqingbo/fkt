                                        ...
                                        <div class="col-sm-6 type_3_price" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <label>
                                                    ...
                                                    预计佣金<font color="red">*</font>:<span id="commission_price_view"></span>元
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6" style="width:100%">
...
//    });
    ...
    $('#commission_ratio').keyup(function(){
        ...
        var result = price*$(this).val()*0.01
        $('#commission_price').val(result);
        $('#commission_price_view').html(result);
    });
