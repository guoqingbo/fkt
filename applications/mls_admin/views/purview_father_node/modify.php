							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   图标class:&nbsp&nbsp<input type="search" name="class_str" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $node['class_str']?>">
									  </label>
									  </div>
									  </div>
