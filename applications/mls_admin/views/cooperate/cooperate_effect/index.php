                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
						       <form name="search_form" method="post" action="<?=MLS_ADMIN_URL?>/cooperate_effect/index/1/1" >
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                   <ul class="pagination" style="margin:-8px 0;padding-left:20px">
								          <?php echo page_uri($page,$pages,MLS_ADMIN_URL.'/cooperate_effect/index/1/1/');?>
								    </ul>
                                </div>
                            </div>
...
function modify(id){
	...
	$.ajax({
        ...
        success: function(data){
			if(data='成功'){
				alert('操作成功');
				window.location.href="/cooperate_effect/index/1/1";
			}else{
				alert('操作失败');
			}
