            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div>
                            <div>
                             <span ><a href="<?=MLS_ADMIN_URL?>/cooperate_success/index/1/2" >出售公盘</a></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span ><a href="<?=MLS_ADMIN_URL?>/cooperate_success/index/2/2" >出租公盘</a></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span ><a href="<?=MLS_ADMIN_URL?>/cooperate_success/index/3/2">求购公客</a></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span ><a href="<?=MLS_ADMIN_URL?>/cooperate_success/index/4/2" >求租公客</a></span>
                        </div>
                        </div>
                        <div class="table-responsive">
						      <form name="search_form" method="post" action="<?=MLS_ADMIN_URL?>/cooperate_success/index/4/2" >
								...
								<tr>
								 ...
								 ?>
                                   ...
                                   <?php echo $house_info['price'];?>
                                    ...
                                    <th><?php echo date('Y-m-d H:i:s',$val['report_time']);?></th>
                                    <th>
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                   <ul class="pagination" style="margin:-8px 0;padding-left:20px">
								        <?php echo page_uri($page,$pages,MLS_ADMIN_URL.'/cooperate_success/index/4/2/');?>
								    </ul>
                                </div>
                            </div>
                        </div>
...
function modify(id){
	...
	$.ajax({
        type: 'post',
        url: '/cooperate_success/modify/',
        data:{id:id,status_modify:status_modify},
        success: function(data){
			if(data='成功'){
				alert('操作成功');
				window.location.href="/cooperate_success/index/4/2";
			}else{
				alert('操作失败');
			}
