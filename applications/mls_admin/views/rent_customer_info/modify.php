...
<div class="table-responsive">
   <form name="search_form" method="post" action="<?php echo MLS_ADMIN_URL;?>/rent_customer_info/modify_info" >
            ...
            <div class="row">
                <div class="col-sm-6" style="width:100%">
                    <div class="dataTables_length" id="dataTables-example_length">
                        ...
                        价格：
                        <div class="form-group">
                            <input type="text" class="form-control" name="price_min" value="<?php echo $customer_info['price_min'] ?>" disabled="disabled">——<input type="text" class="form-control" name="price_max" value="<?php echo $customer_info['price_max'] ?>" disabled="disabled">元/月
                        </div>
                        <br><br>
                        <!-------------------第八行----------------->
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="cmt_id[]" value="<?php echo $customer_info['cmt_id1'];?>" disabled="disabled">
                        ...
                        <div class="form-group" id="box_cmt1" <?php if(empty($customer_info['cmt_id2']) || $customer_info['cmt_id2'] == 0) { ?> style="display: none;" <?php } ?>>
                            ...
                            <input type="hidden" class="form-control" name="cmt_id[]" value="<?php echo $customer_info['cmt_id2'];?>" disabled="disabled">
                        ...
                        <div class="form-group" id="box_cmt2" <?php if(empty($customer_info['cmt_id3']) || $customer_info['cmt_id3'] == 0) { ?> style="display: none;" <?php } ?>>
                            ...
                            <input type="hidden" class="form-control" name="cmt_id[]" value="<?php echo $customer_info['cmt_id3'];?>" disabled="disabled">
                        ...
                        楼层：
                        <div class="form-group">
                            <input type="text" class="form-control" name="floor_min" value="<?php echo $customer_info['floor_min']?>" disabled="disabled">——<input type="text" class="form-control" name="floor_max" value="<?php echo $customer_info['floor_max'] ?>" disabled="disabled">
                        </div>
                        <br><br>
                        地段：
                        ...
                        <br><br>
                        期限：
                        <?php if(is_array($conf_customer['lease']) && !empty($conf_customer['lease'])) { ?>

                            <?php foreach($conf_customer['lease'] as $key => $value){ ?>
                                <label class="radio-inline">
                                    <input type="radio" <?php if($customer_info['deadline'] == $key) { ?> checked <?php } ?> name="lease" value='<?php echo $key;?>' disabled="disabled"> <?php echo $value;?>
                                </label>
                            <?php } ?>
							<label class="radio-inline">
                                <input type="radio" <?php if($customer_info['deadline'] == 0) { ?> checked <?php } ?> name="lease" value='' disabled="disabled"> 不限(成交为止)
                            </label>
    ...
    $(function(){
        $("#block01,#block02,#block03").autocomplete({
            source: function( request, response )
            {
                ...
                $.ajax({
                    url: "/rent_customer_info/get_cmtinfo_by_kw/",
                    type: "GET",
                    dataType: "JSON",
