...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">修改操作日志类型</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                ...
                                <form name="search_form" method="post" action="">
                                    <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                                            ...
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <label>
                                                    ...
                                                    <select name="module_id" class="form-control input-sm" aria-controls="dataTables-example">
                                                        ...
                                                        <option value="<?php echo $val['id'];?>" <?php if($val['id']==$operator_type['module_id']){echo "selected='selected'";} ?>><?php echo $val['name'];?></option>
                                                        <?php }?>
                                                    </select>
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <label>
                                                    操作名称:&nbsp&nbsp&nbsp&nbsp<input type="search" name="name" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $operator_type['name'] ?>">
                                                </label>
                                            </div>
                                        </div>
