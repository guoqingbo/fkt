							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   密码:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="password" name="password" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>									  
						        <div class="col-sm-6" style="width:100%">
								    ...
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                        ...
                                        <select name="am_cityid" aria-controls="dataTables-example" class="form-control input-sm" style="display:none;" id="am_cityid">
                                            <option value="<?php echo $city_arr['city_id']?>"><?php echo $city_arr['name']?></option>
                                        </select> 
									  </label>
									  </div>
									  </div>	
