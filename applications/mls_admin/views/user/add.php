							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   ...
									   用户名:&nbsp&nbsp&nbsp&nbsp<input type="search" name="username" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   ...
									   密码:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="password" name="password" class="form-control input-sm" aria-controls="dataTables-example" value="" autocomplete ="off">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   真实姓名:<input type="search" name="truename" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   联系方式:<input type="search" name="telno" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>									  
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   备注:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="message" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%; height:30px; line-height:30px;">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									    客户经理:&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type='radio' name='master' value='2' checked/>&nbsp;否&nbsp;
                                        <input type='radio' name='master' value='1'/>&nbsp;是&nbsp;
                                        <select name="am_cityid" aria-controls="dataTables-example" class="form-control input-sm" style="display:none;" id="am_cityid">
                                            <?php foreach($city_arr as $k=>$v){ ?>
                                            <option value="<?php echo $v['city_id']?>"><?php echo $v['name']?></option>
                                            <?php } ?>
                                        </select> 
									  </label>
									  </div>
