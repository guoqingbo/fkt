							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
								    ...
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   用户组:
                                                    ...
                                                    <label>&nbsp&nbsp <?php echo $user_group_data['city_name'];?>
                                                        <select name="user_group<?php echo $k;?>" aria-controls="dataTables-example" class="form-control input-sm">
                                                            ...
                                                            <?php foreach($user_group_data['user_group'] as $k=>$v){ ?>
								...
								<div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   密码:<input type="password" name="password" class="form-control input-sm" aria-controls="dataTables-example" value="">
									  </label>
									</div>
								</div>
						        <div class="col-sm-6" style="width:100%">
								    ...
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                        ...
                                        <select name="am_cityid" aria-controls="dataTables-example" class="form-control input-sm" style="<?php if ($user['am_cityid'] == 0) {echo 'display:none;';} else {echo 'display:inline;';}?>" id="am_cityid">
                                            <option value="<?php echo $city_arr['city_id']?>" <?php if ($user['am_cityid'] == $city_arr['city_id']) {echo 'selected';}?>><?php echo $city_arr['name']?></option>
                                        </select> 
									  </label>
									  </div>
									  </div>	
