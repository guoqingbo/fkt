                                            ...
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                <label>
                                                    <div class="dataTables_length" id="dataTables-example_length">
                                                        ...
                                                        <input class="btn btn-primary" onclick="$('#search_form').attr('action', '/upload_house_excel/index/')" type="submit" value="查询">
                                                    </div>
                                                </label>
                                            </div>
                                         </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <?php if (isset($broker_info) && !empty($broker_info)) {
                                foreach ($broker_info as $key => $value) { ?>
                                    <tr class="gradeA">
                                        <td><a href="javascript:void(0);"><?php echo $value['broker_id']; ?></a></td>
                                        ...
                                        <td>
											<a onclick="openn_import_new('sell',<?php echo $value['broker_id']; ?>)" class="add_link" href='javascript:void(0);'>泰州出售房源导入</a> |
											<a onclick="openn_import_new('rent',<?php echo $value['broker_id']; ?>)" class="add_link" href='javascript:void(0);'>泰州出租房源导入</a> |
											<a onclick="openn_import_new('buy_customer',<?php echo $value['broker_id']; ?>)" class="add_link" href='javascript:void(0);'>泰州求购客源导入</a> |
											<a onclick="openn_import_new('rent_customer',<?php echo $value['broker_id']; ?>)" class="add_link" href='javascript:void(0);'>泰州求租客源导入</a>
                                        </td>
                                    </tr>
                            <?php }} ?>
                            </tbody>
                            ...
                            <div class="col-sm-6 clearfix" style="width:100%;">
                                ...
                                <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                    <ul class="pagination" style="margin:-8px 0;padding-left:20px">
                                        <?php echo page_uri($page,$pages,MLS_ADMIN_URL.'/upload_house_excel/');?>
                                    </ul>
                                </div>
                            </div>
                         </div>
...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:none;" >
    <div class="hd">
        ...
        <div class="close_pop"><a href="/upload_house_excel/" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">
        ...
        <div class="up_m_b_file clearfix" id='import_form'>
            <form action="/upload_house_excel/import/1" enctype="multipart/form-data" target="new" method="post">
...
function openn_import_new(type,broker_id)
{
	if(type == 'rent'){
		...
		$('#import_form form').attr("action", "/upload_house_excel/import/2");
		$('#openn_sure').html("<a class='btn-lv' href='javascript:void(0);' onclick='openn_sure_new(2);'><span>确认导入</span></a>");
	}else if(type == 'buy_customer'){
		$("#import_title").html('求购客源导入');
		$('#import_form form').attr("action", "/upload_house_excel/import/3");
		$('#openn_sure').html("<a class='btn-lv' href='javascript:void(0);' onclick='openn_sure_new(3);'><span>确认导入</span></a>");
	}else if(type == 'rent_customer'){
		$("#import_title").html('求租客源导入');
		$('#import_form form').attr("action", "/upload_house_excel/import/4");
		$('#openn_sure').html("<a class='btn-lv' href='javascript:void(0);' onclick='openn_sure_new(4);'><span>确认导入</span></a>");
	}
    //先清空上传文本框
...
{
    var url = "/upload_house_excel/sure/"+type;
