                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="gradeA">
                                            ...
                                            <td>
                                            	<a href="<?php echo MLS_ADMIN_URL;?>/user_group/modify/<?php echo $value['id'];?>" >修改</a>
                                            	<a href="<?php echo MLS_ADMIN_URL;?>/user_group/modify_purview_node/<?php echo $value['id'];?>" >权限节点</a>
