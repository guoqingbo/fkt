							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   城市:&nbsp&nbsp&nbsp&nbsp
                                        <select name="city_id" class="form-control input-sm" aria-controls="dataTables-example">
                                            <?php foreach($city as $k => $v){?>
                                            <option value="<?php echo $v['id'];?>" <?php if($v['id']==$user_group_data['city_id']){echo "selected='selected'";}?>><?php echo $v['cityname'];?></option>
                                            <?php }?>
                                        </select>
									  </label>
									  </div>
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  ...
									  <label>
									   用户组名称:&nbsp&nbsp<input type="search" name="name" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $user_group_data['name']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   排序字段:&nbsp&nbsp<input type="search" name="order" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $user_group_data['order']?>">
									  </label>
									  </div>
									  </div>									  	
