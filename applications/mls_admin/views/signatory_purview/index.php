                            ...
                            <?php if (isset($permission_role) && !empty($permission_role)){
                                foreach ($permission_role as $key => $value) { ?>
                                    <tr class="gradeA">
                                        ...
                                        <td><a href="/signatory_purview/set_role_func/<?=$value['id']?>">权限设置</a> |
...
function add_group(){
    ...
    $.ajax({
        type:"POST",
        url:"/signatory_purview/addgroup",
        data:data,
        cache:false,
        error:function(){
            alert("系统错误");
...
function get_group(id){
    $.ajax({
        url: "<?php echo MLS_ADMIN_URL;?>/signatory_purview/get_group/"+id,
        type:"GET",
        dataType:"json",
        data:{
            isajax:1
...
function update_group(){
    ...
    $.ajax({
        type:"POST",
        url:"/signatory_purview/update_group",
        data:data,
        cache:false,
        error:function(){
            alert("系统错误");
...
function del_group(id){
    $.ajax({
        url: "<?php echo MLS_ADMIN_URL;?>/signatory_purview/del_group/"+id,
        type:"GET",
        dataType:"json",
        data:{
            isajax:1
