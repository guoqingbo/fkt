                                    ...
                                    <div class="dataTables_length" id="dataTables-example_length">
                                        <label>
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                <a class="btn btn-primary" href='<?php echo MLS_ADMIN_URL; ?>/agency_permission_node/add/'>添加</a>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                if (isset($permission_modules) && !empty($permission_modules)) {?>
                                    ...
                                    <?php foreach ($permission_modules as $key => $vo) { ?>
                                        <tr class="gradeA" id="tr<?php echo $vo['pid'];?>">
                                            ...
                                            <td>
                                                <a href="<?php echo MLS_ADMIN_URL; ?>/agency_permission_node/modify/<?php echo $vo['pid']; ?>" >修改</a>
                                                <!--<a href="<?php echo MLS_ADMIN_URL; ?>/agency_permission_node/del/<?php echo $vo['pid']; ?>" onclick="return checkdel()">删除</a>
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                    ...
                                    <ul class="pagination" style="margin:-8px 0;padding-left:20px">
                                        <?php echo page_uri($page, $pages, MLS_ADMIN_URL . '/agency_permission_node/index'); ?>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	function _del(pid){
		$.ajax({
			type: "POST",
			url: "/agency_permission_node/del_del/",
			data: "pid="+pid,
			dataType:"json",
			cache:false,
			error:function(){
