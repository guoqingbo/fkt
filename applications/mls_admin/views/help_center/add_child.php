                                        ...
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <div class="form-group">
                                                    <b>子项标题：</b><input type="text" name="title" value="" >
                                                </div>
                                                <div>
                                                    <b>内&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;容：</b>
                                                </div>
                                                ...
                                                <div>
                                                    <b>序&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</b><input type="text" name="orderby" value="">&nbsp;&nbsp;<b>数值越大越靠前，若不填将默认为0</b>
                                                </div>
                                                <div>
    ...
    <script>
        $(function(){
            $("#btn-save").click(function(){
                ...
                $.post("<?php echo MLS_ADMIN_URL;?>/help_center/save_add_child",{title:title,content:content,parent_id:parent_id,orderby:orderby},
                    function(data){
                        if(data.status == 1){
                            alert('新增成功！');
