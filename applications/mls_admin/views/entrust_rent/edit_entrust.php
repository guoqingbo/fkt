                                ...
                                <form name="search_form" method="post" action="">
                                    ...
                                    <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                                        ...
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <label>
                                                    <span>公司:&nbsp&nbsp</span><input id="company_name"  value="<?php echo $list['company_name'];?>" class="input_text input_text_r w150 form-control input-sm" style="width:180px;display: inline-block;height:30px; line-height: 30px" type="text" placeholder="输入汉字筛选">
                                                                                 <input type="hidden" id="company_id" name="company_id" value="<?php echo $list['company_id'];?>">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6" style="width:100%">
                                        ...
                                        <script>
                                         ...
                                         function get_agency(company_name){
                                             $.ajax({
                                                type: 'get',
                                         ...
                                         function get_broker(agency_id){
                                            $.ajax({
                                                type: 'get',
                                                url : '<?php echo MLS_ADMIN_URL; ?>/entrust_rent/get_broker/',
                                                dataType:'json',
                                                data:{
                                                    agency_id:agency_id
                                                },
                                        ...
                                        <div class="col-sm-6" style="width:100%">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                ...
                                                <a class="btn btn-primary" href="/entrust_rent/index">返回</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
        $(function() {
            setTimeout(function() {
                window.location.href = "<?php echo MLS_ADMIN_URL . '/entrust_rent/index/'; ?>";
            }, 1000);
        });
</script>
<?php }?>
