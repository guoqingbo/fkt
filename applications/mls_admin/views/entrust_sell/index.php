                        ...
                        <div class="table-responsive">
                            <form action="" method="post" name="search_form">
                                ...
                                <div style="width:100%" class="col-sm-6">
                                    ...
                                    小区：&nbsp;<input type="text" value="<?=$param_array['comt_name']?>" aria-controls="dataTables-example" class="form-control input-sm " style="width:120px;display: inline-block;"  name="comt_name">
									...
									&nbsp;&nbsp;审核状态：&nbsp;<select name="is_check">
													...
													<option value="3" <?=($param_array['is_check']==2)?'selected':''?>>审核不通过</option>
                                                </select>
                                    <input type="hidden" name="pg" value="1">
                                    <input class="btn btn-primary" type="submit" value="查询" name="search">&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="button" onclick="javascript:location.href = '/entrust_sell/'" value="重置">
                                </div>
                            </form>
                        </div>
                        <table id="dataTables-example" class="table table-striped table-bordered table-hover">
                            <thead>
                                 <tr>
                                    ...
                                    <th style="width:70px">期望售价(万元)</th>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
									...
									case 1:echo "<a href='/entrust_sell/edit_entrust/".$val['id']."'>修改委托</a> | <a href='javascript:void(0);' onclick='del_pop(".$val['id'].")'>下架</a> | <a href='/entrust_sell/entrust_grab_details/".$val['id']."' >委托明细</a>";break;
									case 2:echo "<a href='/entrust_sell/edit_entrust/".$val['id']."'>修改委托</a> | <a href='/entrust_sell/entrust_grab_details/".$val['id']."' >委托明细</a>";break;}?></td>
                                </tr>
                                <?php }}else{
