                        ...
                        <div class="table-responsive">
                            <form action="" method="post" name="search_form">
                                ...
                                <div style="width:100%" class="col-sm-6">
                                    ...
                                    <input class="btn btn-primary" type="submit" value="查询" name="search">&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="button" onclick="javascript:location.href = '/seek_sell/'" value="重置">
                                </div>
                            </form>
                        </div>
                        <table id="dataTables-example" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
									...
									case 1:echo "<a href='/seek_sell/edit_entrust/".$val['id']."'>修改委托</a> | <a href='javascript:void(0);' onclick='del_pop(".$val['id'].")'>下架</a> | <a href='/seek_sell/entrust_grab_details/".$val['id']."' >委托明细</a>";break;
									case 2:echo "<a href='/seek_sell/edit_entrust/".$val['id']."'>修改委托</a> | <a href='/seek_sell/entrust_grab_details/".$val['id']."' >委托明细</a>";break;}?></td>
                                </tr>
                                <?php }}else{
