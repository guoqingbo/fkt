<?php require APPPATH.'views/header.php'; ?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">权限节点列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6" style="width:100%">
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <label>&nbsp&nbsp 父节点
                                                        <select name="p_id" aria-controls="dataTables-example" class="form-control input-sm">
                                                            <option value="0">请选择</option>
                                                            <?php foreach($father_node as $k => $v){?>
                                                            <option value="<?php echo $v['id'];?>"<?php if(isset($where_cond['p_id'])){if($v['id']==$where_cond['p_id']){echo 'selected="selected"';}}?>><?php echo $v['name'];?></option>
                                                            <?php }?>
                                                        </select>
                                                    </label>
                                                    <label>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                        if(isset($father_node_list2) && !empty($father_node_list2)){
                                            foreach($father_node_list2 as $key=>$value){
                                    ?>
                                        <tr class="gradeA">
                                            ...
                                            <td>
                                            	<a href="<?php echo MLS_ADMIN_URL;?>/purview_node/modify/<?php echo $value['id'];?>" >修改</a>
...
<script>
function del(id){
    var is_del = confirm('确定删除该节点吗？');
    del_url = "<?php echo MLS_ADMIN_URL;?>/purview_node/del/"+id;
    if(is_del){
