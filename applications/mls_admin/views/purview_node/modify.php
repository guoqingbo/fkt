							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  ...
									  <label>
									   节点名称:&nbsp&nbsp<input type="search" name="name" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $node['name']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   父节点:&nbsp&nbsp&nbsp&nbsp
                                        <select name="p_id" class="form-control input-sm" aria-controls="dataTables-example">
                                            <?php foreach($father_node as $k => $v){?>
                                            <option value="<?php echo $v['id'];?>" <?php if($v['id']==$node['p_id']){echo "selected='selected'";}?>><?php echo $v['name'];?></option>
                                            <?php }?>
                                        </select>
									  </label>
									  </div>
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   状态:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <select name="status" class="form-control input-sm" aria-controls="dataTables-example">
                                            <option value="1" <?php if($node['status']==1){echo 'selected="selected"';}?>>有效</option>
                                            <option value="0" <?php if($node['status']==0){echo 'selected="selected"';}?>>无效</option>
                                        </select>
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   路径:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="path" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $node['path']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   排序字段:&nbsp&nbsp<input type="search" name="order" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $node['order']?>">
									  </label>
									  </div>
									  </div>
