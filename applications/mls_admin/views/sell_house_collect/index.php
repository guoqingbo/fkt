<?php require APPPATH.'views/header.php'; ?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">二手房采集内容列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
							...
							<form name="search_form" method="post" action="" >
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
									日期：
									  <label>
									   ...
									   <input class="btn btn-primary" type="button" value="导出" onclick="javascript:window.location.href='<?php echo MLS_ADMIN_URL."/sell_house_collect/export"?>'"><br>
								</div>
								</div>
                               </form>
								</div>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
																			if(isset($sell_house_collect) && !empty($sell_house_collect)){
																				foreach($sell_house_collect as $key=>$value){
                                    ?>
                                        <tr class="gradeA">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                       ...
                                       <ul class="pagination" style="margin:-8px 0;padding-left:20px">
									   										<?php echo page_uri($page,$pages,MLS_ADMIN_URL.'/sell_house_collect/index');?>
									   									 </ul>
                                    </div>
                                  </div>
                                <div style="color:blue;position:absolute;right:33px;">
                                    <b>共查到<?php echo $sell_house_collect_num;?>条数据</b>
                                </div>
                                </div>
                               </div>
                               </div>
