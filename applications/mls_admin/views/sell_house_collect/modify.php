...
<?php require APPPATH.'views/header.php'; ?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">二手房采集房源电话审核</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			...
			<table>
				...
				<tr>
					<td>待审核号码：</td>
					<td>
						<input type="text" name="tel" class="input-sm"  value="<?php echo $sell_house_collect['telno1'];?>" />
						<?php if(strlen($sell_house_collect['tel_url'])>15){?>
							<a alt='查看号码' target='_blank' href="<?php echo $sell_house_collect['tel_url'];?>">查看号码</a>
						<?php }else{?>
							<img src="<?php echo $sell_house_collect['tel_url'];?>"/>
						<?php }?>
					</td>
				</tr>
				<tr>
					<td><a target="_blank" href="<?php echo $sell_house_collect['oldurl'];?>" >查看原网址</a></td>
					<td><a target="_blank" href="http://www.baidu.com/s?wd=<?php echo $sell_house_collect['telno1'];?>" >人工查询</a></td>
				</tr>
				<tr>
...
<script>
	function	goback(){
		location.href = "<?=MLS_ADMIN_URL?>/sell_house_collect/";
	}
</script>
