                                ...
                                <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                                    ...
                                    <div class="col-sm-6" style="width:100%">
                                        <div class="dataTables_length" id="dataTables-example_length">
                                            ...
                                            <label>
                                                标题:&nbsp&nbsp&nbsp&nbsp<input type="search" name="title" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $news_msg['title']?>">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6" style="width:100%">
                                        <div class="dataTables_length" id="dataTables-example_length">
                                            <label>
                                                内容:&nbsp&nbsp&nbsp&nbsp                                           <textarea name="content" id="content" cols="100" rows="4" style="visibility:hidden;"><?php echo $news_msg['content']; ?></textarea>
                                            </label>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div class="col-sm-6" style="width:100%">
                                        <div class="dataTables_length" id="dataTables-example_length">
                                            <input type="hidden" class="form-control" name="new_id" value="<?php echo $news_msg['id'];?>">
                                            <input class="btn btn-primary" type="button" value="提交" id="btn-save">
...
<script>
    ...
    $(function(){
        $("#btn-save").click(function(){
            ...
            $.post("/module_news/modify/" + id,{title:title,content:content,submit_flag:submit_flag},
                function(data){
                    if(data >= 1){
                        alert('修改成功！');
