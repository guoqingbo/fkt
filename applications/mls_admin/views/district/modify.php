							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   区属名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="district" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['district']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   排序:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="search" name="order" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['order']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
                                       ...
                                       <select name="is_show" class="form-control input-sm" aria-controls="dataTables-example">
                                           <option value="1"<?php if($city_data['is_show']=='1'){echo 'selected="selected"';}?>>有效</option>
                                           <option value="2"<?php if($city_data['is_show']!='1'){echo 'selected="selected"';}?>>无效</option>
                                       </select>
									  </label>
									</div>
								</div>
								<div class="col-sm-6" style="width:100%">
									...
									<script type="text/javascript">
										var lng = "<?php echo $city_data['b_map_x'] > 0 ? $city_data['b_map_x'] : $lng;?>";
										var lat = "<?php echo $city_data['b_map_y'] > 0 ? $city_data['b_map_y'] : $lat;?>";
										// 百度地图API功能
