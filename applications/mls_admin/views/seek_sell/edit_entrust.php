...
<script>
        $(function() {
            setTimeout(function() {
                window.location.href = "<?php echo MLS_ADMIN_URL . '/seek_rent/index/'; ?>";
            }, 1000);
        });
</script>
<?php }?>
