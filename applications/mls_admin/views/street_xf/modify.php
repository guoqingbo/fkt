							...
							<form name="search_form" method="post" action="">
							  ...
							  <div class="row">
						        ...
						        <div class="col-sm-6" style="width:100%">
								    <div class="dataTables_length" id="dataTables-example_length">
									  <label>
									   板块名<font color="red">*</font>:&nbsp&nbsp&nbsp&nbsp<input type="search" name="streetname" class="form-control input-sm" aria-controls="dataTables-example" value="<?php echo $city_data['streetname']?>">
									  </label>
									  </div>
									  </div>
						        <div class="col-sm-6" style="width:100%">
