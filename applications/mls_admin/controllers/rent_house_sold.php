 ...
 * @author      angel_in_us
 */
class Rent_house_sold extends MY_Controller
{
  ...
  public function index()
  {
    ...
    //加载列表页
    $this->load->view('sold_list/sold_rent', $data);
  }
...
/* End of file rent_house_sold.php */
/* Location: ./application/controllers/rent_house_sold.php */
