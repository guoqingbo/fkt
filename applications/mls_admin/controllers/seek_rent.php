 ...
 * @author      sun
 */
class Seek_rent extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['list'] = $this->seek_model->get_list_by_cond($where, $tbl = 'seek_rent', $data['offset'], $data['pagesize'], 'ctime desc', '');
    ...
    $this->load->view("seek_rent/index", $data);
  }
  ...
  public function entrust($id)
  {
    ...
    $data['result'] = $result;
    $this->load->view('seek_rent/entrust', $data);
  }
  ...
  public function edit_entrust($id)
  {
    ...
    $data['district'] = $this->seek_model->get_district();
    $data['result'] = $result;
    $this->load->view('seek_rent/edit_entrust', $data);
  }
  ...
  public function cancel_entrust($id)
  {
    ...
    $result = $this->seek_model->update_status($id, $update_array, $tbl = "seek_rent");
    $data['result'] = $result;
    $this->load->view('seek_rent/cancel_entrust', $data);
  }
  ...
  public function del($id)
  {
    ...
    $data = $this->seek_model->update_status($id, $update_array, $tbl = "seek_rent");
    if (1 == $data) {
