...
/**
 * Sell_house_statistic_model CLASS
 *
 * 出售房源信息统计相关的方法。
 *
 * @package         MLS
...
class Sell_house_statistic_model extends House_base_model
{
  ...
  public function get_city_district_new_data($cond_where)
  {
    ...
    //单套
    $this->dbback_city->select('AVG(avgprice) AS avgprice', FALSE);
