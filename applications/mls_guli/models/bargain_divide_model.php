 ...
 * @author          sun
 */
load_m("Bargain_divide_base_model");

class Bargain_divide_model extends Bargain_divide_base_model
{
  ...
  {
    parent::__construct();
    $this->_tbl1 = 'bargain_divide';
  }

  //总计数据
  public function get_total($bargain_id)
  {
    //查询字段
    $this->dbback_city->select("SUM(divide_price) AS price_total,SUM(percent) AS percent_total");

    $this->dbback_city->where('c_id', $bargain_id);
