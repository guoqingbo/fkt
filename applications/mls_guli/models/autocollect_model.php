...
class Autocollect_model extends MY_Model
{
  ...
  public function get_pic_url($url, $area)
  {
    ...
    $localfile = "applications/mls_guli/photo/" . $filename;
    ...
    $this->uf->setSaveDir("/" . $area . "mls_guli/");
  ...
  public function con_flow($str)
  {
    ...
    $flowments[3] = "";
    $flowments[4] = "";
    $arr = preg_flow($patterns, $flowments, $str);
    return $arr;
  }
  ...
  //html转义字符去除 :wjy
  public function special_flow($str)
  {
    $patterns[0] = '/&[A-Za-z]+;/';
    $patterns[1] = '/	/';
    $patterns[2] = '/\n/';
