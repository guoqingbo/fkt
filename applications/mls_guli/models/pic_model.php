...
class Pic_model extends MY_Model
{
  ...
  public function __construct()
  {
    ...
    if (!empty($_SESSION[USER_SESSION_KEY]["city_spell"])) {
      $this->_save_dir = '/' . $_SESSION[USER_SESSION_KEY]["city_spell"] . 'mls_guli/';
    }
  }
   ...
   * 房源打印
   */
  public function house_print($cmt_name = '', $price = '', $area = '', $apartment = '', $fitment = '', $forward = '', $remark = '', $signatory = '', $shinei = '', $huxing = '', $house_id, $type = 0, $department_name = '', $qrcode = '')
  {
   ...
   * 个人中心，门店二维码打印
   */
  public function department_print($department_scode_img = '', $department_id)
  {
    header('Content-Type:text/html;charset=utf-8');
    ...
    $result = $this->uf->department_pic_deal($department_scode_img, $department_id);
    return $result;
  }
