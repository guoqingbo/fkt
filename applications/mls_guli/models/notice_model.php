...
class Notice_model extends MY_Model
{
   ...
   * @author       angel_in_us
   */
  function get_notice($where = array(), $where_in = array(), $like = array(), $offset = 0, $limit = 10, $database = 'dbback_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_notice_byid($where = array(), $database = 'dbback_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_notice_num($where = array(), $where_in = array(), $like = array(), $database = 'dbback_city')
  {
    $notice_num = $this->get_data(array('form_name' => $this->notice, 'where' => $where, 'where_in' => $where_in, 'like' => $like, 'select' => array('count(*) as num')), $database);
