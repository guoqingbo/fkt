...
<title>经纪人注册页面</title>
<link href="<?php echo MLS_SOURCE_URL;?>/min/?b=mls_guli&f=css/v1.0/web_reseat.css,css/v1.0/register_login_password2.css" rel="stylesheet" type="text/css">
<script src="<?php echo MLS_SOURCE_URL;?>/min/?b=mls_guli/js/v1.0&f=jquery-1.8.3.min.js,jquery.validate.min.js"></script>
<script>
$(function() {
	$('.ewm1').hover(function(){
		$('.ewm-img').toggle();
