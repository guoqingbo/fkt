    ...
    <input type="hidden" value="<?php echo $company_id ?>" id="company_id">
        ...
        <div class="forms_details_fg">
            <div class="clearfix item_fg js_fields">
                ...
                <i class="label labelOn display_htype_yes display_htype_yes2">
                    <input name="sell_type" type="radio"  class="input_radio" value="1" checked  id="js_house_type_ZZ">
                    住宅</i>
                <i class="label display_htype_yes display_htype_yes2">
                    <input type="radio"  class="input_radio" name="sell_type" value="2"   id="js_house_type_BS">
                    别墅</i>
                <i class="label display_htype display_htype_yes2">
                    <input type="radio" class="input_radio" name="sell_type" value="3"  id="js_house_type_SP">
                    商铺</i>
                <i class="label display_htype display_htype_yes2">
                    <input type="radio"  class="input_radio" name="sell_type" value="4" id="js_house_type_XZL">
                    写字楼</i>
                <i class="label display_htype display_htype2">
                    <input type="radio" class="input_radio" name="sell_type" value="5"  id="js_house_type_CF">
                    厂房</i>
                <i class="label display_htype display_htype2">
                    <input type="radio"  class="input_radio" name="sell_type" value="6"  id="js_house_type_CK01">
                    仓库</i>
                <i class="label display_htype display_htype2">
                    <input type="radio" class="input_radio" name="sell_type" value="7" id="js_house_type_CK02">
                    车库</i>
            ...
            <div class="clearfix item_fg">
                ...
                <div class="y_fg js_fields">
                    <input name="block_name" id="block_name" value="" class="input_text input_text_r w150" type="text" placeholder="输入拼音或汉字筛选" onblur="check_unique_house(1);">
                    <?php if(!('1'===$is_property_publish)){?>
					<a href="javascript:void(0)" class="btn-lv1 left btn-right" id="addBlock" onclick="addBlock()">添加楼盘</a>
                    <?php }?>
                    <input name="block_id" id="block_id" value="" type="hidden"  onchange="check_unique_house(1);">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text w60" name="select_q"  id="select_q" type="text" readonly >
                    <input name="district_id" id="district_id"   type="hidden">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text w60" id="select_b" name="select_b" type="text" readonly >
                    <input name="street_id" id="street_id"  type="hidden">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text w260" id="address" name="address"  type="text" readonly >
                    <div class="errorBox clear"></div>
                </div>
                </label>
            </div>
          ...
          <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="y_fg js_fields" id="dong_div">
                    <input class="input_text input_text_r w80" name="dong" id="dong" value="" type="text" onblur="check_unique_house(1);">&nbsp;&nbsp;<span style="font-weight:bold;color:red;" id="dong_reminder"></span>
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields" id="unit_div">
                    <input class="input_text input_text_r w80" name="unit" id="unit" value="" type="text" onblur="check_unique_house(1);">&nbsp;&nbsp;<span style="font-weight:bold;color:red;" id="unit_reminder"></span>
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields" id="door_div">
                    <input class="input_text input_text_r w80" type="text" id="door" value="" name="door" onblur="check_unique_house(1);">&nbsp;&nbsp;<span style="font-weight:bold;color:red;" id="door_reminder"></span>
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r w80" type="text"  name="owner">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
            ...
            <div class="item_fg clearfix">
                <div class="label"> <span class="text_fg"><b class="red">*</b>业主电话：</span>
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r w80" type="text" name="telno1"  id="telno1">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
           <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="left width_b js_s_h_info js_s_ZZ_info" ><!--住宅-->
            ...
            <div class="item_fg clearfix">
                ...
                <div class="left width_b" id="house_type">
            ...
            <div class="item_fg clearfix house_type2">
                 <div class="left width_b">
                    ...
                    <div class="y_fg js_fields" id="d_input" style="margin-right: 5px;" >
                        <input class="input_text input_text_r w20" name="floor"  type="text" id="floor" >
                        <div class="errorBox clear"></div>
                    </div>
                    ...
                    <div class="label label_none js_fields">
                        ...
                        <div class="left">
                            <input class="input_text input_text_r w50" type="text" name="totalfloor"  id="z_louceng" >
                            <div class="errorBox clear"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item_fg clearfix">
                <div class="label">
                    ...
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r w60" name="buildarea" >
                ...
                <div class="label">
                    ...
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r w60" name="rent_price" id="rent_price" onblur=""  type="text">
                        <span class="y_fg y_fg_p_l_5 js_show_pirce" id="js_show_pirce_1">元/月</span>
                        <select class="select hide js_select_pirce" style="margin-left:10px;" name="price_danwei">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
            <div  class="item_fg reset_P clearfix">
                ...
                <div class="left" id="status_1" style="display:block;">
                    ...
                    <?php }else{?>
                    <i class="label-no mod_p" id = "js_gs_01">是
                    </i>
                    <i class="label-no2 mod_p labelOn "  id = "js_gs_02">否
                    </i>
                    <?php }?>
                </div>
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
           <div class="clearfix">
            ...
            <div class="js_s_h_info_house hide">
                ...
                <div class="item_fg clearfix hide js_s_h_info js_s_SP_info" ><!--商铺-->
                    <div class="left">
                        <div class="text_fg">类型：</div>
                        <?php
                ...
                <div class="item_fg clearfix hide js_s_h_info js_s_XZL_info" ><!--写字楼-->
                    <div class="left width_b  ">
                ...
                <div class="item_fg clearfix js_s_fenge_info" style="display:none;">
                    <div class="left width_b hide js_s_h_info js_s_SP_info" ><!--商铺-->
                        <div class="text_fg"> 是否可分割：</div>
                        <i class="label">
                    ...
                    <div class="left width_b hide js_s_h_info js_s_XZL_info" ><!--写字楼-->
                        <div class="text_fg"> 类型：</div>
                        <?php
                    ...
                    <div class="left width_b js_s_h_info hide js_s_BS_info"> <!--别墅-->
                        <div class="text_fg">类型：</div>
                        <?php
                ...
                <div class="item_fg clearfix hide js_s_h_info js_s_BS_info" >
                ...
                <div class="item_fg hide js_s_h_info js_s_BS_info clearfix">
                    <div class="left width_b"><!--别墅-->
...
<!--是否发布到网店弹窗提示-->
<div class="pop_box_g" id="is_publish" style="width:300px; height:auto; background:#fff; display:block;">
    <div class="hd">
        <div class="title">提示</div>
        <div class="close_pop"><a href="javascript:void(0);" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod mod-qf">
		...
		<div class="center">
            <!--                    <a class="btn-lv mr10" id="y_publish" href="javascript:void(0)">-->
            <!--                        <span>要群发</span>-->
            <!--                    </a>-->
            <a class="btn-lv" href="/rent/lists">
                <!--                <span>不群发</span>-->
...
<div class="pop_box_g" id="gl_moban" style="display: none;">
    ...
    <div class="guanli_pop_mb clearfix">
        <?php if(!empty($tmps) && isset($tmps)) {
            ...
            <?php } }?>
        <?php if($temp_num<10) { ?>
            <a class="xjmb_dd btn-add-tmp manage_add_tmp manage_add_tmp" href="javascript:void(0);">新建模板</a>
        <?php } ?>
    </div>
</div>
...
$(function(){
    ...
    $('#add_cmt_submit').live('click',function(){
	...
	$(".display_htype").live('click',function(){
		$("#house_type").hide();
	});
	//写字楼、厂房、仓库、车库、车位没有户型选项   显示
	$(".display_htype_yes").live('click',function(){
		$("#house_type").show();
	});

    //厂房、仓库、车库没有朝向、楼层、装修字段
	$(".display_htype2").live('click',function(){
		$(".house_type2").hide();
	});

	$(".display_htype_yes2").live('click',function(){
		$(".house_type2").show();
	});
});
/*
