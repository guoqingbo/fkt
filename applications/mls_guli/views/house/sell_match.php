<div class="pop_box_g pop_box_g02" id="js_zhineng" style="display: block;border:0;width:930px;">
    ...
    <div class="mod">
        <div class="mod_zn_inner">
            <div class="inner">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><?php echo strip_end_0($house_info['price']); ?></td>
                        <?php if($is_public){?>
                        ...
                        <?php }else{ ?>
                        <a href="javascript:void(0);" onclick="parent.cooperate_house('sell',<?php echo $house_info['id'];?>,<?php echo $house_info['broker_id'];?>);">合作申请</a>
                        <?php } ?>
                        </td>
                        <?php } ?>
                    </tr>
            ...
            <form method='post' action='/sell/match/<?php echo $house_info['id'];?>/<?php echo $is_public;?>' id='search_form'>
            ...
            <div class="inner inner02 clearfix match">
                ...
                <div class="fg_box">
                    ...
                    <div class="fg">
                        ...
                        <input type="hidden" name="search_block_id" id="search_block_id" value="<?php echo !empty($post_param['search_block_id']) ? $post_param['search_block_id'] : '';?>">
                    </div>
                </div>
            ...
            <div class="inner">
                <table class="table">
                    ...
                    <tr class="data_list <?php if($key % 2 == 1){ ?>bg<?php }?>" date-url="<?php echo MLS_SIGN_URL;?>/customer/details/<?php echo $value['id'];?>/<?php echo $details_url;?>" controller="customer">
                        ...
                        <td><?php echo strip_end_0($value['price_min']);?>-<?php echo strip_end_0($value['price_max']);?></td>
                        ...
                        <?php if(!$is_public){?>
                            ...
                            <a href="javascript:void(0)" title="自己不能跟自己合作" style="color:#b2b2b2;text-decoration:none;">合作申请</a>
                            <?php }else{ ?>
                            <a href="javascript:void(0);" onclick="parent.cooperate_customer('buy_customer',<?php echo $value['id'];?>);">合作申请</a>
                            <?php } ?>
                            </td>
                        <?php } ?>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
                    <tr><td colspan="15"><span class="no-data-tip">抱歉，没有找到符合条件的信息</span></td></tr>
                    <?php } ?>
                </table>
            </div>
            <?php } ?>
