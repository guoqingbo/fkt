        ...
        <div class="forms_details_fg">
            ...
            <div class="clearfix item_fg">
                ...
                <div class="y_fg js_fields">
                    ...
                    <?php }?>
                    <input name="block_id" id="block_id" value="" type="hidden" onBlur="check_unique_house(1);">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
           <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r w80" type="text" value="" name="owner">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
            ...
            <div class="item_fg clearfix">
                <div class="label"> <span class="text_fg"><b class="red">*</b>业主电话：</span>
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r w80" type="text" name="telno1" value="" id="telno1">
           ...
           <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                <div class="left width_b js_fields" >
                    ...
                    <div class="left width_b js_s_h_info js_item_hide js_s_ZZ_info" ><!--住宅-->
            ...
            <div class="item_fg clearfix">
                <div class="label">
					...
					<div class="y_fg js_fields">
						<input class="input_text input_text_r w60" name="buildarea" id="buildarea" type="text"  onblur="get_avgprice();">
            ...
            <div class="item_fg clearfix">
                <div class="label">
					...
					<div class="y_fg js_fields">
						<input class="input_text input_text_r w60" name="price" type="text" id="price" onblur="get_avgprice();">
...
<div class="pop_box_g" id="is_publish" style="width:300px; height:auto; background:#fff; display:none;">
    <div class="hd">
        <div class="title">提示</div>
        <div class="close_pop"><!--<a href="javascript:void(0);" title="关闭" class="JS_Close iconfont">&#xe60c;</a>--><a href="/sell/lists" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
