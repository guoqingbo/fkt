                ...
                <div class="t_box" >
                    ...
                    <p class="link_btn_b">
                        <?php if(!('1'==$data_info['is_public'])){ ?>
                            ...
                            <a id="show_baomi_button" onClick="show_baomi_info('<?php echo $data_info['id'];?>','sell')" href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 查看保密信息</a>
                            ...
                            <a style="display:none;" id="modify_baomi_submit_button" onClick="submit_baomi_info(<?php echo $data_info['id']; ?>,'sell')" href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 保存修改</a>
                            <?php }else{ ?>
                            很遗憾，您无权查看相关保密信息。
                            <?php } ?>
                        <?php } ?>
        ...
        <div class="tab_pop_bd">
            ...
            <?php }else{ ?>
                <div>
                    ...
                    <form action="<?php echo MLS_SIGN_URL;?>/sell/download_pic/<?php echo $data_info['id']; ?>" method="get">
