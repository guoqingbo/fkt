...
function chang(type){
 ...
 $.ajax({
	url: "<?php echo MLS_SIGN_URL;?>/"+type+"/broker_list/",
	type: "GET",
	dataType: "json",
    ...
    <div class="title" id="js_title">
        <table class="table">
            <tr>
                ...
                <td class="c4"><div class="info">合作</div></td>
                <?php } ?>
                ...
                <td class="c5"><div class="info"><a href="javascript:void(0)" onclick="renntlist_order(5);return false;" id="order_area" class="i_text <?php if($post_param['orderby_id'] == 6 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 5){ echo 'i_up'; } ?>">面积<br>
                        (㎡)</a></div></td>
                <?php } ?>
                <?php if(in_array(10, $rent_house_field_arr)){ ?>
				<td class="c8"><div class="info"><a href="javascript:void(0)" onclick="renntlist_order(7);return false;" id="order_price" class="i_text <?php if($post_param['orderby_id'] == 8 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 7){ echo 'i_up'; } ?>">租金</a></div></td>
                <?php } ?>
                <?php if(in_array(11, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">栋座</div></td>
                <?php } ?>
                <?php if(in_array(12, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">单元</div></td>
                <?php } ?>
                <?php if(in_array(13, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">门牌</div></td>
                <?php } ?>
                ...
                <td class="c4"><div class="info">朝向</div></td>
                <?php } ?>
    ...
    <div class="inner" id="js_innerHouse" style="*overflow-x:hidden; *position:relative;height:371px;">
		...
		?>
           <tr <?php if(!empty($tag_str)){ ?>title="<?php echo $tag_str; ?>"<?php } ?> <?php if('' != $tdclass){ ?>class="<?php echo $tdclass; ?>" <?php }?> id="tr<?php echo $val['id'];?>" date-url="/rent/details_house/<?php echo $val['id'];?>/1" controller="rent" _id="<?php echo $val['id'];?>" min_title="<?php echo $val['block_name'].'-'.intval($val['price']).'万'.'-'.intval($val['buildarea']).'平米'; ?>" page_id="<?php echo $key+1; ?>">
                ...
                <?php } ?>
                <?php if(in_array(20, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">CZ<?php echo $val['id']; ?></div></td>
                <?php } ?>
                <?php if(in_array(2, $rent_house_field_arr)){ ?>
                ...
                <?php } ?>
                <?php if(in_array(4, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info" id="share<?php echo $val['id'];?>"><?php if($val['isshare']==1){ ?>是<?php }else if($val['isshare']==2){ ?>审核中<?php }else{ ?>否<?php }?></div>
                ...
                <?php } ?>
                <?php if(in_array(9, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info f60"><?php echo strip_end_0($val['buildarea']);?></div></td>
                <?php } ?>
                <?php if(in_array(10, $rent_house_field_arr)){ ?>
                <td class="c8">
                ...
                <?php } ?>
                <?php if(in_array(16, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info"><?php echo $config['forward'][$val['forward']]; ?></div></td>
                <?php } ?>
                <?php if(in_array(17, $rent_house_field_arr)){ ?>
    ...
    <?php }else{ ?>
        ...
        <?php if('1'==$open_cooperate){?>
            ...
            <div class="secondLevel">
                <p><a href="javascript:void(0);" onclick = "share_check('rent',0);">发到合作中心</a></p>
                <p><a href="javascript:void(0);" onclick = "share_check('rent',1);">发到朋友圈</a></p>
            </div>
            </li>
            <?php }else{?>
            <li class="js_input_6 secondLevelParent" style="position:relative;">
            设置合作<img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/new/jt.gif" style="padding-left:3px;">
            <div class="secondLevel">
                <p><a href="javascript:void(0);" onclick = "sharechange(1,'rent',0);">发到合作中心</a></p>
                <p><a href="javascript:void(0);" onclick = "sharechange(1,'rent',1);">发到朋友圈</a></p>
            </div>
            </li>
            <?php }?>
...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:none;" >
    ...
    <div class="mod">
        ...
        <iframe allowtransparency="true" src="<?php echo MLS_SIGN_URL;?>/blank.php" frameborder="0" scrolling="no" name="new" id="xx1x" height="35" width="393"></iframe><!-- width="470"  wty---->
...
<div class="pop_box_g pop_box_g_big pop_box_d_c pop_box_d_c02" style="display:none" id="js_rent_export">
    ...
    <div class="mod">
        <form action="<?php echo MLS_SIGN_URL;?>/rent/exportReport" method="post" id="myform">
            <!--存放当前的总页数用于判断-->
...
$(function(){
	...
	$(".js_input_6").live("mouseout",function(){
		$(this).find("img").attr("src","<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/new/jt.gif");
		timer = setTimeout(function(){
