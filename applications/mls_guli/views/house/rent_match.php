        ...
        <div class="mod_zn_inner">
            ...
            <div class="inner">
                <table class="table">
                    ...
                    <tr class="data_list <?php if($key % 2 == 1){ ?>bg<?php }?>" date-url="<?php echo MLS_SIGN_URL;?>/rent_customer/details/<?php echo $value['id'];?>/<?php echo $details_url;?>" controller="rent_customer">
