    ...
    <div class="mod clearfix">
        <div class="trail-fl">
			<div class="tab_pop_hd">
				<div class="clearfix">
                    <a class="item <?php if(1==$num){echo 'itemOn';}?> " href="/sell/house_follow/<?php echo $house_id;?>/1">跟进明细</a>
					<a class="item <?php if(2==$num){echo 'itemOn';}?> " href="/sell/house_follow/<?php echo $house_id;?>/2">带看明细</a>
					<a class="item <?php if(3==$num){echo 'itemOn';}?> " href="/sell/house_follow/<?php echo $house_id;?>/3">提醒明细</a>
				</div>
			</div>
...
<div class="pop_box_g pop_see_inform pop_no_q_up" id="js_pop_msg1">
    <div class="hd">
        ...
        <div class="close_pop">
            <a class="JS_Close iconfont msg_iconfont_close" title="关闭" href="/sell/house_follow/<?=$house_id?>/<?=$num?>"></a>
        </div>
    </div>
    <div class="mod">
            ...
            success:function(data){
                if('success' == data){
                    ...
                    $("#dialog_share").click(function(){
                       ...
                       $(window.parent.document).find("#detialIframe").contents().find("#sell_house_match").attr('class','btn-lan');
                       $(window.parent.document).find("#detialIframe").contents().find("#sell_house_share_tasks").attr('class','btn-lan');
                       $(window.parent.document).find("#detialIframe").contents().find("#sell_allocate_house").attr('class','btn-lan');
                       $(window.parent.document).find("#detialIframe").contents().find("#sell_zhuxiao").show();
                       $(window.parent.document).find("#detialIframe").contents().find("#sell_bianji").show();
                        //详情页隐藏，列表页刷新
