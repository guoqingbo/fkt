    ...
    <?php }else{ ?>
        ...
        <?php if('1'==$open_cooperate){?>
            ...
            <div class="secondLevel">
                <p><a href="javascript:void(0);" onclick = "share_check('sell',0);">发到合作中心</a></p>
                <p><a href="javascript:void(0);" onclick = "share_check('sell',1);">发到朋友圈</a></p>
            </div>
            </li>
            <?php }else{?>
            <li  class="js_input_6 secondLevelParent" style="position:relative;">
            设置合作<img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/new/jt.gif" style="padding-left:3px;">
                <div class="secondLevel">
                    <p><a href="javascript:void(0);" onclick = "sharechange(1,'sell',0);">发到合作中心</a></p>
                    <p><a href="javascript:void(0);" onclick = "sharechange(1,'sell',1);">发到朋友圈</a></p>
                </div>
            </li>
            <?php }?>
...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:none;" >
    ...
    <div class="mod">
        ...
        <div class="up_m_b_tex">房源导入功能可以将外部房源直接导入系统中，省去手动录入的麻烦。为保证您的房源顺利导入，请使用我们提供的标准模板，且勿对模板样式做任何删改。</br><a href="<?php echo MLS_SOURCE_URL;?>/xls/example1.xls" target="_blank">
        ...
        <iframe allowtransparency="true" src="<?php echo MLS_SIGN_URL;?>/blank.php" frameborder="0" scrolling="no" name="new" id="xx1x" height="34" width="393" style="bac"></iframe><!-- width="470"  wty---->
...
<div class="pop_box_g pop_box_g_big pop_box_d_c pop_box_d_c02" style="display:none" id="js_sell_export">
    ...
    <div class="mod">
        <form action="<?php echo MLS_SIGN_URL;?>/sell/exportReport" method="post" id="myform">
            <!--存放当前的总页数用于判断-->
