     ...
     <div class="title" id="js_title">
        <table class="table table_q">
            <tr>
                ...
                <td class="c9"><div class="info">楼盘</div></td>
                ...
                <td class="c5">
                    <div class="info"><a href="javascript:void(0)" onclick="selllist_order(7);" id="order_price" class="i_text <?php if($post_param['orderby_id'] == 8 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 7){ echo 'i_up'; } ?>">报价<br>
                        (W)</a></div></td>
                <td class="c7"><div class="info"><a href="javascript:void(0)" onclick="selllist_order(9);" id="order_avgprice" class="i_text <?php if($post_param['orderby_id'] == 10 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 9){ echo 'i_up'; } ?>">单价<br>
                        (元/㎡)</a></div></td>
    ...
    <div  id="js_inner" class="inner" style="overflow-y: scroll;">
		...
		<?php
            if($house_list)
            {
                ...
                {
            ?>
        <tr info_id = "<?php echo $val['id'];?>" <?php if($key % 2 == 1){ ?>class="bg" <?php }?> id="tr<?php echo $val['id'];?>" date-url="/sell/details_house/<?php echo $val['id'];?>/2">
                <td class="c8">
                <div class="info ff9c00">
                    <?php if('2'==$val['reward_type']){?>
                    <span class="iconfont ts2">&#xe658;</span> <strong><?php echo $val['cooperate_reward'];?></strong>
                ...
                <td class="c7"><div class="info f13 fblod"><?php echo round($val['avgprice']); ?></div></td>
                <td class="c8 js_info broker" data-brokerId ="<?php echo $val['broker_id'];?>" data_id="<?php echo $val['id'];?>" type="sell_house">
					<div class="info">
						<?php echo $val['broker_name']; ?>
						<!--<span class="onper iconfont">&#xe616;</span>-->
					</div>
					<?php if($check_coop_reulst[$val['id']] == 1){ ?>
					<a href="###" broker_id="<?= $val['broker_id']?>" broker_name="<?=$val['broker_name']?>" class="im_a" id="im_icon" title="在线IM">
                ...
                -->
                <td class="c6"><div class="info"><?php echo date('Y-m-d H:i',$val['set_share_time']); ?></div></td>
                <td class="js_no_click">
					<div class="info_p_r">
                        <?php if($check_coop_reulst[$val['id']] == 1){ ?>
                           <a href="javascript:void(0)" title = "已申请" class="no-opt">已申请</a>
                        ...
                        <?php }else if('0'==$open_cooperate){?>
							<a href="javascript:void(0)" title = "当前公司未开启合作中心" class="no-opt">合作申请</a>
                        <?php } else {?>
							<a href="javascript:void(0)" title = "自己不能跟自己合作" class="no-opt">合作申请</a>
                        <?php }?>
							<span>|</span><a href="javascript:void(0)" onclick="open_match('sell',2,<?php echo $val['id'];?>)">智能匹配</a><span>|</span><a href="javascript:void(0)" class="shcang" onclick="qucang('house_collect','sell_house',<?php echo $val['id']?>)">取消收藏</a>
					</div>
                </td>
            </tr>
           <?php
