<script>
    $(function () {
        $('#modifycont_form input,#modifycont_form select,#modifycont_form textarea').attr('disabled', 'disabled').css("background-color", " rgb(235, 235, 228)");
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <div class="shop_tab_title" style="margin:0 15px  10px  0px;">
                                    ...
                                    <a class="btn-lv fr" href="/bargain/cash_detail_print/<?php echo $bargain['id']; ?>"
                                       target="_blank"><span>客户打款明细打印</span></a>
                                    <a href="/bargain/modify_bargain/0/<?= $bargain['id']; ?>"
...
//
                    ...
                    <dl class="sale_message">
                        ...
                        <div class="aad_pop_p_B10" style="display:inline;">
                            ...
                            <li style="width: 380px">
                                ...
                                <b>
                                    <input type="text" class="border_color input_add_F zws_W128" style="width:270px"
                    ...
                    <dl class="sale_message">
                        ...
                        <div class="aad_pop_p_B10" style="display:inline;">
                            ...
                            <li style="width:380px;">
                                <strong><em class="resut_table_state_1"></em>身份证号：</strong>
                                <b><input type="text" class="border_color input_add_F zws_W128" style="width: 270px"
        ...
        <div class="inform_inner">
            <div class="up_inner">
                ...
                <button class="btn JS_Close" type="button"
                        onclick="location.href=location">确定
                </button>
            </div>
        </div>
    </div>
