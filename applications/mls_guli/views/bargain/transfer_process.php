<script>
    $(function () {
        $('#modifycont_form input,#modifycont_form select,#modifycont_form textarea').attr('disabled', 'disabled');
...
<div class="bargain-wrap clearfix">
            ...
            <div class="i_box">
                ...
                <div id="js_search_box" class="shop_tab_title  scr_clear top_Marign"
                    ...
                    <div class="shop_tab_title" style="margin:0 15px  10px  0px;">
                        ...
                        <a href="/bargain/transfer_process/<?= $bargain['id']; ?>" class="link link_on"><span
                ...
                <div id="js_mukuai_box" class="iframePopBox"
                    ...
                    <iframe frameborder="0" scrolling="no" width="100%" height="100%"
                            src="/bargain/bargain_transfer_manage/<?= $bargain['id']; ?>" id="iframepage"
    ...
    <!--过户流程，撤销弹框-->
    <div id="js_cancel_transfer" class="pop_box_g pop_see_inform pop_no_q_up">
        <div class="hd">
            <div class="title">提示</div>
            <div class="close_pop"><a href="javascript:void(0);" title="关闭" class="JS_Close iconfont"></a></div>
        </div>
        <div class="mod">
            <div class="inform_inner">
                <div class="up_inner">
                    <p class="text"><img alt="" src="<?php echo MLS_SOURCE_URL; ?>/mls_guli/images/v1.0/s_ico.png">&nbsp;&nbsp
                        过户流程撤销不可恢复。<br/>是否确认撤销？
                    </p>
                    <button type="button" class="btn-lv1 JS_Close" onclick="cancel_transfer();"
    ...
    <!--短信发送弹框-->
    <div id="js_send_massage" class="pop_box_g pop_see_inform pop_no_q_up">
        <div class="hd">
            <div class="title">提示</div>
            <div class="close_pop"><a href="javascript:void(0);" title="关闭" class="JS_Close iconfont"></a></div>
        </div>
        <div class="mod">
            <div class="inform_inner">
                <div class="up_inner">
                    <p class="text"><img alt="" src="<?php echo MLS_SOURCE_URL; ?>/mls_guli/images/v1.0/s_ico.png">&nbsp;&nbsp
                        <span id="send_tip">确认发送完成短信</span>
                    </p>
                    <button type="button" class="btn-lv1 JS_Close" onclick="send_complete_massage();"
                            style="margin-right:10px;">确定
                    </button>
                    <button type="button" class="btn-hui1 JS_Close">取消</button>
                </div>
    ...
    <!--过户流程确认完成-->
    <div class="delate_btn1" style="display: none;width: 335px;height: 270px;" id="js_complete_pop">
        <dl class="title_top">
            <dd>过户流程确认完成</dd>
        ...
        <div class="qz_set_input">
            ...
            <p>完成时期：<input type="text" class="aad_pop_select_W200 time_bg" name='confirm_time'
                           value="<?= $bargain['confirm_time'] > 0 ? date('Y-m-d H:m', $bargain['confirm_time']) : date('Y-m-d H:m', time()); ?>"
                           onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm'})"></p>
            </p>
    ...
    <script>
        ...
        function send_massage(id) {
            $("#stage_id").val(id);
            openWin('js_send_massage');
        }
        ...
        function send_complete_massage() {

            $.ajax({
                url: "/bargain/send_complete_massage",
                type: "POST",
                dataType: "json",
                data: {
                    bargain_id: $("#bargain_id").val(),
