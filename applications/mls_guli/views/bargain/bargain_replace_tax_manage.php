                    ...
                    <td width="10%">
                        <?php if ($val['status'] == 0) { ?>
                            <a href="javascript:void(0);"
                               <?php if ($auth['replace_tax_edit']['auth']){ ?>onclick="flow_replace_tax_detail(<?= $val['id']; ?>,<?= $bargain['id'] ?>);"
                               <?php }else{ ?>onclick="window.parent.window.purview_none();"<?php } ?>>修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <a href="javascript:void(0);"
                               <?php if ($auth['replace_tax_delete']['auth']){ ?>onclick="open_replace_tax_delete(<?= $val['id']; ?>);"
