<div class="achievement_money_pop qz_pop_W700"  style="width:840px;">
   ...
   <div class="qz_add_pop_item pop_padT">
        ...
        <dl>
            ...
            <dt style="width:96%;">
                <div class="transfer_process L0">
                    <ul>
                        <?php foreach($val['steps'] as $k =>$v){?>
                        <li class="transfer_process_bg4 srical_W120" style="padding-bottom:10px;">
                            <p title="<?=$v['stage_name1'];?>" class="stepHeight"><?=$v['stage_name2'];?> </p>
                        </li>
                        <li  style="padding-bottom:10px;">
                            <img src="<?php echo MLS_SOURCE_URL;?>/mls_guli/images/v1.0/qz_process5_10.gif"  class="transfer_process_bg2">
                        </li>
                        <?php }?>
                    </ul>
                </div>
...
<script>
    $(function(){
        $('.transfer_process').find('li .transfer_process_bg2').last().remove();

        $(".zws_pop_li_del .transfer_process").find("li:last-child").remove();
    })
