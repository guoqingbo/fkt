            ...
            <form action="" id="add_replace_signing" method="post">
                    ...
                    <ul>
                        <li class="aad_pop_line1_title "
                            ...
                            <select class="aad_pop_select_W100" name="target_type" onchange="select_target_name()">
                                <?php foreach ($config['target_type'] as $key => $val) { ?>
                                    <option value="<?= $key; ?>"
                                            target_idcard="<?= $target_idcard[$key]; ?>" <?= $flow_list['target_type'] == $key ? 'selected' : '' ?>><?= $val . " " . $target_name[$key]; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <li class="aad_pop_line1_title "
                            ...
                            <input type="text" class="aad_pop_select_W100" name="target_idcard"
                                   value="<?= $id ? $flow_list['target_idcard'] : $target_idcard[1]; ?>"
                                   autocomplete="off">
                ...
                <div style="width:98%; padding:1%;float:left;display:inline;font-weight:normal;">
                    <ul>
                        <li class="aad_pop_line1_title "
                            ...
                            <input type="text" class="aad_pop_select_W100" name="bank_account"
                                   value="<?= $flow_list['bank_account']; ?>" autocomplete="off">
                            <div class="errorBox" style="text-indent:92px;"></div>
                        </li>
                        <li class="aad_pop_line1_title "
                            style="width:38%;float:left;display:inline;font-weight:normal;">
                            ...
                            <select class="aad_pop_select_W100" name="replace_type">
                                <?php foreach ($config['should_collect_type'] as $key => $val) { ?>
                ...
                <div style="width:98%; padding:1%;float:left;display:inline;font-weight:normal;">
                    <ul>
                        <li class="" style="width:38%;float:left;display:inline;font-weight:normal;">
                            ...
                            <input type="text" class="aad_pop_select_W100 " name="collect_person"
                                   value='<?= $flow_list['collect_person']; ?>' autocomplete="off">
                            <div class="errorBox" style="text-align:right;"></div>
                        </li>
                        <li class="" style="width:38%;float:left;display:inline;font-weight:normal;">
                            <p class="aad_pop_line1_title_p"><b class="resut_table_state_1"></b>金额：</p>
                            <input type="text" class="aad_pop_select_W70 test_money" name="money_number"
                                   value='<?= $flow_list['money_number']; ?>' autocomplete="off">元
                            <div class="errorBox" style="text-align:right;"></div>
                        </li>
                    </ul>
                </div>
                <div style="width:98%; padding:1%;float:left;display:inline;">
                    <ul>
                        <li class="aad_pop_line1_title "
                            style="width:38%;float:left;display:inline;font-weight:normal;">
                            <p class="aad_pop_line1_title_p"><b class="resut_table_state_1"
                                                                style="font-weight:normal;"></b>费用类别：</p>
                        ...
                        <li class="aad_pop_line1_title "
                            ...
                            <input type="text" class="aad_pop_select_W100" name="money_name"
                                   value="<?= $flow_list['money_name']; ?>" autocomplete="off">
                            <div class="errorBox" style="text-indent:92px;"></div>
                        </li>
                ...
                <div style="width:98%; padding:1%;float:left;display:inline;font-weight:normal;">
                    <ul>
                        <li class="aad_pop_line1_title "
                            style="width:38%;float:left;display:inline;font-weight:normal;">
                            <p class="aad_pop_line1_title_p"><b class="resut_table_state_1"
                                                                style="font-weight:normal;"></b>支付方式：</p>
                        ...
                        <li class="aad_pop_line1_title "
                            ...
                            <input type="text" class="aad_pop_select_W100" name="certificate_number"
                                   value="<?= $flow_list['certificate_number']; ?>" autocomplete="off">
                            <div class="errorBox" style="text-indent:92px;"></div>
                        </li>
                ...
                <div style="width:98%; padding:1%;float:left;display:inline;font-weight:normal;">
                    <ul>
                        <li class="aad_pop_line1_title "
                            style="width:60%;float:left;display:inline;font-weight:normal;">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td width="83%" class="aad_pop_p_T20"><textarea class="aad_pop_select_textare_W"
                                                                        name="replace_remark"><?= $flow_list['remark']; ?></textarea>
                            <div class="errorBox"></div>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table width="100%" align="center">
                    ...
                    <tr>
                        <td style="text-align:center" class="aad_pop_p_T20">
                            ...
                            <button class="btn-hui1" type="button" onclick="closeParentWin('js_replace_pop');">取消
                            </button>
                        </td>
                    </tr>
                    </tbody>
