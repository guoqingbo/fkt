...
<div class="bargain-wrap clearfix">
	...
	<div class="forms_scroll2">
		<!-- 上部菜单选项，按钮-->
		<div class="search_box clearfix" style="margin-top:0;padding:5px 15px 4px 10px" id="js_search_box_02">
			<form name="search_form" id="subform" method="post" action="">
				...
				<div class="fg_box">
					...
					<div class="fg"> <a href="javascript:void(0);" onclick="$('#subform :input[name=page]').val('1');$('#subform').attr('action', '/bargain_flow/replace_list/');form_submit();return false;" class="btn"><span class="btn_inner">搜索</span></a> </div>
					<div class="fg"> <a href="javascript:void(0);" onclick="$('#subform').attr('action', '/bargain_flow/exportreplace/');form_submit();$('#subform').attr('action', '');return false;" class="btn"><span class="btn_inner">导出</span></a> </div>
					<div class="fg"> <a href="/bargain_flow/replace_list" class="reset">重置</a> </div>
				</div>
			</form>
		</div>
<script>
	...
	document.onkeydown = function(e){ //enter
		...
		<div class="table_all">
			<div class="title shop_title" id="js_title">
				<table class="table">
					<tr>
						<td class="c9"  style="width:10%;">签约日期</td>
						<td class="c9"  style="width:10%;">成交编号</td>
						<td class="c9"  style="width:10%;">款类</td>
						<td class="c9"  style="width:10%;">收款方</td>
						<td class="c9"  style="width:10%;"><div class="info"><a href="javascript:void(0)" id="order_area" class="i_text <?php if ($post_param['orderby_id']==1) {echo 'i_down';} else if ($post_param['orderby_id']==2) {echo 'i_up';}?>" onclick="list_order(2);return false;">实收金额<br>(元)</a></div></td>
						<td class="c9"  style="width:10%;">付款方</td>
						<td class="c9"  style="width:10%;"><div class="info"><a href="javascript:void(0)" id="order_area" class="i_text <?php if ($post_param['orderby_id']==3) {echo 'i_down';} else if ($post_param['orderby_id']==4) {echo 'i_up';}?>" onclick="list_order(4);;return false;">实付金额<br>(元)</a></div></td>
						<td class="c11">收付日期</td>
						<td>状态</td>
					</tr>
				</table>
			</div>
			<div class="inner shop_inner" id="js_inner">
				<table class="table" style="*+width:98%;_width:98%;">
					...
					<tr class="<?=$key%2==1?'bg':''?>" onclick="view_detail(<?=$val['f_id'];?>);">
						<td class="c9" style="width:10%;"><div class="info"><?=date('Y-m-d',$val['signing_time']);?></div></td>
						<td class="c9" style="width:10%;"><div class="info c227ac6"><a href="/bargain/bargain_detail/<?=$val['id'];?>"><?=$val['number'];?></a></div></td>
						<td class="c9" style="width:10%;"><div class="info"><?=$config['money_type'][$val['money_type']];?></div></td>
						<td class="c9" style="width:10%;"><div class="info"><?=$config['collect_type'][$val['collect_type']]?$config['collect_type'][$val['collect_type']]:'—';?></div></td>
						<td class="c9" style="width:10%;"><div class="info"><?=$val['collect_money']?strip_end_0($val['collect_money']):'—';?></div></td>
						<td class="c9" style="width:10%;"><div class="info"><?=$config['pay_type'][$val['pay_type']]?$config['pay_type'][$val['pay_type']]:'—';?></div></td>
						<td class="c9" style="width:10%;"><div class="info"><?=$val['pay_money']?strip_end_0($val['pay_money']):'—';?></div></td>
						<td class="c11"><div class="info"><?=$val['flow_time'];?></div></td>
						<td>
		...
		<div class="fun_btn fun_btn_bottom clearfix" id="js_fun_btn">
            <div class="count_info count_info_float">
                <table>
                    <tr>
                        <td style="padding-right:20px;">实收总计：<span class="bold highlight color_fontsize"><?=strip_end_0($total['collect_money_total']);?></span>&nbsp;元</td>
                        <td style="padding-right:20px;">实付总计：<span class="bold highlight color_fontsize"><?=strip_end_0($total['pay_money_total']);?></span>&nbsp;元</td>
                    </tr>
                </table>
            </div>
			<div class="get_page">
...
<!--实收实付详情弹框-->
<div id="js_replace_pop" class="iframePopBox" style="width: 582px;height:413px;border:none;">
    <a class="JS_Close close_pop iconfont" href="javascript:void(0)" date-iframe="1">&#xe60c;</a>
    <iframe frameborder="0" scrolling="no" width="582px" height="413px" class='iframePop' src="" id="replace"></iframe>
</div>
<img src="<?php echo MLS_SOURCE_URL;?>/mls_guli/images/v1.0/009.gif" id="mainloading" ><!--遮罩 loading-->
<script src="<?php echo MLS_SOURCE_URL;?>/min/?f=common/third/My97DatePicker/WdatePicker.js,mls_guli/js/v1.0/house.js,mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/backspace.js"></script>
<script>
$(function () {
    ...
    function view_detail(id){
        $('#replace').attr('src', '/bargain/bargain_replace_detail/'+id);
