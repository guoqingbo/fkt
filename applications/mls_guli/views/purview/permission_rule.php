...
<head>
    ...
    <script src="<?php echo MLS_SOURCE_URL;?>/min/?f=mls_guli/js/v1.0/jquery-1.8.3.min.js"></script>
</head>
...
<body>
    ...
    <script type="text/javascript" src="<?php echo MLS_SOURCE_URL;?>/min/?f=mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/house_list.js,mls_guli/js/v1.0/house.js,mls_guli/js/v1.0/backspace.js,mls_guli/js/v1.0/scrollPic03.js"></script>
</body>
</html>
