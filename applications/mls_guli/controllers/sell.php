...
class Sell extends MY_Controller
{
  ...
  public function publish()
  {
    ...
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js,'
      ...
      . 'mls_guli/js/v1.0/uploadpic2.js,'
      . 'mls_guli/js/v1.0/cooperate_common.js,'
      . 'common/third/jquery-ui-1.9.2.custom.min.js,'
      . 'mls_guli/js/v1.0/group_publish.js');
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/jquery.validate.min.js,'
      . 'mls_guli/js/v1.0/verification.js,mls_guli/js/v1.0/radio_checkbox_mod2.js,mls_guli/js/v1.0/backspace.js,mls_guli/js/v1.0/house_title_template.js,mls_guli/js/v1.0/house_content_template.js');
  ...
  public function house_temp()
  {
    ...
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/jquery.validate.min.js,'
      . 'mls_guli/js/v1.0/verification.js,mls_guli/js/v1.0/backspace.js,mls_guli/js/v1.0/radio_checkbox_mod.js,mls_guli/js/v1.0/house_title_template.js');
  ...
  public function collect_publish($cid)
  {
    ...
    if ($entry == 1 && $house_info['pic_cut'] == 1) {
      $house_info['picurl'] = str_replace('mls_guli/', 'mls_cutout/', $house_info['picurl']);
    }
    ...
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/jquery.validate.min.js,'
      . 'mls_guli/js/v1.0/verification.js,mls_guli/js/v1.0/backspace.js,mls_guli/js/v1.0/radio_checkbox_mod2.js,mls_guli/js/v1.0/house_title_template.js,mls_guli/js/v1.0/house_content_template.js');
...
//    $this_broker_group_id = $this->user_arr['group_id'];
  ...
  private function _add()
  {
    ...
    if ($house_id > 0 || $housee_id > 0) {
      ...
      if ($coo_ziliao_check_1 && $coo_ziliao_check_2 && $coo_ziliao_check_3) {
        ...
        //设置封面
        if (is_full_array($pics['p_filename1']) || is_full_array($pics['p_filename2']) || is_full_array($pics['p_filename3']) || is_full_array($pics['p_filename4'])) {
          if ($pics['add_pic']) {
  ...
  public function lists($page = 1)
  {
    ...
    $data['css'] = load_css('mls_guli/css/v1.0/base.css,'
      . 'mls_guli/third/iconfont/iconfont.css,'
      . 'mls_guli/css/v1.0/guest_disk.css,'
      . 'mls_guli/css/v1.0/myStyle.css,'
      . 'mls_guli/css/v1.0/house_manage.css');

    //需要加载的JS
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js,common/third/jquery-ui-1.9.2.custom.min.js,' . 'mls_guli/js/v1.0/group_publish.js');
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/house_list.js,'
      . 'mls_guli/js/v1.0/jquery.validate.min.js,mls_guli/js/v1.0/house.js,'
      . 'mls_guli/js/v1.0/cooperate_common.js');
    //加载发布页面模板
  ...
  /* 出售详情页面
     ...
     * @param $is_pub 查看来源1客源列表、2合作房源列表，3合作中心合作列表页,4合同管理查看房源，5智能匹配查看房源(非合作)，6智能匹配查看房源(合作)
     * @param $tab int TAB排序
  ...
  public function details($house_id, $is_pub = 1, $tab = 1, $hide_btn = 0, $app_id = 0)
  {
    ...
    if ($is_pub == 1 || $is_pub == 4) //4为合同管理查看房源
    {
      ...
      $view_other_per = $this->broker_permission_model->check('1', $owner_arr);
        /*      if (!$view_other_per['auth'] || $this_broker_group_id != '2') {
          $this->redirect_purview_none_iframe('js_pop_box_g');
          exit();
        }*/
    ...
    if (is_full_array($house_info)) {
      ...
      //底部JS
      $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/house_list.js,mls_guli/js/v1.0/house.js,'
        . 'mls_guli/js/v1.0/backspace.js,mls_guli/js/v1.0/scrollPic_0630.js');
      //加载详情页面模板
  ...
  public function house_print($house_id = 0)
  {
    ...
    if (intval($house_id) > 0) {
      ...
      //$house_details['qrcode'] = get_qrcode(MLS_SIGN_URL . '/' . $this->user_arr['city_spell'] . '/broker_info/broker_details/' . $this->user_arr['broker_id'], $this->user_arr['city_spell']);
    }
    //加载出售基本配置MODEL
    $this->load->model('house_config_model');
    //获取出售信息基本配置资料
    ...
    $data['css'] = load_css('mls_guli/css/v1.0/base.css,mls_guli/third/iconfont/iconfont.css'
      . ',mls_guli/css/v1.0/house_manage.css'
      . ',mls_guli/css/v1.0/house_new.css'
      . ',mls_guli/css/v1.0/myStyle.css');
    //需要加载的JS
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js');
    //加载详情页面模板
  ...
  public function add_brower_log()
  {
    ...
    if ('1' == $is_secret_follow) {
      ...
      if (is_int($result) && $result > 0) {
        $return_data = 'add_success';
      } else {
        $return_data = 'add_failed';
      }
    } else {
      $return_data = 'add_failed';
    }
  ...
  public function match($house_id, $is_public = 0)
  {
    ...
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/house_list.js,mls_guli/js/v1.0/jquery.validate.min.js,'
...
//    $this_broker_group_id = $this->user_arr['group_id'];
    ...
    if (!$get_secret_per['auth']) {
      $this->redirect_purview_none_iframe();
      exit();
    } else {
      if (!$agency_secret_per) {
        $this->redirect_purview_none_iframe();
  ...
  private function _get_cond_str($form_param)
  {
    ...
    if (isset($form_param['telno']) && $form_param['telno'] != '') {
      $cond_where .= " AND (telno1 = '" . $form_param['telno'] . "' or telno2='" . $form_param['telno'] . "' or telno3='" . $form_param['telno'] . "') ";
    }
  ...
  public function lists_pub($page = 1, $friend = '')
  {
    ...
    $blockname = $this->input->post('blockname', true);
    if (empty($post_param['set_share_time'])) {
    ...
    if ($is_submit_form) {
      $sell_lists_pub = array(
        'set_share_time' => $post_param['set_share_time'],
        'sell_type' => $post_param['sell_type'],
        'district' => $post_param['district'],
        'street' => $post_param['street'],
        'block_name' => $post_param['block_name'],
    ...
    if (!empty($post_param['block_name'])) {
      if ($friend == 'friend' || $friend == 'manage') {
    ...
    //获取列表内容
    $list = $this->sell_house_model->get_list_by_cond_or_like($cond_where, $cond_or_like, $this->_offset, $this->_limit, $order_arr['order_key'], $order_arr['order_by'], 'set_share_time', 'desc');
    ...
    $data['css'] = load_css('mls_guli/css/v1.0/base.css,'
      . 'mls_guli/third/iconfont/iconfont.css,'
      . 'mls_guli/css/v1.0/house_manage.css,mls_guli/css/v1.0/myStyle.css');
    //需要加载的JS
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js,'
      . 'mls_guli/js/v1.0/cooperate_common.js,'
  ...
  //房源跟进
  public function house_follow($house_id, $num = 1, $task = 0)
  {
    //新权限
    //获得当前数据所属的经纪人id和门店id
    $this->sell_house_model->set_search_fields(array('broker_id', 'agency_id', 'company_id', 'is_seal', 'keys', 'key_number'));
    $this->sell_house_model->set_id($house_id);
    $owner_arr = $this->sell_house_model->get_info_by_id();
    ...
    if (!$house_follow_per['auth']) {
      $this->redirect_purview_none_iframe('js_genjin');
      exit();
    } else {
    ...
    $data['css'] = load_css('mls_guli/css/v1.0/base.css,'
      ...
      . 'mls_guli/css/v1.0/house_manage.css');
    //需要加载的JS
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js,common/third/swf/swfupload.js,mls_guli/js/v1.0/upload_wei.js,mls_guli/js/v1.0/cooperate_common.js,common/third/jquery-ui-1.9.2.custom.min.js');
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/house_list.js,mls_guli/js/v1.0/jquery.validate.min.js,mls_guli/js/v1.0/backspace.js,'
          ...
          if ('1' == $datainfo['is_public']) {
            ...
            if ($update_result) {
              ...
              $customer_follow_arr['follow_way'] = 12;
                $customer_follow_arr['text'] = '受托人从 无 >> ' . $this->user_arr['truename'];
              $this->follow_model->set_tbl($tbl);
      ...
      if ('1' == $datainfo['is_public']) {
        ...
        if ($update_result) {
          ...
          $follow_arr['follow_way'] = 8;
            $follow_arr['text'] = '受托人从 无 >> ' . $this->user_arr['truename'];
          $this->follow_model->set_tbl($tbl);
...
//                        break;
  ...
  public function report($house_id, $broker_id)
  {
    ...
    $data['js'] = load_js('mls_guli/js/v1.0/jquery-1.8.3.min.js,'
      . 'common/third/swf/swfupload.js,'
      . 'mls_guli/js/v1.0/uploadimg.js,'
      . 'mls_guli/js/v1.0/cooperate_common.js'
    );
    //底部JS
    $data['footer_js'] = load_js('mls_guli/js/v1.0/openWin.js,mls_guli/js/v1.0/jquery.validate.min.js,'
      . 'mls_guli/js/v1.0/verification.js,mls_guli/js/v1.0/backspace.js');
  ...
  public function import()
  {
    if (!empty($_POST['sub'])) {
      ...
      if ($this->upload->do_upload('upfile')) {
        ...
        $result = '<!DOCTYPE html><html><head lang="en"><meta charset="UTF-8"><title>空白页面</title><link type="text/css" rel="stylesheet" href="' . MLS_SOURCE_URL . '/min/?f=mls_guli/css/v1.0/base.css"></head><body style="background:#F2F2F2;"><p class="up_m_b_date_up" style="text-align: center;"><span class="up_e">上传失败</span>，请选择文件上传</p></body></html>';
      }
      echo $result;
  ...
  public function share_tasks($house_id, $num)
  {
    ...
    if ($house_id) {
      ...
      if (!$share_tasks_per['auth']) {
        $this->redirect_purview_none_iframe('js_fenpeirenwu');
        exit();
      } else {
  ...
  public function allocate_house($house_id)
  {
    ...
    if ($house_id) {
      ...
      if (!$allocate_house_per['auth']) {
        $this->redirect_purview_none_iframe('js_allocate_house');
        exit();
      } else {
  ...
  public function add_allocate_house()
  {
    ...
    if ($run_broker_id != $broker_id) {
      $return_id = $this->sell_house_model->update_info_by_cond(array('broker_id' => $run_broker_id), $cond_where);
    }
...
//            }
  ...
  public function pic_deal()
  {
    ...
    if ('success' == $fileurl) {
      echo "<img src='" . MLS_SOURCE_URL . "/mls_guli/images/v1.0/house_print/" . $pic_file_name . "'>";
      if ($is_print == 1) {
        echo "<script>window.print();</script>";
      }
    } else {
      Header("Location: " . MLS_SIGN_URL);
    }
    exit;
  }
...
//    $this_broker_group_id = $this->user_arr['group_id'];
  ...
  public function submit_secret_info()
  {
    ...
    if (isset($house_id) && !empty($house_id)) {
      $this->sell_house_model->set_search_fields(array('dong', 'unit', 'door', 'owner', 'telno1', 'telno2', 'telno3', 'idcare'));
      $this->sell_house_model->set_id($house_id);
      $sell_backinfo = $this->sell_house_model->get_info_by_id();//修改前的信息
...
/* Location: ./application/mls_guli/controllers/sell.php */
