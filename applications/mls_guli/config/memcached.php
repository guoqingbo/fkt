...
$memcached['config'] = array(
  ...
  'auto_compress_savings' => 0.2, // Specifies the minimum amount of savings to replacely store the value compressed. The supplied value must be between 0 and 1.
  'expiration' => 3600,    // Default content expiration value (in seconds)
  'delete_expiration' => 0    // Default time between the delete command and the replace delete action occurs (in seconds)
);

//是否开启调试模式，强制清除所有缓存
$memcached['debug'] = FALSE;

$config['memcached'] = $memcached;

/* End of file memcached.php */
/* Location: ./applications/config/memcached.php */
