...
class Contract_warrant_model extends Warrant_base_model
{
   ...
   * @var string
   */
  private $_tbl = 'contract_warrant_step';
  ...
  public function get_all_by_cid($cid)
  {
    ...
    //查询条件
    $this->dbback_city->where("contract_id", $cid);
    //排序条件
  ...
  {
    $this->db_city->where('contract_id', $cid);
    $this->db_city->delete($this->_tbl);
    return $this->db_city->affected_rows();
  }
}
