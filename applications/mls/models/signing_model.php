 ...
 * @author          lalala
 */
load_m("Appointment_base_model");

class Signing_model extends Appointment_base_model
{
  ...
  public function get_info_by_id($id)
  {
     ...
     * 根据房源id，查询房源是否预约
     */
    public function get_info_by_houseid($house_id)
    {
        //查询字段
        $cond_where = "house_id = {$house_id} and type = 1 and status != 5 ";
