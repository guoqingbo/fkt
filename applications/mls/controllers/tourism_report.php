...
class Tourism_report extends MY_Controller
{
  ...
  public function index()
  {
    ...
    if (is_full_array($list)) {
      foreach ($list as $key => $val) {
        ...
        if ($val['house_id']) {
          ...
          $list[$key]['house_info'] = $house_info['province_name'] . $house_info['block_name'] . $base_config['abroad_house_type'][$house_info['house_type']] . ' - ' . $house_info['avg_price'] . '万元';
        } else {
          $list[$key]['house_info'] = '—';
        }
    ...
    $this->view('tourism/tourism_report', $data);
  }
