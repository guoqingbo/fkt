...
<div class="pop_box_g" id="" style="display:block;background: #fff">
    <div class="hd">
        <div class="title"><?=$truename?>查看保密信息数据</div>
        <div class="close_pop"><a href="javascript:void(0);" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">
        <div class="logging_data_tab">
            <a href="/count_info/detail/<?=$broker_id?>/8/1/<?=$search_time?>" class="tab fl <?=$checked1?>"><?=$show_html1?>出售</a>
            <a href="/count_info/detail/<?=$broker_id?>/8/2/<?=$search_time?>" class="tab fl <?=$checked2?>"><?=$show_html2?>出租</a>
            <a href="/count_info/detail/<?=$broker_id?>/8/3/<?=$search_time?>" class="tab fl <?=$checked3?>"><?=$show_html3?>求购</a>
            <a href="/count_info/detail/<?=$broker_id?>/8/4/<?=$search_time?>" class="tab fl <?=$checked4?>"><?=$show_html4?>求租</a>
        </div>
