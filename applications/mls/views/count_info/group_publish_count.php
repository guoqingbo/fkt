...
<div class="data_aly_content clearfix" style="padding-top:13px;background:#fff">
	<div class="main_menu fl" style="width:150px;border:1px solid rgb(230,230,230)">
		<div class="tab_box wh_hover" id="js_tab_box" style="background:#fff;border:none;height:94px;overflow:hidden">
            ...
            <a href="/count_info/mass_count/1" class="link link_on">站点发布</a>
        ...
        <div class="content_r">
            ...
            <div class="top_bar clearfix">
				...
				<div class="top_bar_r fr">
					...
					<input type="button" class="re" value="重置" onclick="location.href='/count_info/mass_count/1'">
				</div>
            </div>
            ...
            <div class="middle_bar clearfix">
                ...
                <a class="daochu fr" style="text-align:center; line-height:24px;"  onclick="$('#search_form').attr('action', '/count_info/export_count/1');$('#search_form').submit();$('#search_form').attr('action', '');return false;">导出</a>
            </div>
...
var first_date = new Array();
		...
		first_date[5] = $(".date_per").eq(0).find("td").eq(7).html();
		first_date[6] = $(".date_per").eq(0).find("td").eq(8).html();
