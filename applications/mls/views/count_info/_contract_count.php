...
<div class="data_aly_content clearfix" style="padding-top:13px;background:#fff">
	<div class="main_menu fl" style="width:150px;border:1px solid rgb(230,230,230)">
		<div class="tab_box wh_hover" id="js_tab_box" style="background:#fff;border:none;height:94px;overflow:hidden">
			...
			<a href="/count_info/performance_count/1" class="link link_on">合同统计</a>
	...
	<form name="search_form" id="search_form" method="post" action="" >
		...
		<div class="middle_bar clearfix">
			...
			<a class="daochu fr" style="text-align:center; line-height:24px;" href="/count_info/performance_count_export/2/<?=$post_param['agency_id']?>/<?=$post_param['type']?>/<?=$post_param['start_date']?>/<?=$post_param['end_date']?>/<?=$post_param['broker_id']?>">导出</a>
		</div>
		<div class="table_all">
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td class="c14">
								<div class="info">
									<a href="javascript:void(0);" onclick="order(1);return false;" class="i_text2 <?php if($post_param['type'] == 1 ){ echo 'i_down2'; } ?>">二手房签单<br></a>
								</div>
							</td>
							<td class="c14">
								<div class="info">
									<a href="javascript:void(0);" onclick="order(2);return false;" class="i_text2 <?php if($post_param['type'] == 2 ){ echo 'i_down2'; } ?>">租房签单<br></a>
								</div>
							</td>
							<td class="c14">
								<div class="info">
									<a href="javascript:void(0);" onclick="order(3);return false;" class="i_text2 <?php if($post_param['type'] == 3 ){ echo 'i_down2'; } ?>">托管签单<br></a>
								</div>
							</td>
							<td class="c14">
								<div class="info">
									<a href="javascript:void(0);" onclick="order(4);return false;" class="i_text2 <?php if($post_param['type'] == 4 ){ echo 'i_down2'; } ?>">托管出租签单<br></a>
								</div>
							</td>
							<td>
								<div class="info">
									<a href="javascript:void(0);" onclick="order(0);return false;" class="i_text2 <?php if(!$post_param['type'] ){ echo 'i_down2'; } ?>">总计<br></a>
								</div>
							</td>
						</tr>
					<tbody>
						...
						if($broker_info_new){
							foreach ($broker_info_new as $key=>$vo){?>
								<tr>
									...
									<td class="c14"><?=$vo['broker_name']?></td>
									<td class="c14"><?=$vo['contract_sell_total']?></td>
									<td class="c14"><?=$vo['contract_rent_total']?></td>
									<td class="c14"><?=$vo['collocation_contract_total']?></td>
									<td class="c14"><?=$vo['collocation_rent_total']?></td>
									<td><?=$vo['total_total']?></td>
								</tr>
						<?php }} ?>
					</tbody>
				</table>
