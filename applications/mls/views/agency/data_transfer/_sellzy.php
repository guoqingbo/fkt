...
<div class="search_box clearfix" id="js_search_box"> <a href="javascript:void(0)" class="s_h" onclick="show_hide_info(this)" data-h="0">展开<span class="iconfont"></span></a>
    <form name="search_form" id="search_form" method="post" action="<?php echo MLS_URL;?>/data_transfer/index">
        ...
        <div class="fg_box">
			...
			<div class="fg">
				<select class="select" id='district' name='dist_id' >
...
<div class="table_all">
    ...
    <div style="height: 226px;" class="inner shop_inner" id="js_inner">
        <table class="table">
			...
			foreach($list as $key =>$val) {//print_r($val);echo "<br>";?>
            <tr class="bg">
                <td class="c2">
                    <div class="info">
                ...
                <td class="c3">
                    <div class="info"><?php echo strip_end_0($val['price']); ?></div>
                </td>
                <td class="c4">
                    <div class="info"><?php echo round($val['avgprice']); ?></div>
                </td>
                <td class="c6">
...
<script type="text/javascript">
    ...
    function _move_data(move_type)
    {
		...
		if(move_type==1){
			...
			var id_string = $("#sell_id_all_string").val();
			id = id_string.split(",");
		}else{
			return false;
		}
