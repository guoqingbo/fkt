...
<div class="contract-wrap clearfix">
	...
	<div class="forms_scroll2">
		...
		<div class="search_box clearfix" style="margin-top:0;padding:5px 15px 4px 10px;overflow: hidden" id="js_search_box_02">
			<form name="search_form " class="" id="subform" method="post" action="">
				<div class="fg_box">
				...
				<div class="fg_box">
					...
					<div class="fg"> <a href="javascript:void(0);" onclick="$('#subform :input[name=page]').val('1');$('#subform').attr('action', '/contract_flow/actual_list/');form_submit();return false;" class="btn"><span class="btn_inner">搜索</span></a> </div>
					<div class="fg"> <a href="javascript:void(0);" onclick="$('#subform').attr('action', '/contract_flow/exportActual/');form_submit();$('#subform').attr('action', '');return false;" class="btn"><span class="btn_inner">导出</span></a> </div>
					<div class="fg"> <a href="/contract_flow/actual_list" class="reset">重置</a> </div>
				</div>
			</form>
		</div>
<script>
			...
			<div class="inner shop_inner" id="js_inner">
				<table class="table" style="*+width:98%;_width:98%;">
					...
					<tr class="<?=$key%2==1?'bg':''?>" onclick="view_detail(<?=$val['f_id'];?>);">
						...
						<td class="c9" style="width:10%;"><div class="info c227ac6"><a href="/contract/contract_detail/<?=$val['id'];?>"><?=$val['number'];?></a></div></td>
...
$(function () {
    ...
    function view_detail(id){
        $('#actual').attr('src', '/contract/contract_actual_detail/'+id);
