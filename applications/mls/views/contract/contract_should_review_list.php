		...
		<div class="search_box clearfix" style="margin-top:0;overflow: hidden" id="js_search_box_02">
			<form name="search_form" id="subform" method="post" action="">
				...
				<div class="fg_box">
					...
					<div class="fg"> <a href="/contract_flow/should_review_list" class="reset">重置</a> </div>
				</div>
			</form>
		</div>
<script>
			...
			<div class="title shop_title" id="js_title">
				<table class="table">
					<tr>
						...
						<td class="c6">款类</td>
						<td class="c6">收款方</td>
						<td class="c10"><div class="info">应收金额</div></td>
						<td class="c6">付款方</td>
						<td class="c10"><div class="info">应付金额</div></td>
                        <td class="c6">录入门店</td>
                        <td class="c6">录入人</td>
