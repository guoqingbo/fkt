...
<div id="js_search_box" class="shop_tab_title" style="margin-bottom:0">
	<a href="/sell/group_publish" class="link">出售<span class="iconfont hide">&#xe607;</span></a>
   <a href="/rent/group_publish" class="link link_on">出租<span class="iconfont hide">&#xe607;</span></a>
</div>
...
<div id="js_search_box_02" style="padding-bottom:1px;">
	...
	<div class="configuration_website">
       <div style="float:left"><?php if($siteinfo){?>已配置站点：<?php foreach($siteinfo as $key=>$val){?><span class="t"><?php echo $val['name'];?></span><?php }} ?><a href="/site_set/index" class="l">配置站点</a></div>
    ...
    <div class="inner shop_inner" id="js_inner">
        <table class="table table_q">
            ...
            <tr <?php if($key % 2 == 1){ ?>class="bg" <?php }?> id="tr<?php echo $val['id'];?>">
                ...
                <td ><div class="info info_p_r"><a href="javascript:void(0);" onclick="group_publish('rent',<?php echo $val['id'];?>);" class="fun_link">发布</a><span class="fg">|</span><a href="javascript:void(0);"  class="fun_link"  onClick="fun_ref(<?php echo $val['id'];?>);">刷新</a><span class="fg">|</span><a href="/rent/modify/<?php echo $val['id'];?>"  class="fun_link">编辑</a><span class="fg">|</span><a href="javascript:void(0);"  class="fun_link"  onClick="fun_esta(<?php echo $val['id'];?>);">下架</a></div></td>
            </tr>
            <?php
                }
            }else{
...
<script>
    function fun_ref(house_id){
        $.ajax({
            type: 'get',
            url : '/rent/change_zsb/'+house_id+'/1',
            dataType:'json',
    ...
    function fun_esta(house_id){
        $.ajax({
            type: 'get',
            url : '/rent/change_zsb/'+house_id+'/2',
            dataType:'json',
            success: function(msg){
                if(msg['state'] == 'success'){
                    openWin('js_pop_do_success');
