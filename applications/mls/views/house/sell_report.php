...
<div class="pop_box_g report_box" id="js_woyaojubao" style="display:block;border:0;">
    ...
    <div class="report_box">
    	<div class="report_tips clearfix">
    		<p style="line-height:30px; ">为了共同打造真实可靠的合作平台，举报经核实后将奖励您一定的积分</p>

    	</div>

    	<form name="fileform_head"  id="fileform_head" enctype="multipart/form-data" >
    		<table class="table report_table" style="margin-top:0;">
    			<tr class="retrbg">
...
swfu1 = new SWFUpload({
 ...
 <div style="width:66px; height:26px; padding-top:10px;">
    		...
    		<input class="btn-lv1 btn-mid" type="button"  value="举报" onclick="add_report()" id="repot">
