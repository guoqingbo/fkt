...
<div class="search_box clearfix" id="js_search_box"> <a href="javascript:void(0)" class="s_h" onClick="show_hide_info(this)" data-h="0">展开<span class="iconfont">&#xe609;</span></a>
    ...
    <div class="fg_box hide">
        ...
        <div class="fg">
            <input type="text" class="input w100 time_bg" id="start_time" name="start_time" value="<?php echo $post_param['start_time'];?>" onclick="WdatePicker()">
        </div>
        <p class="fg fg_tex fg_tex02">—</p>
        <div class="fg">
            <input type="text" class="input w100 time_bg" id="end_time" name="end_time" value="<?php echo $post_param['end_time'];?>" onclick="WdatePicker()">
        </div>
...
<div class="pop_box_g pop_see_inform pop_no_q_up" id="js_pop_msg1">
    <div class="hd">
        <div class="title">提示</div>
        <div class="close_pop">
            <a class="JS_Close iconfont msg_iconfont_close" title="关闭" href="<?php echo MLS_URL;?>/key/index"></a>
        </div>
    </div>
    <div class="mod">
        <div class="inform_inner">
...
function change_dong(){
    ...
    if(block_id){
        $.ajax({
            url: "<?php echo MLS_URL;?>/key/get_dong_list/",
            type: "GET",
            dataType: "json",
            data: {
                block_id:block_id
...
function change_unit(){
    ...
    if(block_id){
        $.ajax({
            url: "<?php echo MLS_URL;?>/key/get_unit_list/",
            type: "GET",
            dataType: "json",
            data: {
                block_id:block_id,
...
function open_details(id)
{
	...
	//ajax异步获取钥匙详情信息
    $.ajax({
        url: "<?php echo MLS_URL;?>/key/details/"+id,
        type: "GET",
        dataType: "json",
        data: {
            isajax:1
