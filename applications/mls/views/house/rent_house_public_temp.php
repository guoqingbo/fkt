...
<script>
    ...
    $("#btn-save-tmp").click(function(){
        ...
        $.post("/rent/save_new_tmp",{template_name:template_name, remark:remark},function(data){
            if(data.status == 1) {
                ...
                $(".msg_iconfont_close").click(function(){
                    ...
                    $("#btn-manage-tmp",parent.document).before('<a href="javascript:void(0);" class="mobanBtn_N mobanBtn_N_'+data.template_id+'" data-id="'+data.template_id+'">' +
