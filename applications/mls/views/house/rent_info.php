                ...
                <table class="table">
					...
					<tr>
						...
						<td class="w170">
                            <!--房源列表详情和合作列表房源详情分离
                            -->
                            <?php if (1 == $is_pub || 4 == $is_pub || 5 == $is_pub || $is_pub == 7) {
                    ...
                    <tr>
                        <?php if (1 == $is_pub || 5 == $is_pub || $is_pub == 7) { ?>
                        ...
                        <?php if(!('1'==$data_info['is_public'])){ ?>
                            <?php if( $data_info['lock']==0 || in_array( $broker_id , array($data_info['broker_id'],$data_info['lock']) ) ){ ?>
                                <?php if ($is_pub == 7) { ?>
                                    <a id="show_baomi_button"
                                       onClick="show_rentbaomi_info('<?php echo $data_info['id']; ?>','rent','district')"
                                       href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 查看保密信息</a>
                                <?php } else { ?>
                                    <a id="show_baomi_button"
                                       onClick="show_rentbaomi_info('<?php echo $data_info['id']; ?>','rent')"
                                       href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 查看保密信息</a>
                                <?php } ?>
                            <a style="display:none;" id="modify_baomi_button" onClick="modify_baomi_info(<?php echo $modify_secret_per; ?>)" href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 编辑保密信息</a>
                                <a style="display:none;" id="modify_baomi_submit_button"
                                   onClick="submit_baomi_info(<?php echo $data_info['id']; ?>,'rent')"
        ...
        <div class="tab_pop_bd">
            ...
            <?php }else{ ?>
                <div>
                    ...
                    <form action="<?php echo MLS_URL;?>/rent/download_pic/<?php echo $data_info['id']; ?>" method="get">
            ...
            <?php } else if ($is_pub == 7) { ?>
                <div class="tab_pop_bd">
                    <div>
                        ...
                        <a id="rent_house_match" class="btn-lan" href="javascript:void(0);"
                           onclick="parent.open_match('rent',0,<?php echo $data_info['id']; ?>)"><span>智能匹配</span></a>
                        <a class="btn-lan" style="position:relative;z-index: 11" href="javascript:void(0);"
                           onclick="parent.xq_openfollow('rent',<?php echo $data_info['id'] ?>,1,'district')"><span>房源跟进</span></a>
                    </div>
                </div>
            <?php } ?>
        <?php } ?>
