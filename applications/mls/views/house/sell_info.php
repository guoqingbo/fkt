<div class="pop_box_g" id="js_pop_box_g"  style="display:block; border:none">
    ...
    <div class="mod">
        <div class="tab_pop_hd">
            <div class="clearfix">
                <?php if ($is_pub == 1 || $is_pub == 4 || $is_pub == 5 || $is_pub == 7) { ?>
                <a class=" item <?php if($tab == 1) { ?> itemOn <?php }?>" href="/sell/details_house/<?php echo $data_info['id'];?>/<?=$is_pub?>/1/<?php echo $hide_btn;?>/<?=$app_id?>">房源详情</a>
                <a class=" item <?php if($tab == 2) { ?> itemOn <?php }?>" href="/sell/details_secret/<?php echo $data_info['id'];?>/<?=$is_pub?>/2/<?php echo $hide_btn;?>/<?=$app_id?>">保密信息</a>
                <a class=" item <?php if($tab == 3) { ?> itemOn <?php }?>" href="/sell/details_image/<?php echo $data_info['id'];?>/<?=$is_pub?>/3/<?php echo $hide_btn;?>/<?=$app_id?>">房源图片</a>
				<?php if($data_info['video_id']){?>
				<a class=" item <?php if($tab == 7) { ?> itemOn <?php }?>" href="/sell/details_video/<?php echo $data_info['id'];?>/<?=$is_pub?>/7/<?php echo $hide_btn;?>/<?=$app_id?>">房源视频</a>
				<?php }?>
                <?php if($xiaoquflag == 1){?>
                <a class=" item <?php if($tab == 4) { ?> itemOn <?php }?>" href="/sell/details_district/<?php echo $data_info['id'];?>/<?=$is_pub?>/4/<?php echo $hide_btn;?>/<?=$app_id?>">小区概况</a>
                <?php }?>
				<?php }?>
				...
				<?php if($data_info['video_id']){?>
				<a class=" item <?php if($tab == 7) { ?> itemOn <?php }?>" href="/sell/details_video/<?php echo $data_info['id'];?>/<?php echo $is_pub;?>/7/<?php echo $hide_btn;?>/<?=$app_id?>">房源视频</a>
				<?php }?>
                <?php if($xiaoquflag == 1){?>
                ...
                <a class=" item <?php if($tab == 6) { ?> itemOn <?php }?>" href="/sell/details_map/<?php echo $data_info['id'];?>/<?php echo $is_pub;?>/6/0/<?=$app_id?>">小区地图</a>
                <?php }?>
                <?php if($is_pub == 1 || $is_pub == 5){?>
				 <a class=" item <?php if($tab == 5) { ?> itemOn <?php }?>" href="/sell/details_hezuo/<?php echo $data_info['id'];?>/1/5/<?php echo $hide_btn;?>/<?=$app_id?>">合作统计</a>
                <?php }?>
            </div>
        </div>
        <div class="tab_pop_mod clear" id="js_tab_b01" <?php if($tab==6){?>style="overflow:auto;"<?php } ?>>
			...
			<?php $type = '暂不售（租）';?>
                <table class="table">
                    <?php if ($is_pub == 1 || $is_pub == 4 || $is_pub == 5 || $is_pub == 2 || $is_pub == 7) { ?>
					<tr>
                    ...
                    <tr>
                        ...
                        <td class="w170">
                            <!--房源列表详情和合作列表房源详情分离
                            -->
                            <?php if (1 == $is_pub || 4 == $is_pub || $is_pub == 7) {
					...
					<tr>
                        <td class="w70 t_l">物业类型：</td>
                        <td class="w170" style="color:#F75000"><?php if($data_info['sell_type']){ echo $config['sell_type'][$data_info['sell_type']];} ?></td>
                        <td class="w70 t_l">使用面积：</td>
                        <td style="color:#F75000"><?php echo strip_end_0($data_info['usage_area']); ?>平方米</td>
                    </tr>
					<?php }?>
                    <?php if ($is_pub == 1 || $is_pub == 4 || $is_pub == 5 || $is_pub == 7){ ?>
                    <tr>
					...
					<tr>
                        ...
                        <td class="w170" style="color:#F75000">
                        <?php
                            if(1 == $data_info['isshare']){
                                echo '是';
                            }else if(2 == $data_info['isshare']){
                                echo '店长审核中';
                            }else if(3 == $data_info['isshare']){
                                echo '资料审核中';
                            }else{
                                echo '否';
                            }
                        ...
                        <?php if(intval($data_info['isshare'])>0 && intval($data_info['reward_type'])>0){ ?>
						<tr>
                        <td colspan="6">
                            <div class="share">
                                 <table>
                                     <?php if('1' == $data_info['reward_type']){ ?>
                                        <tr>
                                            <td width="120"><strong>房源合作佣金分配</strong></td>
                                            <td>甲方可获得本次交易双方佣金总金额&nbsp;<strong class="f60 f14"><?=$data_info['commission_ratio_arr']['house']?></strong><em>|</em>乙方可获得本次交易双方佣金总金额&nbsp;<strong class="f60 f14"><?=$data_info['commission_ratio_arr']['customer']?></strong>
                                            <p class="b8b7b7">注：此佣金分配方案仅做参考，具体佣金方案需经纪人线下商定</p></td>
                                        </tr>
                                     <?php }else if('2' == $data_info['reward_type']){ ?>
                                        <tr class="tr-one">
                                            <td><strong>房源合作悬赏赏金</strong></td>
                                            <td><strong class="f60 f14">¥<?php echo $data_info['cooperate_reward'];?> 元</strong>
                                            <p class="b8b7b7">注：待房源成交后合作方将会获得一定的奖金，具体金额以双方协商为准</p></td>
                                        </tr>
                                     <?php } ?>
								</table>
                                <div class="arrow"></div>
				...
				<table class="table">
                    ...
                    <td>
                        <div class="ie-break-all"><?php
                            if($data_info['sell_tag_arr']){
                                foreach($data_info['sell_tag_arr'] as $key => $val)
                                {
                                    if($val)
                                    {
                                        echo $config['sell_tag'][$val].'、';
                                    }
                                }
                            }
                        ?></div>
                ...
                <?php if($is_pub == 2 || $is_pub == 6){ ?>
                    <?php if('2' == $data_info['house_degree']){ ?>
                        <p class="youzhi">该房源为优质房源，赶快申请合作吧</p>
                    <?php }else if('3' == $data_info['house_degree']){?>
                        <p class="dujia">该房源为独家房源，赶快申请合作吧</p>
                    <?php } ?>
                <?php } ?>
            </div>
            <?php } ?>
                    ...
                    <table class="table" id="js_table_ys">
                        ...
                        <tr>
                            ...
                            <td class="w170">
                                ...
                                <input style="display:none;" class="input_text input_text_r w60" name="dong"
                                       placeholder="请输入数字"
                                       id="dong_input" value="<?php echo $data_info['dong']; ?>" type="text"><span
                                        style="margin-left: -20px;display: none" class="iconfont">&#xe607;</span>
                                <!--                                <select name="dong" id="dong_input" class="select" style="display:none;">-->
                                <!--                                    <option value="">请选择</option>-->
                                <!--                                    --><?php //for ($i=1; $i<=50; $i++) { ?>
                                <!--                                        <option value="-->
                                <?php //echo $i; ?><!--" -->
                                <?php //if ($i == $data_info['dong']) {echo 'selected="selected"';} ?><!-->
                                <?php //echo $i; ?><!--</option>-->
                                <!--                                    --><?php //} ?>
                                <!--                                </select>-->
                            </td>
                            ...
                            <td>
                                ...
                                <input style="display:none;" class="input_text input_text_r w60" name="unit"
                                       placeholder="请输入数字"
                                       id="unit_input" value="<?php echo $data_info['unit']; ?>" type="text"><span
                                        style="margin-left: -20px;display: none" class="iconfont">&#xe607;</span>
                                <!--                                <select name="unit" id="unit_input" class="select" style="display:none;">-->
                                <!--                                    <option value="">请选择</option>-->
                                <!--                                    --><?php //for ($i=1; $i<=10; $i++) { ?>
                                <!--                                        <option value="-->
                                <?php //echo $i; ?><!--" -->
                                <?php //if ($i == $data_info['unit']) {echo 'selected="selected"';} ?><!-->
                                <?php //echo $i; ?><!--</option>-->
                                <!--                                    --><?php //} ?>
                                <!--                                </select>-->
                                <strong class="color js_y_hide hide">3</strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="w170">
                                ...
                                <input style="display:none;" class="input_text input_text_r w60" name="door"
                                       placeholder="请输入数字"
                                       id="door_input" value="<?php echo $data_info['door']; ?>" type="text"><span
                                        style="margin-left: -20px;display: none" class="iconfont">&#xe607;</span>
                                <!--                                <select name="door" id="door_input" class="select" style="display:none;">-->
                                <!--                                    <option value="">请选择</option>-->
                                <!--                                    --><?php //for ($i=101; $i<=5099; $i++) { ?>
                                <!--                                        <option value="-->
                                <?php //echo str_pad($i, 4, "0", STR_PAD_LEFT); ?><!--" -->
                                <?php //if (str_pad($i, 4, "0", STR_PAD_LEFT) == $data_info['door']) {echo 'selected="selected"';} ?><!-->
                            ...
                            <script type="text/javascript">
                                $(function () {
                                    ...
                                    autoselect($("#door_input"), "door")
                                    autoselect($("#unit_input"), "unit")
                                    autoselect($("#dong_input"), "dong")
                                });
                            </script>
                        ...
                        <tr>
                            ...
                            <td class="w170">
                                <strong class="color js_y_hide" id="idcare">
                                    <?php
                                        if('1'==$data_info['is_public']){
                                            echo $data_info['idcare'];
                                        }else{
                                            echo '***';
                                        }
                                    ?>
                    ...
                    <p class="link_btn_b">
                        <?php if(!('1'==$data_info['is_public'])){ ?>
                            <?php if( $data_info['lock']==0 || in_array( $broker_id , array($data_info['broker_id'],$data_info['lock']) ) ){ ?>
                                ...
                                <?php if ($is_pub == 7) { ?>
                                    <a id="show_baomi_button"
                                       onClick="show_baomi_info('<?php echo $data_info['id']; ?>','sell','district')"
                                       href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 查看保密信息</a>
                                <?php } else { ?>
                                    <a id="show_baomi_button"
                                       onClick="show_baomi_info('<?php echo $data_info['id']; ?>','sell')"
                                       href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 查看保密信息</a>
                                <?php } ?>
                            <a style="display:none;" id="modify_baomi_button" onClick="modify_baomi_info(<?php echo $modify_secret_per; ?>)" href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 编辑保密信息</a>
                                <a style="display:none;" id="modify_baomi_submit_button"
                                   onClick="submit_baomi_info(<?php echo $data_info['id']; ?>,'sell')"
                                   href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 保存修改</a>
                            <?php }else{ ?>
                            很遗憾，您无权查看相关保密信息。
                            <?php } ?>
                        <?php } ?>
                            ...
                            <ul class="clearfix" >
                                <?php
                                    if($shineipic)
                                    {
                                        ...
                                        {
                                            echo '<li class="item" style="float:right;display:inline;"><img src="'.$val['url'].'" height="55" width="72"></li>';
                                        }
                                    }
                                    else
                                    {
                                        for($i=0;$i<5;$i++)
                                        {
                                            echo '<li class="item" style="float:right;display:inline;"><img src="'.MLS_SOURCE_URL.'/mls/images/v1.0/no_img.jpg" height="55" width="72"></li>';
                                        }
                                    }
                                ?>
                            </ul>
                        </div>
                        <div class="next"  style="float:right;"><span class="iconfont">&#xe607;</span></div>
                    </div>
                </div>
                <div class="show_house_pic clearfix" style="display:none;">
                    <div class="pic" style="overflow:hidden;">
                        <img alt="" style="height:340px;" src="<?php if(!empty($huxingpic[0])){ echo changepic($huxingpic[0]['url']);}else{echo MLS_SOURCE_URL.'/mls/images/v1.0/no_img.jpg';}?>" style="height:340px;">
                    </div>
                    <div class="small_pic">
                        <div class="prev"  style="float:right;"><span class="iconfont">&#xe607;</span></div>
                        <div class="list"  style="float:right;">
            ...
            <div class="js_d inner"  style="display:block">
				...
				<table class="table">
                    <tr>
                        ...
                        <td><div class="ie-break-all"><?php echo $community_info['introduction'];?></div></td>
                    </tr>
                    <tr>
                        <td class="w70 t_l">周边环境：</td>
                        <td><div class="ie-break-all">
						<?php echo $facilities;?></div>
						</td>
                    </tr>
                    <tr>
        ...
        <div class="tab_pop_bd">
            <?php if(1==$data_info['is_public']){ ?>
                <div>
                    <a class="btn-lan" style="position:relative;z-index: 11" onclick="parent.xq_openfollow('sell',<?php echo $data_info['id'] ?>,1)" href="javascript:void(0);"><span>房源跟进</span></a>
                </div>
            <?php }else{ ?>
                <div>
                    <a id="sell_bianji" class="btn-hui1 btn-left" href="/sell/modify/<?php echo $data_info['id'];?>/<?=$app_id?>" target="_parent"><span>编辑</span></a>
                    <?php if($app_id){?>
                    ...
                    <?php }else{?>
                    <a id="sell_zhuxiao" class="btn-hui1 btn-left" href="javascript:void(0);"  onclick="xdel('sell',<?php echo $data_info['id'];?>,'lists',<?php echo $data_info['is_outside'];?>,<?php echo $data_info['nature_per'];?>)"><span>注销</span></a>
                    <?php } ?>
                    <?php if($shineipic_count || $huxingpic_count ){?>
                        <form action="<?php echo MLS_URL; ?>/sell/download_pic/<?php echo $data_info['id']; ?>"
                              method="get">
                ...
                <div>
                    <a id="sell_allocate_house" class="btn-lan" href="javascript:void(0);" onclick="parent.xqhouse('sell',<?php echo $data_info['id']?>)"><span>分配房源</span></a>
                    <a id="sell_house_share_tasks" href="javascript:void(0);"class="btn-lan" onclick="parent.xqtasks('sell',1,<?php echo $data_info['id']?>)"><span>分配任务</span></a>
                    <a class="btn-lan" style="position:relative;z-index: 11" onclick="parent.xq_openfollow('sell',<?php echo $data_info['id'] ?>,1)" href="javascript:void(0);"><span>房源跟进</span></a>
                    <a id="sell_house_match" class="btn-lan" onclick="parent.open_match('sell',0, <?php echo $data_info['id'];?>)" href="javascript:void(0);"><span>智能匹配</span></a>

                    <!--                    <a class="btn-lan" onclick="parent.house_publish('sell',<?php echo $data_info['id']; ?>)" href="javascript:void(0);"><span>群发房源</span></a> -->
                </div>
            <?php } ?>
        </div>
		...
		<div class="tab_pop_bd">
            ...
            <?php } else if ($is_pub == 7) { ?>
                <div class="tab_pop_bd">
                    <div>
                        <a class="btn-lan" onclick="parent.open_match('sell' ,2,<?php echo $data_info['id']; ?>);"
                           href="javascript:void(0);"><span>智能匹配</span></a>
                        <a class="btn-lan" style="position:relative;z-index: 11"
                           onclick="parent.xq_openfollow('sell',<?php echo $data_info['id'] ?>,1,'district')"
                           href="javascript:void(0);"><span>房源跟进</span></a>
                    </div>
                </div>
            <?php } ?>
