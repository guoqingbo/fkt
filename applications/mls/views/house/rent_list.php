...
<form action="" method="post" id="search_form">
    <div class="tab_box" id="js_tab_box">
        ...
        <!-- <span style="float:right;">从第<input type="text"  class="input w40" id="mylimit" name="mylimit" value="<?php echo $mylimit; ?>" />条房源开始导出，每次导出<input type="text" class="input w40" id="myoffset" name="myoffset" value="<?php echo $myoffset; ?>" />条<a href="###" onclick="nextexport();">下一组</a></span> -->
        <!--        <a onclick="sub_export_btn_2();" class="add_link" >导出房源</a>-->
        <a class="add_lead"  id="import">导入房源</a>
        <a href="/rent/publish/" class="add_link"><span class="iconfont">&#xe608;</span>录入房源</a>
    </div>
    <div class="search_box clearfix" id="js_search_box"> <a href="javascript:void(0)" class="s_h" onClick="show_hide_info(this , 'rent_list_extend')" data-h="0" id="extend">更多<span class="iconfont">&#xe609;</span></a>
    <div class="fg_box">
        ...
        <?php if($view_other_per){?>
                ...
                <select class="select" name="post_agency_id" onchange="chang('sell')">
                    ...
                    <?php if($agency_list){
                        ...
                        ?>
                        <option <?php if($val['agency_id'] == $post_param['post_agency_id'])echo "selected"; ?> value="<?php echo $val['agency_id'];?>"><?php echo $val['agency_name'];?></option>
                    <?php }}?>
...
function chang(type){
 ...
 $.ajax({
    ...
    <div class="fg_box hide">
        ...
        <div class="fg">
            <select class="select" name='rent_tag'>
                <option value='0'>不限</option>
                <?php
                    foreach($config['rent_tag'] as $key =>$val)
                    {
                        echo '<option value="'.$key.'"';
                        if($key == $post_param['rent_tag'])
                            echo "selected";
                        echo '> '.$val.'</option>';
                    }
                ?>                    
...
$(function(){
    ...
    if(alert_house_id > 0){
        var alert_url = '/rent/details_house/'+alert_house_id+'/1/2/0/0';
...
<div class="table_all">
    <div class="title" id="js_title">
        <table class="table">
            <tr>
                ...
                <?php if(in_array(1, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info">标签</div></td>
                <?php } ?>
                <?php if(in_array(20, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">编号</div></td>
                <?php } ?>
                <?php if(in_array(2, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">状态</div></td>
                <?php } ?>
                <?php if(in_array(3, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">性质</div></td>
                <?php } ?>
                <?php if(in_array(4, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">合作</div></td>
                <?php } ?>
                <?php if(in_array(5, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">区属</div></td>
                <?php } ?>
                <?php if(in_array(6, $rent_house_field_arr)){ ?>
                <td class="c6"><div class="info">板块</div></td>
                <?php } ?>
                <?php if(in_array(7, $rent_house_field_arr)){ ?>
                <td class="c11"><div class="info">楼盘</div></td>
                <?php } ?>
                <?php if(in_array(8, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info">物业类型</div></td>
                <?php } ?>
                <?php if(in_array(9, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info"><a href="javascript:void(0)" onclick="renntlist_order(5);return false;" id="order_area" class="i_text <?php if($post_param['orderby_id'] == 6 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 5){ echo 'i_up'; } ?>">面积<br>
                        (㎡)</a></div></td>
                <?php } ?>
                <?php if(in_array(10, $rent_house_field_arr)){ ?>
				<td class="c5"><div class="info"><a href="javascript:void(0)" onclick="renntlist_order(7);return false;" id="order_price" class="i_text <?php if($post_param['orderby_id'] == 8 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 7){ echo 'i_up'; } ?>">租金</a></div></td>
                <?php } ?>
                <?php if(in_array(11, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">栋座</div></td>
                <?php } ?>
                <?php if(in_array(12, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">单元</div></td>
                <?php } ?>
                <?php if(in_array(13, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">门牌</div></td>
                <?php } ?>
                <?php if(in_array(14, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info">户型</div></td>
                <?php } ?>
                <?php if(in_array(15, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info"><a href="javascript:void(0)" onclick="renntlist_order(17);return false;" id="order_floor" class="i_text <?php if($post_param['orderby_id'] == 17 ){ echo 'i_up'; }elseif($post_param['orderby_id'] == 18){ echo 'i_down'; } ?>">楼层<br>
                <?php } ?>
                <?php if(in_array(16, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info">朝向</div></td>
                <?php } ?>
                <?php if(in_array(17, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">装修</div></td>
                <?php } ?>
                <?php if(in_array(18, $rent_house_field_arr)){ ?>
                <td class="c6"><div class="info">
                    <a href="javascript:void(0)" onclick="renntlist_order(11);return false;" id="order_genjin" class="i_text <?php if($post_param['orderby_id'] == 12 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 11){ echo 'i_up'; } ?>">跟进时间<br></a>
                </div></td>
                <?php } ?>
                <?php if(in_array(19, $rent_house_field_arr)){ ?>
    ...
    <div class="inner" id="js_innerHouse" style="*overflow-x:hidden; *position:relative;height:371px;">
		...
		foreach($list as $key=>$val){
            //获得房源的创建天数
            $real_time = $rent_house_check_day*24*3600 + $val['createtime'];
            if($real_time > time()){
                $is_check_day = 1;
            }else{
                $is_check_day = 0;
            ...
            $tag_class2 = 'zws-red';
            $tag_str = '该房源自登记以来超过'.$rent_house_check_time.'天未勘察';
            if(1===$tag_follow_red || 1===$is_check_day){
                if(in_array($val['id'] , $follow_green_house_id)){
                    $tag_class2 = 'zws-green';
                    $tag_str = '该房源距离上一次跟进已超'.$rent_house_follow_last_time1.'天';
                }else{
                    if(in_array($val['id'] , $follow_zi_house_id)){
                        $tag_class2 = 'zws-zi';
                        $tag_str = '该房源距离上一次跟进已超'.$rent_house_follow_last_time2.'天';
                    }else{
            ...
            $tag_jingji = $val['house_grade'] == 3 ? 1 : 0;
            if(1 == $tag_remind){
                $tag_class = 'bg-yellow';
            }else{
		...
		?>
           <tr <?php if(!empty($tag_str)){ ?>title="<?php echo $tag_str; ?>"<?php } ?> <?php if('' != $tdclass){ ?>class="<?php echo $tdclass; ?>" <?php }?> id="tr<?php echo $val['id'];?>" date-url="/rent/details_house/<?php echo $val['id'];?>/1" controller="rent" _id="<?php echo $val['id'];?>" min_title="<?php echo $val['block_name'].'-'.intval($val['price']).'万'.'-'.intval($val['buildarea']).'平米'; ?>" page_id="<?php echo $key+1; ?>">
                <td class="c3"><div class="info">
                ...
                <td class="c5">
                    <div class="info">
                        ...
                        <?php if($val['rententrust']==3){ ?><span title="独家代理" class="iconfont ts">&#xe646;</span><?php } ?>
                ...
                <?php } ?>
                <?php if(in_array(20, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info">CZ<?php echo $val['id']; ?></div></td>
                <?php } ?>
                <?php if(in_array(2, $rent_house_field_arr)){ ?>
                ...
                <?php } ?>
                <?php if(in_array(4, $rent_house_field_arr)){ ?>
                <td class="c3"><div class="info" id="share<?php echo $val['id'];?>"><?php if($val['isshare']==1){ ?>是<?php }else if($val['isshare']==2){ ?>审核中<?php }else{ ?>否<?php }?></div>
                ...
                <?php } ?>
                <?php if(in_array(7, $rent_house_field_arr)){ ?>
                <td class="c11"><div class="info f14 fblod <?php echo $tag_class2; ?>"><?php echo $val['block_name']; ?></div></td>
                <?php } ?>
                <?php if(in_array(8, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info"><?php echo $config['sell_type'][$val['sell_type']]; ?></div></td>
                <?php } ?>
                <?php if(in_array(9, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info f60"><?php echo strip_end_0($val['buildarea']);?></div></td>
                <?php } ?>
                <?php if(in_array(10, $rent_house_field_arr)){ ?>
                <td class="c5">
					<div class="info f60 fblod f13">
					<?php echo strip_end_0($val['price']); if($val['price_danwei'] == 1){echo "元/㎡*天";}else{echo "元/月";}?>
                ...
                <?php } ?>
                <?php if(in_array(14, $rent_house_field_arr)){ ?>
                <td class="c5"><div class="info fblod"><?php echo $val['room']; ?>-<?php echo $val['hall']; ?>-<?php echo $val['toilet']; ?></div>
                <?php } ?>
                <?php if(in_array(15, $rent_house_field_arr)){ ?>
                ...
                <?php } ?>
                <?php if(in_array(17, $rent_house_field_arr)){ ?>
                <td class="c4"><div class="info"><?php echo !empty($config['fitment'][$val['fitment']]) ? $config['fitment'][$val['fitment']] : ''; ?></div></td>
                <?php } ?>
                <?php if(in_array(18, $rent_house_field_arr)){ ?>
...
<!--最小化导航栏-->
    ...
    <div class="zws_bottom_nav" style="margin-top:-12px;">
        <div class="zws_bottom_nav_dao">
            <ul id="window_min">
                ...
                <input type="hidden" value="<?php echo '/rent/details_house/'.$v['house_id'].'/1' ?>"/>
...
<ul id="openList">
    ...
    <?php if('1'==$post_param['is_public']){ ?>
        <li onClick="openHouseDetails('rent',1);" class="js_input_1">查看详情</li>
        <li  onClick="open_follow('rent',1)" class="js_input_4">房源跟进</li>
    <?php }else{ ?>
        <!--右键菜单-->
        <li onClick="openHouseDetails('rent',1);" class="js_input_1">查看详情</li>
        <li onclick="modifyInfo('rent');" class="js_input_2">修改详情</li>
        <li class="line"></li>
        ...
        <?php if('1'==$open_cooperate){?>
            ...
            <div class="secondLevel">
                <p id="isshare"><a href="javascript:void(0);" onclick="share_check('rent',0);">发到合作中心</a></p>
                <p id="isshare_friend"><a href="javascript:void(0);" onclick="share_check('rent',1);">发到朋友圈</a></p>
            ...
            设置合作<img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/new/jt.gif" style="padding-left:3px;">
            <div class="secondLevel">
                <p id="isshare"><a href="javascript:void(0);" onclick="sharechange(1,'rent',0);">发到合作中心</a></p>
                <p id="isshare_friend"><a href="javascript:void(0);" onclick="sharechange(1,'rent',1);">发到朋友圈</a></p>
                <!--                <p id="isshare_district"><a href="javascript:void(0);" onclick="sharechange(1,'rent',2);">发到区域公盘</a></p>-->
            </div>
            </li>
            <?php }?>
                <li class="js_input_14 " id="send_to_district" style="position:relative;display: none"
                    onclick="sharechange(1,'rent',2)">
                    发到公盘
                </li>
                <li class="js_input_14 " id="cancel_to_district" style="position:relative;display: none"
                    onclick="sharecancel(0,'rent','','district');">
                    公盘下架
                </li>
        <li onclick = "sharecancel(0,'rent');" class="js_input_7">取消合作</li>
        <?php }?>
        <?php }?>
        ...
        <?php if('2'==$group_id){?>
<!--        <li onclick="fang100('rent',1)" class="js_input_11">同步至平台</li>
        <li onclick="fang100('rent',0)" class="js_input_12">从平台下架</li>-->
        <?php }?>
    <?php } ?>
</ul>
...
<div id="js_genjin" class="iframePopBox" style="width:816px; height:610px;">
    <a class="JS_Close close_pop iconfont" href="javascript:void(0)" date-iframe="1">&#xe60c;</a>
    <iframe frameborder="0" scrolling="no" width="816" height="610" class='iframePop' src=""></iframe>
</div>
<!--详情弹跳页-->
<div id="js_pop_box_g" class="iframePopBox" style="width:816px; height:540px;">
    ...
    <iframe frameborder="0" name="detialIframe" scrolling="no" width="816" height="540" class='iframePop' src="" id="detialIframe"></iframe>
</div>
<!--房源打印-->
    ...
    <div class="mod">
        <div class="inform_inner">
			...
			<div class="text-wrap">
				...
				<button href="javascript:void(0);" type="button" id="sure_yes" class="btn-lv1 btn-mid JS_Close">确定</button>
            </div>
    ...
    <div class="mod">
        <div class="inform_inner">
            <div class="up_inner">
                ...
                <button type="button" id='dialog_sure' class="btn-lv1 btn-left JS_Close" onclick="modifyInfo('rent');">
                    去编辑
                </button>
                <button type="button" class="btn-hui1 JS_Close">取消</button>
            </div>
...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:none;" >
    <div class="hd">
        <div class="title">出租房源导入</div>
        <div class="close_pop"><a href="/rent/lists" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">

        <div class="up_m_b_tex">房源导入功能可以将外部房源直接导入系统中，省去手动录入的麻烦。为保证您的房源顺利导入，请使用我们提供的标准模板，且勿对模板样式做任何删改。<a href="<?php echo MLS_SOURCE_URL;?>/xls/example2.xls" target="_blank">
                <img alt="" src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/page_white_excel.png">点击下载出租房源导入模板</a>
        </div>
        <style>
        ...
        <div class="up_m_b_file clearfix">
            <form action="/rent/import" enctype="multipart/form-data" target="new" method="post">
        ...
        <iframe allowtransparency="true" src="<?php echo MLS_URL;?>/blank.php" frameborder="0" scrolling="no" name="new" id="xx1x" height="35" width="393"></iframe><!-- width="470"  wty---->
        ...
        <div style="text-align:center;"><a class="btn-lv" href="javascript:void(0)" onclick="openn_sure('rent')"><span>确认导入</span></a></div>
    </div>
</div>
<script>
function see_reason(){
...
<!--导出求租房源报表弹出窗口-->
<div class="pop_box_g pop_box_g_big pop_box_d_c pop_box_d_c02" style="display:none" id="js_rent_export">
    <div class="hd">
        <div class="title">报表导出</div>
        <div class="close_pop"><a href="javascript:void(0);" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">
        <form action="<?php echo MLS_URL;?>/rent/exportReport" method="post" id="myform">
            <!--存放当前的总页数用于判断-->
            ...
            <div style="text-align:center; padding-top:10px;"><a href="javascript:void(0);" class="btn-lv" onclick="sub_rent_print_btn()"><span>打印预览</span></a></div>
        </form>
    </div>
</div>
<!-- 用于提交打印预览的数据 -->
...
<form action="/sell/print_hid_three" method="post" id="hid_form2" target="_blank">
    <input type="hidden" name="hid_data2" id="hid_data2" value="">
</form>-->
<script>
	/*
	*	aim:	面积、租金等 onblur 事件的校验
	*	author: angel_in_us
	*	date:	2015.03.04
	*/
	function check_num(){
		...
		var pricemin   =    $("#pricemin").val();	//最小租金
		var pricemax   =    $("#pricemax").val();	//最大租金
		...
		if(pricemin){
			...
			{
				$("#pricemin_reminder").html("租金必须为正整数！");
				return;
			}else{
    ...
    {
        $.ajax({
            url: "/rent/del_search_cookie/rent_list",
            type: "POST",
            dataType: "json",
            success: function(data) {
    ...
    <div class="mod">
        <div class="inform_inner">
            <div class="up_inner">
                ...
                <button type="button" class="btn" id="quxiao_share">确定</button>
            ...
            <div class="up_inner">
                <div class="text-wrap">
                    <table>
                        <tr>
                            <td><div class="img"><img alt="" src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/s_ico.png"></div></td>
                            <td class="msg"><span class="bold">您确定要将该房源设置合作吗？</span></td>
                        </tr>
                    </table>
                </div>
                <div style="width:120px; margin:0 auto; height:auto; overflow:hidden; zoom:1;">
                <button type="button" class="btn btn_qd_text" id="dialog_share_share" style="float:left !important;">确定</button>
                <button type="button" class="btn btn_none btn_qx_text JS_Close" style="float:right !important;">取消</button>
            	</div>
            </div>
        </div>
    </div>
...
//            $("#isshare_district").empty().html('<a href="javascript:void(0);" onclick = "sharecancel(0,\'rent\',\'\',\'district\');">从区域公盘下架</a>');
//        } else {
//            $("#isshare_district").empty().html('<a href="javascript:void(0);" onclick="sharechange(1,\'rent\',2);">发到区域公盘</a>');
//        }
...
//        $.ajax({
//            url: "<?php //echo MLS_URL;?>///rent/house_info/",
//            async: true,
//            type: "POST",
//            dataType: "json",
//            data: {house_id: text},
...
//    $(".js_input_6").live("mouseover",function(){
//		$(this).find("img").attr("src","<?php //echo MLS_SOURCE_URL;?>///mls/images/v1.0/new/baijt.gif");
//		$(this).find("div").show();
//
//		clearTimeout(timer);
//
    ...
    delCookie('page_id');
	//'收起'，‘更多’按钮，获得cookie值
    var rent_list_extend = getCookie('rent_list_extend');
    if(1==rent_list_extend){
