        ...
        <div class="forms_details_fg">
            <div class="clearfix item_fg js_fields">
                ...
                <i class="label display_htype display_htype2">
                    ...
                    车库</i>
                <i class="label display_htype_yes display_htype_yes2">
                    <input type="radio" class="input_radio" name="sell_type" value="8" id="js_house_type_JDS">
                    酒店式公寓</i>
            ...
            <div class="clearfix item_fg">
                ...
                <div class="y_fg js_fields">
                    ...
                    <?php }?>
                    <input name="block_id" id="block_id" value="" type="hidden"  onchange="check_unique_house(2);">
          ...
          <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="y_fg js_fields" id="dong_div">
                    <input class="input_text input_text_r w80" name="dong" id="dong" value="" type="text"
                           placeholder="输入数字"
                           onblur="check_unique_house(1);"><span style="margin-left: -20px"
                                                                 class="iconfont">&#xe607;</span>
                ...
                <div class="y_fg js_fields" id="unit_div">
                    <input class="input_text input_text_r w80" name="unit" id="unit" value="" type="text"
                           placeholder="输入数字"
                           onblur="check_unique_house(1);"><span style="margin-left: -20px"
                                                                 class="iconfont">&#xe607;</span>
                ...
                <div class="y_fg js_fields" id="door_div">
                    <input class="input_text input_text_r w80" type="text" id="door" value="" name="door"
                           placeholder="输入数字"
                           onblur="check_unique_house(1);"><span style="margin-left: -20px"
                                                                 class="iconfont">&#xe607;</span>
