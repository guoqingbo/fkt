            ...
            if($list) {
                foreach($list as $key => $val) {
                    ...
                    <tr info_id="<?php echo $val['id']; ?>" <?php if ($key % 2 == 1){ ?>class="bg" <?php } ?>
                        ...
                        date-url="/rent/details_house/<?php echo $val['id']; ?>/<?= $friend == 'district' ? 7 : 2; ?>"
                        controller="rent" _id="<?php echo $val['id']; ?>"
                        ...
                        <?php if ($friend !== 'district' && $friend !== 'manage') { ?>
                            <td class="c8 js_info broker" data-brokerId="<?php echo $val['broker_id']; ?>"
                                data_id="<?php echo $val['id']; ?>" type="rent_house">
                                <div class="info">
                                    <?php echo $val['broker_name']; ?><!--<span class="onper iconfont">&#xe616;</span>--></div>
                            </td>
                        <?php } else { ?>
                            <td class="c8 js_info broker" data-brokerId="<?php echo $val['district_broker_id']; ?>"
                                data_id="<?php echo $val['id']; ?>" type="rent_house">
                                <div class="info">
                ...
                --><?php if ($friend !== 'district' && $friend !== 'manage') { ?>
                            <td class="c9">
                                <div class="info"><?php echo date('Y-m-d H:i', $val['set_share_time']); ?></div>
                            </td>
                        <?php } else { ?>
                            <td class="c9">
                            ...
                            <td class="js_no_click">
                                <div class="info_p_r">
                                    ...
                                    <?php } elseif ($friend == 'district_manage') { ?>
                                        <a href="javascript:void(0)" onclick="sharecancel(0,'rent',<?php echo $val['id']; ?>,'district');"
