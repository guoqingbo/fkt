    ...
    <div class="mod clearfix">
        <div class="trail-fl">
			<div class="tab_pop_hd">
				<div class="clearfix">
                    <a class="item <?php if (1 == $num) {
                        echo 'itemOn';
                    } ?> " href="/sell/house_follow/<?php echo $house_id; ?>/1/0/district">跟进明细</a>
                    <a class="item <?php if (2 == $num) {
                        echo 'itemOn';
                    } ?> " href="/sell/house_follow/<?php echo $house_id; ?>/2/0/district">带看明细</a>
                    <a class="item <?php if (3 == $num) {
                        echo 'itemOn';
                    } ?> " href="/sell/house_follow/<?php echo $house_id; ?>/3/0/district">提醒明细</a>
				</div>
			</div>
