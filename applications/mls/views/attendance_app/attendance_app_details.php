...
<!-- 			<span class="work_time">
            ...
            <div class="work_time_list">
				<span>
					<p class="work_timeP2">日期</p>
					<p class="work_timeP1">星期</p>
					<p class="work_timeP1">上午</p>
					<!-- <p class="work_timeP1">位置</p> -->
					<p class="work_timeP1">下午</p>
					<!-- <p class="work_timeP1">位置</p> -->
                    <!-- <p class="work_timeP1">打卡IP</p> -->
				</span>
				<?php if(is_full_array($attendance_info)){?>
                <ul>
					<?php foreach($attendance_info as $key=>$vo){?>
                    <li>
                        <p class="work_timeP2"><?php echo $vo['year'].'-'.sprintf('%02d',$vo['month']).'-'.sprintf('%02d',$vo['day']);?></p>
                        <p class="work_timeP1"><?php echo $vo['week']?></p>
						<?php
							if ($vo['attendance_am']!='未打卡') {
								echo "<p class='work_timeP1'>".$vo['attendance_am']."</p>";
							}else{
								echo "<p class='work_timeP1 work_time_late'>".$vo['attendance_am']."</p>";
							}
							// echo "<p class='work_timeP1'>".$vo['position_am']."</p>";
							if ($vo['attendance_pm']!='未打卡') {
								echo "<p class='work_timeP1'>".$vo['attendance_pm']."</p>";
							}else{
								echo "<p class='work_timeP1 work_time_late'>".$vo['attendance_pm']."</p>";
							}
							// echo "<p class='work_timeP1'>".$vo['position_pm']."</p>";
						?>                        
                    </li>
					<?php } ?>
                </ul>
