...
<body>
    <div class="wrapper ywgj" style="margin: 0 auto;margin-top: 20px;position:relative;">
        ...
        <?php if(is_full_array($all_dong_unit_door)){ ?>
            <ul class="ld_ul">
                ...
                <li class="li_ld clearfix">
                    <div class="add_ld">
                        <input type="text" name="dong_name[]" value="<?php echo $key; ?>" msgs="<?php echo $key; ?>" onfocus="bindFocus(this,this.value,true)"
        ...
        <div class="all_btns">
            <div class="bt_xg clearfix" style="width:350px;<?php if(is_full_array($all_dong_unit_door)){echo 'display: block;';} ?>">
                <?php if('1'==$is_lock){ ?>
                ...
                <button class="button_bc" onclick="dong_door_unit_import()">批量导入</button>
            </div>
...
<div id="js_pop_do_success" class="pop_box_g pop_see_inform pop_no_q_up" >
    <div class="hd">
        ...
        <div class="close_pop">
            <a href="/community/index" title="关闭" class="JS_Close iconfont" id="close_refresh"></a>
        </div>
    </div>
    <div class="mod">
...
<script>
  ...
  <?php } ?>
    ...
    $('#modify_button_2').live('click',function(){
        ...
        $.ajax({
            url: "/community/dong_door_unit_modify/",
            type: "GET",
            data: {
                cmt: cmt,
                cmt_id:<?php echo $cmt_id; ?>
