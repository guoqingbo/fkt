...
<div id="js_search_box" class="shop_tab_title  scr_clear">
    ...
    <a href="/statistic/lease_statistic" class="link link_on">租赁成交统计<span class="iconfont hide">&#xe607;</span></a>
...
<div class="table_all report-form-wrap">
    ...
    <div class="inner" id="js_inner" style="height: 343px !important;">
        <table class="table list-table">
            <tr>
                ...
                <td colspan="6">
                    <table class="table inner-table">
                        <tr class="first">
                            <td class="c15"><?php echo intval(@$rent_house_data[1]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_house_data[2]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_house_data[3]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_house_data[4]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_house_data[5]['count(*)'])?></td>
                            <td class="c15"><?php echo intval(@$rent_house_data[0]['count(*)'] + @$rent_house_data[6]['count(*)'] );?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                        <tr class="second">
                            <td class="c15"><?php echo doubleval(@$rent_house_data[1]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_house_data[2]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_house_data[3]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_house_data[4]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_house_data[5]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo (doubleval(@$rent_house_data[0]['ratio']) + doubleval(@$rent_house_data[6]['ratio']))."%"; ?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="6">
                    <table class="table inner-table">
                        <tr class="first">
                            ...
                            <td class="c15"><?php echo intval(@$rent_house_groups[0]['count(*)']) + intval(@$rent_house_groups[6]['count(*)']);?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                        <tr class="second">
            ...
            <tr>
                <td class="c14">求租客户</td>
                <td colspan="6">
                    <table class="table inner-table">
                        <tr class="first">
                            <td class="c15"><?php echo intval(@$rent_customer_data[1]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_customer_data[2]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_customer_data[3]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_customer_data[4]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_customer_data[5]['count(*)']);?></td>
                            <td class="c15"><?php echo intval(@$rent_customer_data[0]['count(*)']) + intval(@$rent_customer_data[6]['count(*)']);?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                        <tr class="second">
                            <td class="c15"><?php echo doubleval(@$rent_customer_data[1]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_customer_data[2]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_customer_data[3]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_customer_data[4]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo doubleval(@$rent_customer_data[5]['ratio'])."%"; ?></td>
                            <td class="c15"><?php echo (doubleval(@$rent_customer_data[0]['ratio']) + doubleval(@$rent_customer_data[6]['ratio']))."%"; ?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="6">
                    <table class="table inner-table">
                        <tr class="first">
                            ...
                            <td class="c15"><?php echo intval(@$rent_customer_groups[0]['count(*)']) + intval(@$rent_customer_groups[6]['count(*)']);?></td>
                            <td class="c10">&nbsp;</td>
                        </tr>
                        <tr class="second">
