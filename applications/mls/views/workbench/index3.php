	...
	<div class="main-seo clearfix">
		<div class="left-seo">
			<div class="opt-seo clearfix">
				<!--<ul>
                    <li class="opt-a opt-a1"><a class="w1-seo" href="<?php echo MLS_URL;?>/my_task/index/"><span><?php echo $task_num;?></span>新增采集房源</a></li>
					<li class="opt-a opt-a2"><a class="w1-seo" href="<?php echo MLS_URL;?>/house_collections/collect_sell"><span><?php echo $all_collect_house_num;?></span>未完成提醒</a></li>
					<li class="opt-a opt-a3"><a class="w1-seo" href="<?php echo MLS_URL;?>/cooperate/accept_order_list/"><span><?php echo $accept['all_estas_num'];?></span>我收到的合作</a></li>
				...
				<ul>
                    <li><a class="w1-seo opt-a opt-a1" href="<?php echo MLS_URL;?>/my_task/index/"><span><?php echo $task_num;?></span>我的新任务</a></li>
                    <li><a class="w1-seo opt-a opt-a2" href="javascript:void(0);"
                           onclick="window.parent.to_url('bulletin')"><span><?php echo $message3_num; ?></span>我的消息</a>
                    </li>
<!--					<li><a class="w1-seo opt-a opt-a2" href="--><?php //echo MLS_URL;?><!--/house_collections_new/collect_sell"><span>--><?php //echo $all_collect_house_num;?><!--</span>新增采集</a></li>-->
			...
			<div class="mobile-seo">
				<ul class="slide-pic">
					...
					<li class="current">
						<div class="banner-01">
							<a style="background:#FEEB9C;" href="<?php echo MLS_URL;?>/project/fang100/"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/subject/xcc2.jpg" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a href="<?php echo MLS_URL;?>/project/fang100/"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/subject/banner.jpg" ></a>
						</div>
					</li>
                    -->
                    <?php if (false && $broker['city'] == 'cd') { ?>
					<li class="current">
						<div class="banner-01">
							<a style="background:#f22f4d;" href="<?php echo MLS_URL;?>/notice/credit_active/"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner3.png" ></a>
						</div>
					</li>
                    <?php } ?>
					<?php if (false && ($broker['city'] == 'sz' || $broker['city'] == 'km')) { ?>
					<li  class="current">
						<div class="banner-01">
							<a style="background:#d7083e;" href="<?php echo MLS_URL;?>/notice/credit_active/"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner2.png" ></a>
						</div>
					</li>
					<?php } ?>
                    <?php if ($broker['city'] == 'sz1') { ?>
					<li class="current">
						<div class="banner-01">
							<a style="background:#1576d9;" href="<?php echo MLS_URL;?>/finance/apply_pledge"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#B1302D;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner1_sz.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#6081C0;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner2_sz.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#EC6422;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner3_sz.png" ></a>
						</div>
					</li>
					<?php } ?>
					<?php if ($broker['city'] == 'cd') { ?>
					<li class="current">
						<div class="banner-01">
							<a style="background:#EC6422;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner1_cd.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#F6AC16;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner2_cd.png" ></a>
						</div>
					</li>
					<?php } ?>
					<?php if ($broker['city'] == 'km') { ?>
					<li class="current">
						<div class="banner-01">
							<a style="background:#cca97f;" href="#"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner4.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#24A3D8;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner1_km.png" ></a>
						</div>
					</li>
					<li>
						<div class="banner-01">
							<a style="background:#FF8C07;"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/banner2_km.png" ></a>
						</div>
					</li>
					<?php } ?>
                    <!--                    <li style="background:#1D4DA2;" -->
                    <?php //if ($broker['city'] != 'sz' && $broker['city'] != 'km' && $broker['city'] != 'cd') { ?><!--class="current" -->
                    <?php //} ?><!---->
                    <li style="background:#1D4DA2;" class="current">
						<div class="mobile-inner-seo">

						</div><!--<a class="a1" href="###" onclick="openWin('js_pop_jjsx');"><img src="<?php /*echo MLS_SOURCE_URL;*/?>/mls/images/v1.0/new/m1_1.png" ></a>
							<a href="###"  onclick="openWin('js_pop_jjsx');"><img src="<?php /*echo MLS_SOURCE_URL;*/?>/mls/images/v1.0/new/m2_1.png"></a>-->
					</li>
				</ul>
                <?php if ($broker['city'] == 'sz1') { ?>
			...
			<div class="add-seo clearfix">
                ...
                <div class="w1-seo-notice sign-seo">
					...
					<ul style="display:none">
						...
						?>
                        <li>
                            <a class="<?= $vv['color'] ?>" id="" href="<?php echo MLS_URL; ?>/message/notice/"
                               title="<?= $vv['title'] ?>">[<?= date('m-d', $vv['createtime']) ?>
                                ]<?= $vv['title'] ?></a>
                        </li>
						<?php }}else{?>
						<li>暂无公告</li>
                    ...
                    <ul style="display:none">
                        <?php
                        if (!empty($signing_notice_list)) {
                            foreach ($signing_notice_list as $ke => $vv) {
                                ?>
                                <li>
                                    <a class="<?= $vv['color'] ?>" id=""
                                       href="<?php echo MLS_URL; ?>/signing_notice/index/"
                                       title="<?= $vv['title'] ?>">[<?= date('m-d', $vv['createtime']) ?>
                                        ]<?= $vv['title'] ?></a>
                                </li>
                            <?php }
                    ...
                    <?php //echo MLS_URL;?><!--/homepage/web_help" target="_blank">帮助中心</a>-->
		...
		<div class="right-seo">
			<div class="info-seo clearfix newH">
                ...
                <?php if ($broker['photo']) { ?>
				<img class="info-img" src="<?=$broker['photo']?>" width="55" height="70">
                <?php } ?>
                <p style="margin-top: 10px;margin-bottom: 10px"><?php echo $broker['truename']; ?>
                    <b class="cur_bg_c"
                       style="padding:0 10px;font-size: 12px;font-family: Arial;font-weight: bold;color: #FFF;text-align: center;font-style: italic;_background:url(<?php echo MLS_SOURCE_URL; ?>/mls/images/v1.0/IE6_level_bj2_03.jpg) no-repeat center;cursor:pointer"
                       onclick1="openWin('my_level')">Lv<?= $level['level'] ?></b></p>
				<div class="clearfix"><span class="left" style="color:#8BBBEB; line-height:24px; margin-right:6px;">信用</span>
                <?php echo $broker['trust_level']['level'];?></div>
                <!--				<a style="color:#8BBBEB;" href='-->
                <?php //echo MLS_URL;?><!--/my_credit/index'>我的积分：--><?php //echo $broker['credit']?><!--</a>-->

			</div>
			<div class="apr-seo">
				<div class="clearfix">

                    <a class="<?php echo ($broker['ident_auth_status'] == 2) ? 'apr1' : 'apr1-1'; ?>"
                       href="<?php echo MLS_URL; ?>/my_info/index/">&nbsp;
				    <?php
				    if($broker['ident_auth_status'] == 2){
				        echo '身份已认证';
				    }else{
				        echo '身份未认证';
				    }
                    ...
                    <a class="<?php echo ($broker['ident_auth_status'] == 2) ? 'apr2' : 'apr2-2'; ?>"
                       href="<?php echo MLS_URL; ?>/my_info/index/">
				    <?php
				    if($broker['ident_auth_status'] == 2){
				        echo '资质已认证';
			...
			<div class="eva-seo">
				...
				<ul>
                    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信息真实度：<span class="<?php if($broker['appraise_and_avg']['infomation']['up_down']=='down'){echo 'down-seo';}else if($broker['appraise_and_avg']['infomation']['up_down']=='up'){echo 'up-seo';}?>"><?php echo $broker['appraise_and_avg']['infomation']['score'];?></span></li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合作满意度：<span class="<?php if($broker['appraise_and_avg']['attitude']['up_down']=='down'){echo 'down-seo';}else if($broker['appraise_and_avg']['attitude']['up_down']=='up'){echo 'up-seo';}?>"><?php echo $broker['appraise_and_avg']['attitude']['score'];?></span></li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;业务专业度：<span class="<?php if($broker['appraise_and_avg']['business']['up_down']=='down'){echo 'down-seo';}else if($broker['appraise_and_avg']['business']['up_down']=='up'){echo 'up-seo';}?>"><?php echo $broker['appraise_and_avg']['business']['score'];?></span></li>
				</ul>
			</div>
...
<?php if ($count_day == 1 && $broker['city'] == 'sz1') { ?>
...
<div class="jd">
	...
	<a href="<?php echo MLS_URL;?>/finance/apply_pledge"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/ad/screen.jpg" /></a>
</div>
<?php } ?>
    ...
    <div class="mod">
        <div class="inform_inner">
			...
			<div class="text-wrap">
                    <table>
                        <tbody><tr>
                            <td><div class="img"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/s_ico.png" id="imgg" alt=""></div></td>
        ...
        <div class="inform_inner">
            <div class="up_inner" style="padding:0px;">
				<div class="text-wrap">
                    ...
                    <div class="img"><img src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/app.jpg" id="imgg" alt=""></div>
                </div>
            </div>
        </div>
    </div>
...
<div  class="pop_box_g pop_see_inform pop_no_q_up" style=" display:none;" id='work_end_fail'>
    ...
    <div class="dakaisSucc">
    	<dl class class="clearfix">
			<dt class="left"><img alt="" src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/s_ico.png"></dt>
...
<script src="<?php echo MLS_SOURCE_URL;?>/min/?f=mls/js/v1.0/BreakingNews.js"></script>
<script>
...
//			var w2 = ($(window).width() - 365)/4 + "px";
	   ...
	   $('#accept_cooperate,#send_cooperate').click(function(){
		   ...
		   if('accept_cooperate'==id){
			   href = '<?php echo MLS_URL;?>/cooperate/accept_order_list/';
		   }else if('send_cooperate'==id){
			   href = '<?php echo MLS_URL;?>/cooperate/send_order_list/';
		   }
	...
	function add_work(type){
		...
		$.ajax({
			type: 'post',
			url : '/check_work_center/add_work/'+<?=$broker_id?>,
			dataType:'json',
			data: {type:type},
			success: function(data){
				if(data['result'] == 'ok'){
