...
<form id="jsUpForm" name = 'jsUpForm' method="post" action =''>
	<div class="pop_see_inform pop_no_q_up pop_box_g" id="infomat" style="width:800px; height:430px;">
		<div class="hd">
		...
		<div class="mod infomat">
			...
			<div class="label-div clearfix"><b class="label labelon"><input type="checkbox" class="js_checkbox">我已阅读并同意该活动规则</b></div>
			<div class="center">
