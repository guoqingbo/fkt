...
<a href="##" class="link link_on"><span class="iconfont">&#xe603;</span>修改求购</a>
<?php } ?>
...
<div class="forms forms_scroll h91" id="js_inner">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
            ...
            <div class="item_fg clearfix">
                <div class="left width_b js_fields" >
                    ...
                    <i class="label display_htype_yes <?php if($customer_info['status'] == $key){echo "labelOn";}?>">
                        <input type="radio" name="status" class="input_radio" <?php if($customer_info['status'] == $key){echo 'checked';}?> value='<?php echo $key;?>'> <?php echo $value;?>
                    </i>
                    <?php } ?>
                    <?php } ?>
            ...
            <div class="item_fg clearfix">
                <div class="left width_b">
                    ...
                    <span class="y_fg y_fg_p_l_5">万元</span> </div>
            ...
            <div class="item_fg clearfix">
                <div class="left"> <span class="text_fg">意向楼盘：</span>
                    <div class="y_fg">
                        <input class="js_block input_text w200" type="text" name="cmt_name[]"  <?php if(!empty($customer_info['cmt_id1'])) { ?> change_tag ="1" <?php }else{?> change_tag ="0" <?php }?> id="block01" value="<?php echo $customer_info['cmt_name1'];?>" placeholder="输入拼音或汉字筛选">
                        <input type="hidden" name="cmt_id[]" id = 'cmt_id01' class='cmt_id' value="<?php echo $customer_info['cmt_id1'];?>">
                    ...
                    <div class="y_fg <?php if(empty($customer_info['cmt_id3'])) { echo 'hide';}?>">
                        ...
                        <input type="hidden" name="cmt_id[]" id = 'cmt_id03' class='cmt_id' value="<?php echo $customer_info['cmt_id3'];?>">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="left">
                    ...
                    <i class="label display_htype_yes <?php if($customer_info['infofrom'] == $key){echo "labelOn";}?>">
                        <input type="radio" class="input_radio" name="infofrom" value='<?php echo $key;?>' <?php if($customer_info['infofrom'] == $key){echo 'checked';}?>> <?php echo $value;?>
                    </i>
                    <?php } ?>
                    <?php } ?>
                </div>
        ...
        <input type = 'hidden' name = 'publish_type' id = 'publish_type' value = 'buy_customer_modify'>
