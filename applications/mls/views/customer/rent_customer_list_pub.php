...
<form action = '<?php echo MLS_URL;?>/rent_customer/manage_pub' method = 'post' name = 'search_form' id ='search_form'>
<div class="search_box clearfix" id="js_search_box_02">
    <a href="javascript:void(0)" class="s_h" onClick="show_hide_info(this , 'rent_customer_pub_list_extend')" data-h="0" id="extend">更多<span class="iconfont">&#xe609;</span></a>
    <div class="fg_box">
...
<div class="table_all">
    <div class="title" id="js_title">
        <table class="table">
            <tr>
                ...
                <td class="c6"><div class="info">户型(室)</div></td>
                <td class="c8"><div class="info">面积(㎡)</div></td>
                <td class="c8"><div class="info">租金</div></td>
    ...
    <div class="inner" id="js_innerHouse" style="height:331px;">
        <table class="table table_q" id="js_table_box_Sincerity">
            ...
            <tr info_id = "<?php echo $value['id'];?>" <?php if($key % 2 == 1){ ?>class="bg" <?php }?> date-url="<?php echo MLS_URL;?>/rent_customer/details/<?php echo $value['id'];?>/1" controller="rent_customer" _id="<?php echo $value['id'];?>" min_title="<?php echo $district_arr[$value['dist_id1']]['district'].'-'.$street_arr[$value['street_id1']]['streetname'].' '.intval($value['price_min']).'-'.intval($value['price_max']).'万'; ?>">
                ...
                <td class="c6"><div class="info fblod"><?php echo $value['room_min'];?>-<?php echo $value['room_max'];?></div></td>
                <td class="c8"><div class="info"><?php echo strip_end_0($value['area_min']);?>-<?php echo strip_end_0($value['area_max']);?></div></td>
                <td class="c8"><div class="info f13 fblod"><?php echo ('1'==$value['price_danwei'])?strip_end_0($value['price_min']/$value['area_min']/30):strip_end_0($value['price_min']);?>-<?php echo ('1'==$value['price_danwei'])?strip_end_0($value['price_max']/$value['area_max']/30):strip_end_0($value['price_max']);?><?php echo ('1'==$value['price_danwei'])?'元/㎡*天':'元/月';?></div></td>
                <td class="c7 js_info broker" data-brokerId ="<?php echo $value['broker_id'];?>" data_id="<?php echo $value['id'];?>" type="rent_customer">
                <div class="info">
                    <?php
                ...
                <td class="js_no_click">
                   <div class="info_p_r">
                    ...
                    <?php } else if( $value['broker_id'] != $broker_id && '1'==$open_cooperate){?>
                            <a href="javascript:void(0)" class="hezuo" onclick="cooperate_customer('rent_customer',<?php echo $value['id'];?>);">合作申请</a>
                    <?php } else if( '0'==$open_cooperate ){?>
                             <a href="javascript:void(0)" title = "当前公司未开启合作中心" class="hezuo" style="color:#b2b2b2;text-decoration:none;">合作申请</a>
                    <?php } else { ?>
                    ...
                    <?php } ?>
                             ...
                             <a href="javascript:void(0)" onclick="open_match_customer('rent_customer',1,<?php echo $value['id'];?>)">智能匹配</a>
                    ...
                    ?>
                            <a href="javascript:void(0)" class="shcang" onclick="collect_customer(<?php echo $value['id'];?>,'rent_customer');" id = "collect_<?php echo $value['id'];?>">收藏</a>
                    <?php
                    }
                    ?>
                     </div>
    ...
    <script type="text/javascript">
		...
		$(function(){
            ...
            //'收起'，‘更多’按钮，获得cookie值
            var rent_customer_pub_list_extend = getCookie('rent_customer_pub_list_extend');
            if(1==rent_customer_pub_list_extend){
    ...
    <div class="zws_bottom_nav" style="margin-top:2px;">
        <div class="zws_bottom_nav_dao">
            <ul id="window_min">
                ...
                <input type="hidden" value="<?php echo '/rent_customer/details/'.$v['customer_id'].'1' ?>"/>
...
<ul id="openList">
    ...
    <li onclick="openDetails('rent_customer',1);">查看详情</li>
</ul>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
            url: "/rent_customer/del_search_cookie/rent_customer_manage_pub",
            type: "POST",
            dataType: "json",
