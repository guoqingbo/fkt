...
<form action = '<?php echo MLS_URL;?>/customer_collect/rent_customer_collects' method = 'post' name = 'search_form' id ='search_form'>
<div class="search_box clearfix" id="js_search_box_02">
    ...
    <div class="fg_box">
        ...
        <div class="fg"> <a href="/customer_collect/rent_customer_collects/" class="reset">重置</a> </div>
    </div>
</div>
...
<div class="table_all">
    <div class="title" id="js_title">
        <table class="table">
            <tr>
                ...
                <td class="c8"><div class="info">租金(元/月)</div></td>
    ...
    <div class="inner" id="js_inner">
        <table class="table table_q" id="js_table_box_Sincerity">
            ...
            <tr info_id = "<?php echo $value['id'];?>" <?php if($key % 2 == 1){ ?>class="bg" <?php }?> date-url="<?php echo MLS_URL;?>/rent_customer/details/<?php echo $value['id'];?>/1">
                ...
                <td class="js_no_click">
                    ...
                    <?php } else if( '0'==$open_cooperate ){?>
                        <a href="javascript:void(0)" class="hezuo" title = "当前公司未设置合作中心"  style="color:#b2b2b2;text-decoration:none;">合作申请</a>
                    <?php } else {?>
                        <a href="javascript:void(0)" class="hezuo" title = "自己不能跟自己合作"  style="color:#b2b2b2;text-decoration:none;">合作申请</a>
                    <?php } ?>
                    <span style="margin:0 2px;color:#b2b2b2;">|</span>
                     <a href="javascript:void(0)" onclick="open_match_customer('rent_customer',2,<?php echo $value['id'];?>)">智能匹配</a>
                    <span style="margin:0 2px;color:#b2b2b2;">|</span>
                    <a href="javascript:void(0)" class="shcang" onclick="cancle_collect_customer(<?php echo $value['c_id'];?> , 'rent_customer');" id = "collect_<?php echo $value['id'];?>">取消收藏</a>
                    </div>
                  </td>
            </tr>
            <?php } ?>
