<div class="pop_box_g pop_box_g02 pop_box_g_big pop_box_g_border_none" id="js_zhineng" style='display: block;width:930px;'>
    ...
    <form name="search_form" id = 'search_form' method="post" action="<?php echo MLS_URL;?>/customer/match/<?php echo $data_info['id'];?>/<?php echo $is_public;?>">
    <div class="mod">
        <div class="mod_zn_inner">
            <div class="inner">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><?php echo strip_end_0($data_info['price_min']);?>-<?php echo strip_end_0($data_info['price_max']);?></td>
                        <td>
                        <?php
                        ...
                        <td><a  href="javascript:void(0);" onclick="parent.cooperate_customer('buy_customer',<?php echo $data_info['id'];?>);">合作申请</a></td>
                        <?php } else { ?>
			...
			<div class="clearfix" style="padding-left:90px;">
				<div class="fg_box">
        ...
        <div class="inner">
            <table class="table">
                ...
                <tr class="data_list bg" date-url="<?php echo MLS_URL;?>/sell/details/<?php echo $value['id'];?>/<?php echo $match_num;?>" controller="sell">
                    <td><?php echo isset($conf_customer['property_type'][$value['sell_type']]) ? $conf_customer['property_type'][$value['sell_type']]: '';?></p>
                    <td><?php
                    if(isset($district_arr[$value['district_id']]['district']) && !empty($district_arr[$value['district_id']]['district']))
                    {
                        echo $district_arr[$value['district_id']]['district'];
                    }
                    ?>
                    </td>
                    ...
                    <td>
                        ...
                        <a  href="javascript:void(0);" onclick="parent.cooperate_house('sell',<?php echo $value['id'];?>,<?php echo $value['broker_id'];?>);">合作申请</a>
                        <?php } else { ?>
