    ...
    <div class="mod">
        <div class="tab_pop_hd">
            <dl class="clearfix" id="js_tab_t01">
                <a class="item <?php if($tab == 1) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/rent_customer/customer_detail/<?php echo $customer_id;?>/<?php echo ('4'==$is_public)?'4':'0'; ?>/1/<?php echo $hide_btn;?>">客源详情</a>
                <a class="item <?php if($tab == 2) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/rent_customer/confidential_info/<?php echo $customer_id;?>/<?php echo ('4'==$is_public)?'4':'0'; ?>/2/<?php echo $hide_btn;?>">保密信息</a>
                <a class="item <?php if($tab == 3) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/rent_customer/cooperation/<?php echo $customer_id;?>/<?php echo ('4'==$is_public)?'4':'0'; ?>/3/<?php echo $hide_btn;?>">合作统计</a>
            </dl>
        </div>
                ...
                <div class="t_box">
                    ...
                    <p class="link_btn_b">
                        <?php if(!('1'==$data_info['is_public'])){ ?>
                            ...
                            <a id="show_baomi_button" onClick="rent_show_ys_inner(<?php echo $data_info['id'];?>)" href="javascript:void(0)"><span class="iconfont">&#xe60f;</span> 查看保密信息</a>
                            ...
                            <a style="display:none;" id="modify_baomi_submit_button" onClick="customer_submit_baomi_info(<?php echo $data_info['id']; ?>,'rent_customer')" href="javascript:void(0)"><span class="iconfont">&#xe610;</span> 保存修改</a>
                            <?php }else{ ?>
                            很遗憾，您无权查看相关保密信息。
                            <?php } ?>
                        <?php } ?>
        ...
        <?php if(is_array($data_info) && !empty($data_info)) { ?>
            <?php if($is_public!='4'){ ?>
                <?php if(1==$data_info['is_public']){ ?>
                    <a class="btn-lan" href="javascript:void(0);" onclick="parent.xq_openfollow('rent_customer',<?php echo $customer_id;?>,1)"><span>客源跟进</span></a>
                <?php }else{ ?>
                    <a class="btn-hui1 btn-left" href="<?php echo MLS_URL;?>/rent_customer/modify/<?php echo $data_info['id'];?>" target="_parent"><span>编辑</span></a>
                    <a class="btn-hui1 btn-left" href="javascript:void(0);" onclick="parent.del_customer_details(<?php echo $customer_id;?>,'rent_customer',<?php echo $per_public_type;?>);"><span>注销</span></a>
                    <a class="btn-lan" href="javascript:void(0);" onclick="parent.xqcustomer('rent_customer',<?php echo $customer_id;?>)"><span>分配客源</span></a>
                    <a class="btn-lan" href="javascript:void(0);" onclick="parent.xqtasks('rent_customer',4,<?php echo $customer_id;?>)"><span>分配任务</span></a>
                    <a class="btn-lan" href="javascript:void(0);" onclick="parent.xq_openfollow('rent_customer',<?php echo $customer_id;?>,1)"><span>客源跟进</span></a>
                    <a class="btn-lan" href="javascript:void(0);" onclick="parent.open_match_customer('rent_customer',0,<?php echo $data_info['id']?>)"><span>智能匹配</span></a>
                <?php } ?>
            <?php }?>
        <?php }?>
        </div>
