...
<body>
<form action='<?php echo MLS_URL; ?>/customer/manage' method='post' name='search_form' id='search_form'>
    ...
    <div class="tab_box" id="js_tab_box">
        ...
        <!--        <a onclick="document.getElementById('js_buy_export').style.display='block';" class="add_link">导出客源</a>-->
        <a class="add_lead" id="import">导入客源</a>
        <a href="<?php echo customer_publish_url('buy'); ?>" class="add_link"><span class="iconfont">&#xe608;</span>录入客源</a>
    </div>
    <div class="search_box clearfix" id="js_search_box">
        <a href="javascript:void(0)" class="s_h" onClick="show_hide_info(this , 'buy_customer_list_extend')" data-h="0"
        ...
        <div class="fg_box">
            ...
            <div class="fg">
                <select class="select" name='street_id' id="street_id">
                    ...
                    <?php
                    if (is_array($select_info['street_info']) && !empty($select_info['street_info'])) {
                        foreach ($select_info['street_info'] as $key => $value) { ?>
        ...
        <div class="fg_box hide">
            ...
            <div class="fg">
                <select class="select" name='room'>
                    <option value='0'>不限</option>
                    <?php
                    if (is_array($conf_customer['room_type']) && !empty($conf_customer['room_type'])) {
                        foreach ($conf_customer['room_type'] as $key => $value) {
                            ?>
        ...
        <div class="fg_box hide">
            ...
            <div class="fg">
                <select class="select" name='public_type'>
                    <option value="0">不限</option>
                    <?php
                    if (is_array($conf_customer['public_type']) && !empty($conf_customer['public_type'])) {
        ...
        <div class="fg_box">
            ...
            <div class="fg"><a href="javascript:void(0)" onclick="sub_form('search_form');return false;" id="btn-sub"
    ...
    <div class="table_all">
        <div class="title" id="js_title">
            <table class="table">
                <tr>
                    ...
                    <?php if (in_array(1, $buy_customer_field_arr)) { ?>
                        <td class="c5">
                            <div class="info">标签</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(18, $buy_customer_field_arr)) { ?>
                        <td class="c3">
                            <div class="info">编号</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(2, $buy_customer_field_arr)) { ?>
                        <td class="c3">
                            <div class="info">状态</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(3, $buy_customer_field_arr)) { ?>
                        <td class="c3">
                            <div class="info">性质</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(4, $buy_customer_field_arr)) { ?>
                        <td class="c3">
                            <div class="info">合作</div>
                        </td>
                    <?php } ?>
                    <!--td class="c3"><div class="info">交易</div></td>-->
                    <?php if (in_array(5, $buy_customer_field_arr)) { ?>
                        <td class="c6">
                            <div class="info">客户</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(6, $buy_customer_field_arr)) { ?>
                        <td class="c8">
                            <div class="info">意向区属板块</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(7, $buy_customer_field_arr)) { ?>
                        <td class="c8">
                            <div class="info">意向楼盘</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(8, $buy_customer_field_arr)) { ?>
                        <td class="c6">
                            <div class="info">物业类型</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(9, $buy_customer_field_arr)) { ?>
                        <td class="c6">
                            <div class="info">面积(㎡)</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(10, $buy_customer_field_arr)) { ?>
                        <td class="c6">
                            <div class="info">总价(W)</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(11, $buy_customer_field_arr)) { ?>
                        <td class="c6">
                            <div class="info">户型(室)</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(12, $buy_customer_field_arr)) { ?>
                        <td class="c4">
                            <div class="info">装修</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(13, $buy_customer_field_arr)) { ?>
                        <td class="c4">
                            <div class="info">楼层</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(14, $buy_customer_field_arr)) { ?>
                        <td class="c4">
                            <div class="info">朝向</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(15, $buy_customer_field_arr)) { ?>
                        <td class="c4">
                            <div class="info">房龄</div>
                        </td>
                    <?php } ?>
                    <?php if (in_array(16, $buy_customer_field_arr)) { ?>
                        <td class="c4">
                            <div class="info">
                    ...
                    <?php } ?>
                    <?php if (in_array(17, $buy_customer_field_arr)) { ?>
                        <td class="c6">
            ...
            <table class="table table_q">
                ...
                if (is_array($customer_list) && !empty($customer_list)) {
                    foreach ($customer_list as $key => $value) {
                        //获得房源的创建天数
                        $real_time = $buy_customer_check_day * 24 * 3600 + $value['creattime'];
                        if ($real_time > time()) {
                            $is_check_day = 1;
                        } else {
                            $is_check_day = 0;
                        ...
                        $tag_class2 = 'zws-red';
                        $tag_str = '该客源自登记以来超过' . $buy_customer_check_time . '天未勘察';
                        if (1 === $tag_follow_red || 1 === $is_check_day) {
                            if (in_array($value['id'], $follow_green_customer_id)) {
                                $tag_class2 = 'zws-green';
                                $tag_str = '该客源距离上一次跟进已超' . $buy_customer_follow_last_time1 . '天';
                            } else {
                                if (in_array($value['id'], $follow_zi_customer_id)) {
                                    $tag_class2 = 'zws-zi';
                                    $tag_str = '该客源距离上一次跟进已超' . $buy_customer_follow_last_time2 . '天';
                                } else {
                        ...
                        <tr <?php if (!empty($tag_str)){ ?>title="<?php echo $tag_str; ?>"<?php } ?>
                            ...
                            date-url="<?php echo MLS_URL; ?>/customer/details/<?php echo $value['id']; ?>"
                            controller="customer" _id="<?php echo $value['id']; ?>"
                            ...
                            <?php if (in_array(18, $buy_customer_field_arr)) { ?>
                                <td class="c3">
                                    <div class="info"><?php echo get_custom_id($value['id']); ?>
                                    </div>
                                </td>
                            <?php } ?>
                            <?php if (in_array(2, $buy_customer_field_arr)) { ?>
                            ...
                            <?php } ?>
                            <!--td class="c3"><div class="info">买</div></td>-->
                            <?php if (in_array(5, $buy_customer_field_arr)) { ?>
                                <td class="c6">
                            ...
                            <?php if (in_array(10, $buy_customer_field_arr)) { ?>
                                <td class="c6">
                                    <div class="info f60 f13 fblod"><?php echo strip_end_0($value['price_min']); ?>
                                        -<?php echo strip_end_0($value['price_max']); ?></div>
                                </td>
                            <?php } ?>
                            <?php if (in_array(11, $buy_customer_field_arr)) { ?>
                                <td class="c6">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                //'收起'，‘更多’按钮，获得cookie值
                var buy_customer_list_extend = getCookie('buy_customer_list_extend');
                if (1 == buy_customer_list_extend) {
                ...
                <?php if (is_full_array($buy_list_min_arr)) {
                    foreach ($buy_list_min_arr as $k => $v) {
                        ...
                        <li id="window_min_id_<?php echo $v['customer_id']; ?>">
                            ...
                            <input type="hidden" value="<?php echo '/customer/details/' . $v['customer_id'] ?>"/>
...
<ul id="openList">
    ...
    <?php if ('1' == $post_param['is_public']) { ?>
        <li onclick="openDetails('customer');" class="js_input_1">查看详情</li>
        <li class="js_input_3" id="follow_openlist">客源跟进</li>
    <?php } else { ?>
        <li onclick="openDetails('customer');" class="js_input_1">查看详情</li>
        <li onclick="modifyInfo('customer');" class="js_input_2">修改详情</li>
        <li class="line"></li>
        <li class="js_input_3" id="follow_openlist">客源跟进</li>
        <li class="line"></li>
        ...
        <?php if ('1' == $open_cooperate) { ?>
            ...
            <?php if ('1' == $check_cooperate) { ?>
                <li onclick="share_check('customer')" class="js_input_6">设置合作</li>
            <?php } else { ?>
                <li onclick="set_share_right('customer')" class="js_input_6">设置合作</li>
            <?php } ?>
            <li onclick="cancle_share_right('customer')" class="js_input_7">取消合作</li>
        <?php } ?>
...
<div id="jss_pop_import" class="pop_box_g pop_see_inform" style=" display:none;">
    <div class="hd">
        <div class="title">求购客源导入</div>
        <div class="close_pop"><a href="/customer/manage/" title="关闭" class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">

        <div class="up_m_b_tex">客源导入功能可以将外部客源直接导入<?php echo SOFTWARE_NAME; ?>
            中，省去手动录入的麻烦。为保证您的客源顺利导入，请使用我们提供的标准模板，且勿对模板样式做任何删改。<a
                    href="<?php echo MLS_SOURCE_URL; ?>/xls/example3.xls" target="_blank">
                <img alt="" src="<?php echo MLS_SOURCE_URL; ?>/mls/images/v1.0/page_white_excel.png">点击下载求购客源导入模板</a>
        </div>
        <style>
            .up_m_b_file .text {
                float: left;
        ...
        <div class="up_m_b_file clearfix">
            <form action="/customer/import" enctype="multipart/form-data" target="new" method="post">
        ...
        <iframe allowtransparency="true" src="" frameborder="0" scrolling="no" name="new" id="xx1x" height="35"
                width="393"></iframe>
        <a class="btn-lv1 btn-mid" href="javascript:void(0)" onclick="openn_sure('customer')">确认导入</a>
    </div>
</div>
<script>
    function see_reason() {
...
<div class="pop_box_g pop_box_g_big pop_box_d_c"
     style="display:none;position: fixed;top: 0;bottom: 0;left: 0;right: 0;margin: auto;" id="js_buy_export">
    <div class="hd">
        <div class="title">报表导出</div>
        <div class="close_pop"><a onclick="document.getElementById('js_buy_export').style.display='none';" title="关闭"
                                  class="JS_Close iconfont">&#xe60c;</a></div>
    </div>
    <div class="mod">
        <p class="d_c_title">报表导出</p>
        <div class="inner">
            <form action="<?php echo MLS_URL; ?>/customer/exportReport" method="post" id="myform">
                <!--存放当前的总页数用于判断-->
...
<script>
    ...
    function del_cookie() {
        $.ajax({
            url: "/customer/del_search_cookie/customer_manage",
            type: "POST",
            dataType: "json",
