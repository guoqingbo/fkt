    ...
    <div class="mod">
        ...
        <?php if(is_array($data_info) && !empty($data_info)) { ?>
            <div>
                ...
                <?php }else{?>
                    <a class="collect-btn collect" href="javascript:void(0);" id="collect_info<?php echo $data_info['id'];?>" onclick="collect_customer(<?php echo $data_info['id'];?> ,'rent_customer','info')">收藏房源</a>
                <?php } ?>
            </div>
            <div>
                <a class="btn-lan" href="javascript:void(0);" onclick="parent.open_match_customer('rent_customer', 1 ,<?php echo $data_info['id'];?>)"><span>智能匹配</span></a> 
                <?php if('1'==$open_cooperate){?>
                <a class="btn-lan" href="javascript:void(0);" onclick="parent.cooperate_customer('rent_customer',<?php echo $data_info['id'];?>);"><span>合作申请</span></a>
                <?php }?>
            </div>
        <?php }?>
        </div>
