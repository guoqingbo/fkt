...
<div class="tab_box" id="js_tab_box">
    <a href="<?php echo MLS_URL;?>/customer/publish" class="link"><span class="iconfont">&#xe605;</span>录入求购</a>
    <a href="##" class="link link_on"><span class="iconfont">&#xe604;</span>录入求租</a>
    <a href="/rent_customer/manage" class="btn-lv" style="float:right; margin-right:10px;"><span>&lt;&lt;返回客源列表</span></a>
</div>
<form action='<?php echo MLS_URL;?>/rent_customer/add'  method='post' id = 'jsUpForm'>
<div class='forms forms_scroll h91' id="js_inner">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
            ...
            <div class="item_fg clearfix">
				<div class="left" >
					...
					<div class="y_fg js_fields">
						<input class="input_text input_text_r w80" type="text" name="truename" id="truename" value='' onblur="check_unique_customer('rent_customer','truename')">
            ...
            <div class="item_fg clearfix">
                <div class="left"> <span class="text_fg"><b class="red">*</b>客户电话：</span>
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r w80" type="text" name="telno[]" id="telno1" onblur="check_unique_customer('rent_customer')">
                        <a href="javascript:void(0)" class="iconfont addTel" id="addTel01">&#xe608;</a>
                        <div class="errorBox clear"></div>
                    </div>
                    <div class=" field-tel02 y_fg js_fields hide">
                        <input class="input_text input_text_r w80" type="text" name="telno[]" id="telno2" onblur="check_unique_customer('rent_customer')">
                        <a href="javascript:void(0)" class="iconfont delTel" id="delTel02">&#xe60c;</a>
                        <div class="errorBox clear"></div>
                    </div>
                    <div class=" field-tel03 y_fg js_fields hide">
                        <input class="input_text input_text_r w80" type="text" name="telno[]" id="telno3" onblur="check_unique_customer('rent_customer')">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
            ...
            <div class="item_fg clearfix">
                <div class="left width_b js_fields" >
					...
					<i class="label">
					<?php }?>
                    <input type="radio" name="status" class="input_radio" <?php if($key == 1){?> checked <?php } ?> value='<?php echo $key;?>'> <?php echo $value;?>
                    </i>
                    <?php } ?>
                    <?php } ?>
		...
		<div class="forms_details_fg forms_details_fg_btn" id="js_forms_details_fg">
			...
			<input type = 'hidden' name = 'publish_type' id = 'publish_type' value = 'rent_customer_publish'>
		</div>
  </form>
...
$(function(){
    $('input[name="property_type"]').parent().click(function(){
        ...
        if(property_type_val == '3' || property_type_val == '4' ||
            property_type_val == '5'|| property_type_val == '6' || property_type_val == '7')
        {
            $('#huxing').hide();
            $('#room_min').val('');
            $('#room_max').val('');
        ...
        {
            $('.js_show_pirce').hide();
            $('.js_select_pirce').show();
            //$(".js_select_pirce").val("0");
        }
        else
        {
            $('.js_show_pirce').show();
            $('.js_select_pirce').hide();
            $(".js_select_pirce").val("0");
        }
    });
});
...
$(function(){//发布页底部按钮 悬浮
    ...
    $('#telno1,#telno2,#telno3').live('blur',function(){
        var telno = $(this).val();
        $.ajax({
                url: "/rent_customer/check_blacklist/",
                type: "GET",
                data: {telno: telno},
