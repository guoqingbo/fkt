    ...
    <div class="mod clearfix">
        <div class="trail-fl">
			<div class="tab_pop_hd">
				<div class="clearfix">
                    <a class="item <?php if(1==$num){echo 'itemOn';}?> " href="/customer/customer_follow/<?php echo $customer_id;?>/1">跟进明细</a>
					<a class="item <?php if(2==$num){echo 'itemOn';}?> " href="/customer/customer_follow/<?php echo $customer_id;?>/2">带看明细</a>
					<a class="item <?php if(3==$num){echo 'itemOn';}?> " href="/customer/customer_follow/<?php echo $customer_id;?>/3">提醒明细</a>
				</div>
			</div>
			<div class="trail-fl-cont tab_pop_mod clear" id="js_tab_b01">
                ...
                <?php }else{?>
                    ...
                    <div class="trail-li <?php echo $class_str;?>">
                        ...
                        <div class="p-gai per-add-inf">房源：<?php echo 'CS'.$v['house_id'];?><br>
                        <?php echo $v['text'];?></div>
                        <?php }else{?>
...
function addsave(foll_type)
{
    ...
    var customer_id=$("#customer_id").val();//房源id
    ...
    else
    {
        ...
        if(ti_text=='请填写提醒内容' && ti_time==''){
            $.ajax({
                url:'/customer/add_follow_remind',
                type:'get',
                dataType:'json',
                data:addata,
                success:function(data){
