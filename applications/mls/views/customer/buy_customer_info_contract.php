<div class="pop_box_g pop_box_g_border_none" id="js_pop_box_g" style="display:block; border:none;">
    ...
    <div class="mod">
        <div class="tab_pop_hd">
            <div class="clearfix">
                <a class="item <?php if($tab == 1) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/customer/customer_detail/<?php echo $customer_id;?>/3/1/<?php echo $hide_btn;?>">客源详情</a>
                <a class="item <?php if($tab == 2) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/customer/confidential_info/<?php echo $customer_id;?>/3/2/<?php echo $hide_btn;?>">保密信息</a>
                <a class="item <?php if($tab == 3) { ?> itemOn <?php }?>" href="<?php echo MLS_URL;?>/customer/cooperation/<?php echo $customer_id;?>/3/3/<?php echo $hide_btn;?>">合作统计</a>
            </div>
        </div>
                ...
                <div class="t_box">
                    ...
                    <table class="table" id="js_table_ys">
                        <tr>
                            ...
                            <td class="w170 js_y_hide " id="idno">***</td>
                        </tr>
                        <tr>
                            <td class="w110 t_l">客源职业：</td>
                            <td class="w170 js_y_hide" id="job_type">***</td>
                            <td class="w110 t_l">客源等级：</td>
                            <td class="w170 js_y_hide" id="user_level">***</td>
                            <td class="w110 t_l">年龄：</td>
                            <td class="w170 js_y_hide" id="age_group">***</td>
                        </tr>
                        <tr>
                            <td class="w110 t_l">联系地址：</td>
                            <td colspan="5" class="js_y_hide" id="address">***</td>
                        </tr>
                    </table>
                    <?php }else{ ?>
                    <table class="table"><tr><td colspan="6">很遗憾，没有找到相关求购信息。</td></table>
                    ...
                    <p class="link_btn_b">
                        ...
                        <a onClick="sell_show_ys_inner(<?php echo $data_info['id'];?>)" href="javascript:void(0)">
