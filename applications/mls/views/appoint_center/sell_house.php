...
<div class="tab_box" id="js_tab_box">
	<div class="clearfix" id="js_fun_btn">
		...
		<a href="/appoint_center/app_sell" class="btn-lv" style="float:right; margin-right:10px;"><span>&lt;&lt;返回预约列表</span></a></span></a>
	</div>
</div>
...
<div class="forms forms_scroll h91" id="js_inner">
        ...
        <div class="forms_details_fg">
            <div class="clearfix item_fg">
                ...
                <div class="y_fg js_fields">
                    <input name="block_name" id="block_name" value="<?php echo $house_detail['block_name']; ?>" class="input_text input_text_r  w150" type="text" placeholder="输入拼音或汉字筛选">
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
           <div class="clearfix">
            ...
            <div class="item_fg clearfix">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r  w80" name="dong" id="dong" value="<?php echo $house_detail['dong']; ?>" type="text"  onblur="check_unique_house()">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r  w80" name="unit" id="unit" value="<?php echo $house_detail['unit']; ?>" type="text"  onblur="check_unique_house()">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r  w80" type="text" id="door" value="<?php echo $house_detail['door']; ?>" name="door"  onblur="check_unique_house()">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r  w80" type="text" value="<?php echo $house_detail['owner']; ?>" name="owner">
                    <div class="errorBox clear"></div>
                </div>
                </label>
                <label class="label">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text w130" name="idcare" value="<?php echo $house_detail['idcare']; ?>" type="text" maxlength="18">
                    <div class="errorBox clear"></div>
                </div>
                </label>
            </div>
            <div class="item_fg clearfix">
                <div class="label"> <span class="text_fg"><b class="red">*</b>业主电话：</span>
                    <div class="y_fg js_fields">
                        <input class="input_text input_text_r  w80" type="text" name="telno1" value="<?php echo $house_detail['telno1']; ?>" id="telno1">
                        <a href="javascript:void(0)" class="iconfont addTel" id="addTel01">&#xe608;</a>
                        <div class="errorBox clear"><span id="spann1"></span></div>
                    </div>
                    <div class=" field-tel02 y_fg js_fields hide field-tel02" <?php if(!empty($house_detail['telno2'])){ echo 'style="display:block;"';} ?>>
                        <input class="input_text input_text_r  w80" type="text" value="<?php echo $house_detail['telno2']; ?>" name="telno2" id="telno2">
                        <a href="javascript:void(0)" class="iconfont delTel" id="delTel02">&#xe60c;</a>
                        <div class="errorBox clear"></div>
                    </div>
                    <div class=" field-tel03 y_fg js_fields hide field-tel03"  <?php if(!empty($house_detail['telno3'])){ echo 'style="display:block;"';} ?>>
                        <input class="input_text input_text_r  w80" type="text" value="<?php echo $house_detail['telno3']; ?>" name="telno3" id="telno3">
                ...
                <div class="y_fg">
                    <input class="input_text w80" value="<?php echo $house_detail['proof']; ?>" name="proof" type="text">
                </div>
                </label>
                <label class="label">
                <span class="text_fg">丘地号：</span>
                <div class="y_fg">
                    <input class="input_text w80" name="mound_num" value="<?php echo $house_detail['mound_num']; ?>"  type="text">
                </div>
                </label>
                <label class="label">
                <span class="text_fg">备案号：</span>
                <div class="y_fg">
                    <input class="input_text w80" name="record_num" value="<?php echo $house_detail['record_num']; ?>" type="text">
                </div>
                </label>
                -->
            </div>
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
                        ...
                        <div class="y_fg">
                            <div class="left js_fields">
                                <select class="select" name="room">
                                    ...
                                    <option value="1" <?php if($house_detail['room'] == 1){echo "selected";}?>>1</option>
                                    <option value="2" <?php if($house_detail['room'] == 2){echo "selected";}?>>2</option>
                                    <option value="3" <?php if($house_detail['room'] == 3){echo "selected";}?>>3</option>
                                    <option value="4" <?php if($house_detail['room'] == 4){echo "selected";}?>>4</option>
                                    <option value="5" <?php if($house_detail['room'] == 5){echo "selected";}?>>5</option>
                                    <option value="6" <?php if($house_detail['room'] == 6){echo "selected";}?>>6</option>
                                </select>
                                <div class="errorBox clear"></div>
                            </div>
                            ...
                            <div class="left js_fields">
                                <select class="select" name="hall">
                                    <option value="">请选择</option>
                                    <option value="0" <?php if($house_detail['hall'] == 0){echo "selected";}?>>0</option>
                                    <option value="1" <?php if($house_detail['hall'] == 1){echo "selected";}?>>1</option>
                                    <option value="2" <?php if($house_detail['hall'] == 2){echo "selected";}?>>2</option>
                                    <option value="3" <?php if($house_detail['hall'] == 3){echo "selected";}?>>3</option>
                                    <option value="4" <?php if($house_detail['hall'] == 4){echo "selected";}?>>4</option>
                                </select>
                                <div class="errorBox clear"></div>
                            </div>
                            ...
                            <div class="left js_fields">
                                <select class="select" name="toilet">
                                    <option value="">请选择</option>
                                    <option value="0" <?php if($house_detail['toilet'] == 0){echo "selected";}?>>0</option>
                                    <option value="1" <?php if($house_detail['toilet'] == 1){echo "selected";}?>>1</option>
                                    <option value="2" <?php if($house_detail['toilet'] == 2){echo "selected";}?>>2</option>
                                    <option value="3" <?php if($house_detail['toilet'] == 3){echo "selected";}?>>3</option>
                                    <option value="4" <?php if($house_detail['toilet'] == 4){echo "selected";}?>>4</option>
                                </select>
                                <div class="errorBox clear"></div>
                            </div>
                            ...
                            <div class="left js_fields">
                                <select class="select" name="kitchen">
                                    <option value="">请选择</option>
                                    <option value="0" <?php if($house_detail['kitchen'] == 0){echo "selected";}?>>0</option>
                                    <option value="1" <?php if($house_detail['kitchen'] == 1){echo "selected";}?>>1</option>
                                    <option value="2" <?php if($house_detail['kitchen'] == 2){echo "selected";}?>>2</option>
                                    <option value="3" <?php if($house_detail['kitchen'] == 3){echo "selected";}?>>3</option>
                                </select>
                                <div class="errorBox clear"></div>
                            </div>
                            ...
                            <div class="left js_fields">
                                <select class="select" name="balcony">
                                    <option value="">请选择</option>
                                    <option value="0" <?php if($house_detail['balcony'] == 0){echo "selected";}?>>0</option>
                                    <option value="1" <?php if($house_detail['balcony'] == 1){echo "selected";}?>>1</option>
                                    <option value="2" <?php if($house_detail['balcony'] == 2){echo "selected";}?>>2</option>
                                    <option value="3" <?php if($house_detail['balcony'] == 3){echo "selected";}?>>3</option>
                                    <option value="4" <?php if($house_detail['balcony'] == 4){echo "selected";}?>>4</option>
                                </select>
                                <div class="errorBox clear"></div>
                            </div>
                ...
                <div class="left js_fields">
                 ...
                 <div class="left width_b">
                    ...
                    <div class="y_fg js_fields" id="d_input" style="margin-right: 5px;" <?php if($house_detail['floor_type']==1 || empty($house_detail['floor_type'])){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>>
                        <input class="input_text input_text_r w20" name="floor" value="<?php echo $house_detail['floor'];?>" type="text">
                        <div class="errorBox clear"></div>
                    </div>
                    ...
                    <div class="y_fg hide"  id="y_input" <?php if($house_detail['floor_type']==2){echo 'style="display:block;"';}?>>
                        <div class="js_fields left js_fields">
                            <input class="input_text input_text_r w20" name="floor2"  value="<?php echo $house_detail['floor'];?>"  type="text">
                            <div class="errorBox clear"></div>
                        </div>
                        <span class="y_fg y_fg_p5">一</span>
                        <div class="js_fields left">
                            <input class="input_text input_text_r w20 js_fields"  value="<?php echo $house_detail['subfloor'];?>"  name="subfloor" type="text">
                            <div class="errorBox clear"></div>
                        </div>
                    </div>
                    ...
                    <div class="left">
                        <input class="input_text input_text_r w50" type="text" name="totalfloor" value="<?php echo $house_detail['totalfloor'];?>" id="z_louceng">
                        <div class="errorBox clear"></div>
                    </div>
                    </label>
                </div>
            ...
            <div class="item_fg clearfix">
                ...
                <div class="y_fg js_fields">
                    <input class="input_text input_text_r w60" name="buildarea" id="buildarea" type="text" value="<?php echo strip_end_0($house_detail['buildarea']);?>" onblur="get_avgprice();">
            ...
            <div class="item_fg clearfix">
               ...
               <div class="left js_fields">
                    ...
                    <label class="label key_label" <?php if(empty($house_detail['keys'])){echo "style='display: none;'";}?>>
                        ...
                        <div class="y_fg">
                            <input class="input_text input_text_r w80" type="text" value="<?php echo $house_detail['key_number'];?>" id="key_number" name="key_number" <?php if($house_detail['key_number']){echo "readonly='readonly'";}?>>
                        </div>
                    </label>
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
                ...
                <div class="left">
                    <?php if('1'==$open_cooperate){?>
                        <?php if('1'==$check_cooperate){?>
                            ...
                            <?php }else{?>
                            <i class="label mod_p <?php if($house_detail['isshare'] == 1){echo "labelOn";}?>" id = "js_gs_01">是
                                <input type="radio" <?php if($house_detail['isshare'] == 1){echo "checked";}?> class="input_radio" name="isshare" value="2">
                            </i>
                        ...
                        <?php }else{?>
                            <i class="label mod_p <?php if($house_detail['isshare'] == 1){echo "labelOn";}?>" id = "js_gs_01">是
                                <input type="radio" <?php if($house_detail['isshare'] == 1){echo "checked";}?> class="input_radio" name="isshare" value="1">
                            </i>
                            <i class="label mod_p <?php if(empty($house_detail['isshare'])){echo "labelOn";}?>"  id = "js_gs_02">否
                                <input type="radio" <?php if(empty($house_detail['isshare'])){echo "checked";}?> class="input_radio" value="0" name="isshare">
                            </i>
                        <?php }?>
                    <?php }else{?>
                                <input type="hidden" name="isshare" value="<?php echo $house_detail['isshare'] == 1?1:0; ?>"/>
                    <i class="label mod_p <?php if($house_detail['isshare'] == 1){echo "label-no2";}else{echo "label-no";}?>" id = "js_gs_01">是
                    </i>
                    <i class="label mod_p <?php if(empty($house_detail['isshare'])){echo "label-no2";}else{echo "label-no";}?>"  id = "js_gs_02">否
                    </i>
                    <?php }?>
                </div>
                <span class="info_bc left">合作房源将在合作中心展示，帮助您高效合作，快速成交！甲方为房源委托方，乙方为购房委托方。</span>
            </div>
            <!--            <div  class="item_fg reset_P clearfix">-->
            <!--                <div class="text_fg"><b class="red">*</b>是否发布网店：</div>-->
            <!--                <div class="left">-->
            <!--                    <i class="label mod_p -->
            ...
            <!--                    </i>-->
            <!--                </div>-->
            <!--                <span class="info_bc left">群发网店有助于您快速成交房源哦！</span>-->
            <!--            </div>-->
        </div>
				...
				<div class="width_b left">
                    <div class="left" width="19%">
                        <div class="text_fg"> 房屋设施：</div>
									...
									<div class="text_fg clear"><b style="float:right;" class="label" onClick="checkedAll(this,'js_check_all01')">
										<input type="checkbox" class="js_checkbox input_checkbox"> 全选 </b>
									</div>
									</div>
                    <div class="check_all" id="js_check_all01">
                        <?php
               ...
               <div class="width_b left">
                   <div class="left">
                       <div class="text_fg"> 周边环境：</div>
						<div class="text_fg clear"><b style="float:right;" class="label" onClick="checkedAll(this,'js_check_all02')">
							<input type="checkbox" class="js_checkbox input_checkbox"> 全选 </b>
						</div>
						</div>
        ...
        <div class="forms_details_fg forms_details_fg_bg clearfix">
            ...
            <div class="js_s_h_info_house">
                <div class="item_fg fy_describe">
                    <div class="js_fields"><b class="red"></b>房源标题：<input type="text" class="fybt_search" name="title"
                                                                          id="title"
                                                                          value="<?php echo $house_detail['title']; ?>"
                                                                          onkeyup="textCounter()">
                    <script>
                    function textCounter(){
                        var text_uid=$("#title").val();
                        var text_num=40-text_uid.length;
                        var more=text_uid.length-40;
                        if(text_uid.length<=40){
                    ...
                    <span class="span1"><span class="span1" id="house_title_num">您还可输入40个字</span></span><a href="javascript:void(0)" class="btn-lv" id="title_template_button"><span>模板</span></a> </div>
                </div>
                <div class="item_fg clearfix"><?php if(empty($tmps)){ ?><p class="d_c left">详细描述： 您还没有设置过模版哦！</p><?php } ?>
                        ...
                        <?php if(!empty($tmps) && isset($tmps)) {
                            ...
                            <?php } }?>
                        <a href="javascript:void(0)" class="mobanBtn btnw66" id="btn-manage-tmp" onClick="openWin('gl_moban')">管理模板</a>
...
<div id="js_pop_add_new_block" class="pop_box_g" style="overflow:hidden;">
    <div class="hd">
        ...
        <div class="close_pop">
        	<a class="JS_Close iconfont" title="关闭" href="javascript:void(0);"></a>
        </div>
    </div>
    <div class="mod" style="_width:771px;">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <div>外景图<span class="t">至多上传10张室内图</span></div>
                                <div class="add_item">
        ...
        <div class="tab_pop_bd add_new_block_bd"> <a href="javascript:void(0);" class="btn-lv1 btn-left" style="margin-left:333px;" id='add_cmt_submit'>新建楼盘</a><a href="javascript:void(0);" class="btn-hui1 JS_Close" style="float:left;">取消</a> </div>
    </div>
</div>
<!-- 模板提示弹窗-->
...
<div id="js_house_title_template_success" class="pop_box_g pop_see_inform pop_no_q_up" >
    ...
    <!-- 模板确认修改状态弹窗-->
    <div id="js_pop_warning_change_status" class="pop_box_g pop_see_inform pop_no_q_up" >
        <div class="hd">
            <div class="title">提示</div>
    ...
    <div class="warrant-step-mb">
	   ...
	   <div class="select_info clearfix">
			...
			<div class="forms fo" id="title_template_select">
				<b class="label label1 labelOn"><input class="input_checkbox"  id="js_checkbox" type="checkbox" name="title_category" value="all">全部</b>
				<b class="label label2 labelOn"><input class="input_checkbox"  type="checkbox" name="title_category" value="name">楼盘</b>
				<b class="label label2 labelOn"><input class="input_checkbox"  type="checkbox" name="title_category" value="fitment">装修</b>
				<b class="label label2 labelOn"><input class="input_checkbox"  type="checkbox" name="title_category" value="room">户型</b>
				<b class="label label2 labelOn"><input class="input_checkbox"  type="checkbox" name="title_category" value="price">价格</b>
				<b class="label label2 labelOn"><input class="input_checkbox"  type="checkbox" name="title_category" value="area">面积</b>
			</div>
	   </div>
	   <div class="data_list">
