...
function chang(type){
 ...
 $.ajax({
	...
	<div class="fg_box">
		...
		<div class="fg">
			<input type="text" name='cmt_name' class="input w90" id='block01' value="<?php echo $post_param['cmt_name'];?>">
    ...
    <div class="fg_box">
            ...
            <div class="fg"> <a href="/rent_customer/lists_rent_customer/" class="reset">重置</a> </div>
        </div>
</div>
        ...
        <table class="table">
            <tr>
                ...
                <td class="c5"><div class="info"><a href="javascript:void(0)" onclick="selllist_order(5);return false;" id="order_area" class="i_text <?php if($post_param['orderby_id'] == 6 ){ echo 'i_down'; }elseif($post_param['orderby_id'] == 5){ echo 'i_up'; } ?>">面积<br>
                        (㎡)</a></div></td>
                <td class="c5"><div class="info"><a href="javascript:void(0)" onclick="selllist_order(7);return false;" id="order_price" class="i_text ">租金<br>(元/月)</a></div></td>
...
<div class="pop_box_g pop_see_inform pop_no_q_up" id="js_pop_msg1">
    <div class="hd">
        <div class="title">提示</div>
        <div class="close_pop">
            <a class="JS_Close iconfont msg_iconfont_close" title="关闭" href="<?php echo MLS_URL;?>/rent_customer/lists_rent_customer"></a>
        </div>
    </div>
    <div class="mod">
        <div class="inform_inner">
...
function all_share(type){
	...
	$("#dialog_share").click(function(){
		...
		$.ajax({
			url: "<?php echo MLS_URL;?>/rent_customer/change_all_share/",
			type: "GET",
			dataType: "json",
