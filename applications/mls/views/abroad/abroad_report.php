    ...
    <dl class="oversea_contract">
        <dd>
            <form action="" method="post" name="search_form" id="search_form">
                ...
                <div class="fg"> <a href="/abroad_report" class="sea_dd_sub">重置</a> </div>
            </form>
        </dd>
        <dt><a href="javascript:void(0);" class="sea_dd_sub" <?php if($group_id==2){?>onclick="openWin('js_report_pop');"<?php }else{?>onclick="permission_none();"<?php }?>>客户报备</a></dt>
    </dl>
    <!--合同报备列表-->
    <div class="oversea_contract_list" id="js_inner">
        <table class="oversea_table" align="center" border="0" cellspacing="0">
            <thead>
                <tr class="tr_underline tr_bg">
...
<div class="sea_pop" style="display: none;" id="js_report_pop">
    ...
    <div class="sea_pop_con">
        ...
        <li>
            ...
            <dl class="errorBox" id="name_error" style="display: none;text-indent: 4em;color:#ff0000;line-height:22px;"></dl>
        </li>
        <li>
            <dl class="sea_pop_con_dl">
                <dd>电话：</dd>
            ...
            <dl class="errorBox" id="phone_error" style="display: none;text-indent: 4em;color:#ff0000;line-height:22px;"></dl>
        </li>
...
<script type="text/javascript">
  ...
  $(".oversea_main").css("height",body_H+"px");
//隔行变色
