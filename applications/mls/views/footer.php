<!-- 没有权限页面 -->
<div id="js_pop_do_permission_none" class="pop_box_g pop_see_inform pop_no_q_up" >
    <div class="hd">
            ...
            <div class="up_inner">
                <div class="text-wrap">
                    <table>
                        <tr>
                            <td>
                                <div class="img"><img id="imgg" src="<?php echo MLS_SOURCE_URL;?>/mls/images/v1.0/s_ico.png"></div>
                            </td>
                            <td>
                                <span class="text" id='dialog_do_permission_none_tip'></span>
                            </td>
                        </tr>
                    </table>
                </div>
