   ...
   <div class="left item <?php if($cooperate_info['step'] == 1){?>item02<?php } ?>">
    ...
    <div class="jt">
     ...
     <?php if($cooperate_info['step'] >= 3){?>
        <div class="left item <?php if($cooperate_info['step'] > 3) { ?> item <?php }else if($cooperate_info['step'] == 3){?>item02<?php } ?>">
            <div class="bz">
            ...
            <div class="tipe">
                ...
                <?php } else if(!empty($cooperate_info['log_record']['3']['4'])){?>
                    ...
                    <p class="t">已完成</p>
                    <?php }else {?>
                    <p class="t"><?php echo $cooperate_info['config']['esta'][$cooperate_info['log_record']['3']['4']['esta']];?></p>
                    <?php } ?>
    ...
    <div class="left item <?php if($cooperate_info['step'] > 4) { ?> item <?php }else if($cooperate_info['step'] == 4){?>item02<?php } ?>">
        <div class="bz">
...
<div class="cooperation_house_d clearfix">
	...
	<div class="qr_bd">
		<div>
			<label class="label"><input type="radio" name="esta" value="8">合作失败未成交</label>
			<label class="label"><input type="radio" name="esta" checked="" value="7">该房源已成交</label>
			<input type="hidden" id="type" value="<?=$cooperate_info['tbl']?>">
			<label class="label">成交价<input type="text" class="input_t" name="total_price" id ="total_price">
			<?php if($cooperate_info['tbl'] == 'sell'){?>
			   万
			<?php }else {?>
			   元/月
			<?php } ?></label>
			<label for="total_price" id ="show_error" class="error" style="color:red;"></label>
		</div>
        <p class="tex">温馨提示：成交价提交将纳入您的诚信考核，请如实填写真实成交价格，核实后将会奖励您相应的积分和诚信度指数。</p>
    </div>
	<?php }?>
