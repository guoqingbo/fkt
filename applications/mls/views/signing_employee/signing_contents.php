...
<form method='post' action='' id='search_form' name='search_form'>
    <div class="search_box clearfix" id="js_search_box">
        <div class="fg_box">
            ...
            <div class="fg">
                <select name="store_name" class="input w150">
                        <option value="no" id="no" selected>不限</option>
                        <?php if($department){
                        foreach($department as $key=>$val) {?>
                        <option value="<?php echo $val['department_name'];?>" <?php if($store_name == $val['department_name']){echo selected;}?>><?php echo $val['department_name'];?></option>
                        <?php }}?>
                </select>
            </div>
        </div>
        ...
        <div class="fg_box">
            ...
            <div class="fg"> <a href="javascript:void(0)" class="reset" onclick="javascript:location.href ='/signing_employee/index';return false;">重置</a> </div>
        </div>
