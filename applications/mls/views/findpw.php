...
<title>经纪人忘记密码页面</title>
<link href="<?php echo MLS_SOURCE_URL;?>/min/?b=mls&f=third/iconfont/iconfont.css,css/v1.0/web_reseat.css,css/v1.0/register_login_password2.css,css/v1.0/house_manage.css" rel="stylesheet" type="text/css">
<script src="<?php echo MLS_SOURCE_URL;?>/min/?b=mls/js/v1.0&f=jquery-1.8.3.min.js,jquery.validate.min.js,openWin.js"></script>
<script>
$(function() {
...
<body class="find_password_body">
	<div class="header">
		<div class="header-inner">
            <a class="logo fl" href="/login"><img src="<?php echo MLS_SOURCE_URL; ?>/mls/images/v1.0/codi/logo/codi.png"
                                                  title="<?= $title ?>"></a>
            <a class="try-btn fr" href="/register">免费申请试用</a>
            <!--            <a class="try-btn fr" href="/login">返回登陆页面</a>-->
		</div>
	</div>
    <div id="findpw_ok_div" class="find_password" style="display:none; height:250px; padding-top:100px;">
        <div class="s_text">密码已重新设置！</div>
        <!--        <div class=""><a href="/login/">点击返回登陆页面</a>！</div>-->
    </div>
   ...
   <div class="footer" style="margin-top:120px;">
		<div class="footer-inner">
            ...
            <p class="company-name">科地地产 <a href="#">浙ICP备</a></p>
		</div>
	</div>
  <!--操作结果弹出提示框-->
