        ...
        <div class="search_box clearfix zws_position " id="js_search_box_02" style="padding:0 0 10px 0;">
            <form name="search_form" id="search_form" method="post" action="">
                ...
                <div class="fg_box">
                    ...
                    <div class="fg mr10" style="*padding-top:10px;">
                        <select class="select zws_w" name="status" style="width:60px;">
                            <option value="0" <?= isset($post_param['status']) && $post_param['status'] == '0' ? "selected" : ''; ?>>
                                不限
                            </option>
                ...
                <div class="fg_box">
                    ...
                    <div class="fg">
                        <input type="text" name="block_name" class="input w90 ui-autocomplete-input" autocomplete="off"
                               value="<?= $post_param['block_name']; ?>">
                ...
                <div class="fg_box">
                    <div class="fg"><a href="javascript:void(0)" onclick="$('#search_form').submit();return false;"
            ...
            <table class="table">
                ...
                <?php if ($list) {
                    foreach ($list as $key => $val) { ?>
                        <tr class="">
                            <td class="zws_W8">
                                <div class="info"><input type="radio" name="id" value="<?= $val['id']; ?>"
                                                         id="house_id<?= $val['id']; ?>" <?= $house_id == $val['house_id'] ? 'checked' : ''; ?>><?= $val['house_id']; ?>
                                </div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $val['isshare_district'] == 1 ? "是" : "否"; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $config['status'][$val['status']]; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $type != 2 ? "出售" : "出租" ?></div>
                            </td>
                            <td class="zws_W22">
                                <div class="info"><?= $val['block_name']; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $val['floor']; ?>/<?= $val['totalfloor']; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $val['owner']; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $val['buildarea']; ?></div>
                            </td>
                            <td class="zws_W8">
                                <div class="info"><?= $val['price']; ?></div>
                            </td>
                            <?php if ($val['isshare_district'] == 1) { ?>
                                <td>
                                    <div class="info"><?= $val['district_agency_name']; ?>
                                        <br/><?= $val['district_broker_name']; ?></div>
                                </td>
                            <?php } else { ?>
                                <td>
                                    <div class="info"><?= $val['agency_name']; ?><br/><?= $val['broker_name']; ?></div>
                                </td>
                            <?php } ?>
            ...
            <tr>
                <td class="zws_center">
                    <button type="button" class="btn-lv1 btn-left"
                            onclick="$('input[type=radio]').removeAttr('checked');">清空
                    </button>
...
<script>
    $(function () {
        ...
        // $('#js_house_box').height = document.documentElement.clientHeight;
        //
        // // var table = $('.table_all').height();
        // // var box = table + 179;
        //
        // // $('#js_house_box').height(box);
        // // $('.iframePop').height(box);
        // console.log($('#js_house_box').height());
        //
        // // document.write(a1);
    })
