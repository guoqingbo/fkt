...
<div class="contract-wrap clearfix">
    ...
    <div class="forms_scroll h90" style="overflow-y:hidden;">
        ...
        <!--	    <a href="/signing/contract_list/1" class="link -->
        <? //=$type==1?'link_on':''?><!--"><span class="iconfont hide"></span>出售</a>-->
        <!--	    <a href="/signing/signing_list/2" class="link -->
                ...
                <div class="100%;display:block;">
                    ...
                    <div class="fg_box">
                        ...
                        <div class="fg"><a href="javascript:void(0);"
                                           onclick="$('#subform :input[name=page]').val('1');$('#subform').attr('action', '/signing/transfer_list');form_submit();return false;"
                                           class="btn"><span class="btn_inner">搜索</span></a></div>
                        <div class="fg"><a href="/signing/transfer_list/<?= $type; ?>" class="reset">重置</a></div>
                    </div>
                </div>
            </div>
                ...
                <?php if ($list) {
                    foreach ($list as $key => $val) { ?>
                        <table class="table list-table cont_list_bottom_solid" align="center"
                            ...
                            <tr id="contract_list"
                                onclick="location.href='/signing/transfer_detail/<?= $val['id']; ?>';return false;">
                                ...
                                <td style="width:77%">
                                    <table class="table inner-table">
                                        <tr class="first cont_list_bottom_dashed ">
                                            ...
                                            <td class="c_table_body_2 zws_border_dashed"><?= $val['signatory_id'] > 0 ? $val['signatory_name'] : ""; ?></td>
                                            <td class="c_table_body_3 zws_border_dashed"><?= date('Y-m-d', $val['signing_time']); ?></td>
                                            <td class="zws_border_dashed"
                                                style="padding:0 6px;"><?= $config['bargain_status'][$val['bargain_status']]; ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
