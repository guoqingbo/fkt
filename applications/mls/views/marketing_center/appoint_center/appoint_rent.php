...
<form name="search_form" id="search_form" method="post" action="<?php echo MLS_URL;?>/appoint_center/app_rent">
...
<div class="search_box clearfix"  id="js_search_box_02">
    ...
    <div class="fg_box">
        ...
        <div class="fg"> <a href="<?php echo MLS_URL;?>/appoint_center/app_rent" class="reset">重置</a> </div>
    </div>
</div>
...
<div class="table_all" >
        ...
        <table class="table">
            <tr>
                ...
                <td class="c6"><div class="info">面积(㎡)</div></td>
  				<td class="c6"><div class="info">租金</div></td>
    ...
    <div class="inner shop_inner" id="js_inner">
        <table class="table">
			...
			if($list){
				foreach($list as $vo){?>
					<tr id="tr<?php echo $vo['id'];?>" date-url="/rent/details_house/<?php echo $vo['id'];?>/1/1/0/<?=$vo['app_id']?>" controller="appoint_center" _id="<?php echo $vo['id'];?>">
						...
						<td class="c6"><div class="info cf60"><strong class="f60"><?php echo strip_end_0($vo['price']); if($vo['price_danwei'] == 1){echo "元/㎡*天";}else{echo "元/月";}?></strong></div></td>
...
<ul id="openList" >
    ...
    <!--右键菜单-->
	<li onClick="openHouseDetails_app('rent',1);" class="js_input_1">查看详情</li>
