...
<div id="js_search_box" class="shop_tab_title forms">
    ...
    <b class="label" onclick = "javascript:location.href='/customer_demand/seek_rent/1';">已抢客源</b>
        ...
        <table class="table">
            <tbody>
                <tr>
                    ...
                    <td class="c15"><div class="info">租金范围</div></td>
        ...
        <table class="table">
            <tbody>
                ...
                <tr <?php if($key % 2 == 1){ ?>class="bg" <?php }?> id="tr<?php echo $val['id'];?>">
                    ...
                    <td class="c15"><div class="info f60"><?=$val['lprice'];?>-<?=$val['hprice'];?>元/月</div></td>
    ...
    function check_num(){
        ...
        if(pricemin && pricemax){
            if(parseInt(pricemin)>=parseInt(pricemax)){
                $("#pricemin_reminder").html("租金筛选区间输入有误！");
                $("input[name='is_submit']").val('0');
                return;
            }else{
                $("#pricemin_reminder").html("");
        ...
        $.ajax({
            ...
            success:function(data){
                if(data['result'] ==200){
                    ...
                    $("#detail_price").children('strong').text(data['data']['lprice']+"-"+data['data']['hprice']+"元/月");
