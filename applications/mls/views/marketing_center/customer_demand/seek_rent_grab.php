...
<div id="js_search_box" class="shop_tab_title forms">
    ...
    <b class="label labelOn" onclick = "window.location.href='/customer_demand/seek_rent/';">已抢客源</b>
        ...
        <table class="table">
            <tbody>
                ...
                <tr <?php if($key % 2 == 1){ ?>class="bg" <?php }?> id="tr<?php echo $val['id'];?>">
                    ...
                    <td class="c15"><div class="info f60"><?=$val['lprice'];?>元/月-<?=$val['hprice'];?>元/月</div></td>
