 ...
 * @author          sun
 */
class Permission_modules_base_model extends MY_Model
{
   ...
   * @var string
   */
  private $_tbl = 'permission_modules';
  private $_tbl_list = 'permission_list';
  ...
  public function __construct()
  {
    ...
    $this->_mem_key = $city . '_permission_modules_base_model_';
  }
  ...
  public function get_all_by($where = '', $start = -1, $limit = 20)
  {
    ...
    $sql = "select pid,name,pname,is_this_user_hold,l.status as status,l.mid,l.tab_id,l.secondtab_id from permission_list l LEFT JOIN permission_modules m on " . $where;
  ...
  {
    $sql = "select * from permission_modules ";
    $result = $this->dbback_city->query($sql)->result_array();
    return $result;
  }
  ...
  {
    $sql = "select * from permission_modules where status=1 and id = '" . $id . "'";
...
/* End of file permission_modules_base_model.php */
/* Location: ./applications/models/permission_modules_base_model.php */
