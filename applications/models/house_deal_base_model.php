 ...
 * @author          sun
 */
class House_deal_base_model extends MY_Model
{
   ...
   * @param int $order_house_deal 排序字段
                             ...
                             $order_house_deal = 'id', $order_by = 'DESC')
  {
    ...
    //排序条件
    $this->dbback_city->order_by($order_house_deal, $order_by);
    if ($start >= 0 && $limit > 0) {
...
/* End of file house_deal_base_model.php */
/* Location: ./applications/models/house_deal_base_model.php */
