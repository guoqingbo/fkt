 ...
 * @author          sun
 */
class Key_log_base_model extends MY_Model
{
                             ...
                             $order_key = 'id', $order_by = 'DESC')
  {
    ...
    //排序条件
    $this->dbback_city->order_by($order_key_log, $order_by);
    if ($start >= 0 && $limit > 0) {
...
/* End of file key_log_base_model.php */
/* Location: ./applications/models/key_log_base_model.php */
