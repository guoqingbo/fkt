 ...
 * @author          sun
 */
class Permission_system_role_base_model extends MY_Model
{
   ...
   * @var string
   */
  private $_tbl = 'permission_system_role';
  ...
  {
    $this->dbback_city->select('id, name, description ,level');
   ...
   * @return array 返回多条记录组成的二维数组
   */
  public function get_all_syspermission()
  {
    //返回结果
    $result = $this->dbback_city->get('permission_system_group')->result_array();
    return $result;
  }
