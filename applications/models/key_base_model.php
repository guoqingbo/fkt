 ...
 * @author          sun
 */
class Key_base_model extends MY_Model
{
  ...
  public function count_by($where = '')
  {
    ...
    return $this->dbback_city->count_all_results($this->_tbl . ' left join broker_info on key.broker_id = broker_info.broker_id');
  }
...
/* End of file key_base_model.php */
/* Location: ./applications/models/key_base_model.php */
