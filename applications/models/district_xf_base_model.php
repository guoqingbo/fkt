 ...
 * @author liuhu
 */
class District_xf_base_model extends MY_Model
{
   ...
   * @var string
   */
  protected $_district_tbl = 'district_xf';
   ...
   * @var string
   */
  protected $_street_tbl = 'street_xf';
  ...
  public function __construct()
  {
    ...
    $this->_mem_key = $city . '_xffx_district_base_model_';
  }
