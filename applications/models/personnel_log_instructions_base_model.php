...
/**
 * Personnel_log_instructions_base_model CLASS
 *
 * 批示日志信息基础类
 *
 * @package         MLS
 ...
 * @author          sun
 */
class Personnel_log_instructions_base_model extends MY_Model
{
   ...
   * @var string
   */
  private $_tbl = 'personnel_log_instructions';
...
/* End of file personnel_log_instructions_base_model.php */
/* Location: ./application/models/personnel_log_instructions_base_model.php */
