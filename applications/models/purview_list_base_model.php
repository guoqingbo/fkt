 ...
 * @author          sun
 */
class Purview_list_base_model extends MY_Model
{
  ...
  public function get_list_by($id, $k)
  {
    $sql = "select pid,pname,tab_id,secondtab_id from purview_list where status=1 and pid =" . $id . " and mid=" . $k;
