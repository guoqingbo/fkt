...
/**
 * Personnel_log_see_base_model CLASS
 *
 * 查看日志信息基础类
 *
 * @package         MLS
 ...
 * @author          sun
 */
class Personnel_log_see_base_model extends MY_Model
{
   ...
   * @var string
   */
  private $_tbl = 'personnel_log_see';
...
/* End of file personnel_log_see_base_model.php */
/* Location: ./application/models/personnel_log_see_base_model.php */
