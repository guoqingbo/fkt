...
/**
 * Publish_count_num_base_model CLASS
 *
 ...
 * @author          sun
 */
class Publish_count_num_base_model extends MY_Model
{
   ...
   * @var string
   */
  private $_tbl = 'publish_count_num';
  ...
  /* 群发统计日志
   * 1 58同城 2 58网邻通 3 赶集 4 赶集vip 5 安居客 6安居客 7 365淘房
   */
...
/* End of file Publish_count_num_base_model.php */
/* Location: ./applications/models/Publish_count_num_base_model.php */
