...
class Collections_model extends MY_Model
{
   ...
   * @author       fisher
   */
  function get_new_sell_num($database = 'dbback_city')
  {
    $count_num = 0;
   ...
   * @author       angel_in_us
   */
  function get_sell_num($where = array(), $like = array(), $database = 'dbback_city')
  {
    $sell_sum = $this->get_data(array('form_name' => $this->sell_house_collect, 'where' => $where, 'like' => $like, 'select' => array('count(*) as num')), $database);
   ...
   * @author       angel_in_us
   */
  function get_rent_num($where = array(), $like = array(), $database = 'dbback_city')
  {
    $rent_num = $this->get_data(array('form_name' => $this->rent_house_collect, 'where' => $where, 'like' => $like, 'select' => array('count(*) as num')), $database);
   ...
   * @author       angel_in_us
   */
  function get_house_sell($where = array(), $where_in = array(), $like = array(), $or_like = array(), $order_by = '', $offset = 0, $limit = 10, $database = 'dbback_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_house_rent($where = array(), $where_in = array(), $like = array(), $or_like = array(), $order_by = '', $offset = 0, $limit = 0, $database = 'dbback_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_housesell_byid($where = array(), $database = 'dbback_city')
  {
   ...
   * @author       angel_in_us
   */
  function get_houserent_byid($where = array(), $database = 'dbback_city')
  {
