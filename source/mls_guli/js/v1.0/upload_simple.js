...
function uploadSuccessSimple(file, serverData) {
  try {
    var progress = new FileProgress(file, this.customSettings.upload_target);
    ...
    if(resultData.success === 1) {
      addImageSimple(resultData.result.imgUrl, this.customSettings.upload_infotype, this.customSettings.upload_nail);
    }
...
function addImage(src, upload_infotype, upload_nail) {
  ...
  var content = '<div class="upload-wei-item add_item_pic" style="width:170px;float:left;display:inline;overflow:hidden;margin:4px 3px;"><img style="width:170px;height:120px;float:left;display:inline;" src="' + bigimg + '"><input class="hidden_1" type="hidden" value="' + src + '" name="' + upload_infotype + '"><a class="del_pic" href="javascript:void(0);" onClick="fun_hide_p(this,' + nail + ');" style="color:#000;float:left;line-height:24px;">删除</a><a href="javascript:void(0);" class="label_pic" onClick="fun_first_p(this)" style="float:right;line-height:24px;">设为首图</a></div>';
  $("#" + upload_nail).append($(content));

}

function addImageSimple(src, upload_infotype, upload_nail) {
  var bigimg = src.replace('/thumb', '');
  var nail = "'" + upload_nail + "'";
  var content = '<div class="upload-wei-item add_item_pic" style="width:170px;float:left;display:inline;overflow:hidden;margin:4px 3px;"><img style="width:170px;height:120px;float:left;display:inline;" src="' + bigimg + '"><input class="hidden_1" type="hidden" value="' + src + '" name="' + upload_infotype + '"><a class="del_pic" href="javascript:void(0);" onClick="fun_hide_p(this,' + nail + ');" style="color:#000;float:left;line-height:24px;">删除</a></div>';
  $("#" + upload_nail).append(content);
...
function fun_hide_p(obj, nail) {
  $(obj).parents('.upload-wei-item').remove();
  $("#" + nail).trigger('uploadRemove');
};
