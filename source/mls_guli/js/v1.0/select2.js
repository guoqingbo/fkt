/*
 ...
 the specific language governing purviews and limitations under the Apache License and the GPL License.
 */
(function ($) {
    ...
    prepareOpts: function () {
      ...
      if (opts.element.get(0).tagName.toLowerCase() === "select") {
        ...
        opts.initSelection = opts.initSelection || function (element, callback) {
            var id = element.val();
            //search in data by id, storing the replace matching item
            var match = null;
            opts.query({
