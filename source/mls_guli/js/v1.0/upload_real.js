function fileQueueError(file, errorCode, message) {
  try {
    if (errorCode === SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED) {
      alert("��ѡ����ļ�������������.\n" + (message === 0 ? "You have reached the upload limit." : "��ֻ������ѡ��" + (message > 1 ? "���" + message + "���ļ�." : "1���ļ�.")));
      return;
    }
...
function del(upload_infotype) {
  var oSwfu = upload_infotype == 1 ? swfu0 : swfu1;
...
function addImage(src, upload_infotype, upload_nail) {
  ...
  if ($("#" + upload_nail + " img").size() >= oSwfu.customSettings.upload_limit) {
    ...
    var content = '<div class="mItem" style="">\n\
                            <div class="mItemInner">\n\
                                <div class="mPic">\n\
                                    <img width="130" height="100"  src="' + src + '" alt="">\n\
                                    <input type="hidden" value="' + src + '" name="p_filename[]">\n\
                                    <input class="pic_type" type="hidden" value="' + upload_infotype + '" name="pic_type[]">\n\
                                    <div class="funMtext">\n\
                                        <div  title="ɾ��" id="' + upload_infotype + '" class="delBtn" onclick="delImg(this);del(' + upload_infotype + ');" >ɾ��</div>\n\
                                    </div>\n\
                                </div>\n\
                            </div>\n\
                        </div>';
