...
function addImage(src, upload_infotype, upload_nail) {
  ...
  if ($("#" + upload_nail + " img").size() >= oSwfu.customSettings.upload_limit) {
    ...
    var content = '<div class="add_item_pic add_item_pic_w left" onMouseOver="showBtn(this)" onMouseOut="hideBtn(this)">'
      + '<div class="pic">'
      + '<img height="65" width="65" src="' + src + '">'
      + '</div>'
      + '<input type="hidden" value="' + src + '" name="img_name' + upload_infotype + '[]"><div class="del_pic_bg">遮罩</div>'
      + '<a class="del_pic" href="javascript:void(0);" onClick="fun_hide_p(this);swfu1.setButtonDisabled(false);">删除</a>'
      + '</div>';
