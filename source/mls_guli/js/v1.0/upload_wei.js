...
function addImage(src, upload_infotype, upload_nail) {
  var oSwfu = swfu1;
  var content = '<div class="upload-wei-item"><img height="120" width="170" src="' + src + '"><input type="hidden" value="' + src + '" name="' + upload_infotype + '[]"><input type="hidden" value="0" name="p_fileids' + upload_infotype + '[]"><a class="upload-wei-fun" href="javascript:void(0)" onClick="fun_hide_p(this);swfu1.setButtonDisabled(false);">删除</a></div>';
