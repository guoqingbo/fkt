...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("button_text_left_padding", 5);
...
SWFUpload.prototype.getFlashHTML = function () {
	...
	//return ['<embed width="', this.settings.button_width, '" height="', this.settings.button_height, '" wmode="', this.settings.button_window_mode , '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" quality="high" src="', this.settings.flash_url, '">'].join("");

	// Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
	return ['<object wmode="transparent" id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
