...
function addImage(src, upload_infotype, upload_nail) {
    ...
    var oSwfu = upload_infotype == 0 ? swfu0 : (upload_infotype == 1 ? swfu1 : (upload_infotype == 5 ? swfu5 : swfu2));
  var imgarr = $("#" + upload_nail).find(".add_item_pic");
  if ($("#" + upload_nail + " img").size() >= oSwfu.customSettings.upload_limit) {
    this.setButtonDisabled(true);
  }
  else if (src.indexOf('http://') >= 0) {
    if (imgarr.length < 1) {
      var content = '<div class="add_item_pic add_item_pic0"><div class="pic"><img height="100" width="130" src="' + src + '"><input class="hidden_1" type="hidden" value="' + src + '" name="p_filename' + upload_infotype + '[]"><input class="hidden_2" type="hidden" value="0" name="p_fileids' + upload_infotype + '[]"></div><div class="fun"><a href="javascript:void(0);" class="label_pic" onClick="prevOrNextFun(this)">设为首图</a><a class="del_pic" href="javascript:void(0);" onClick="fun_hide_p(this);swfu' + upload_infotype + '.setButtonDisabled(false);">删除</a><a class="del_left" href="javascript:void(0);"  onClick="prevOrNextFun(this)">左移</a><a class="del_right" href="javascript:void(0);" onClick="prevOrNextFun(this)">右移</a> <p class="fun-bg">背景</p></div><span class="first-img"></span></div>';
    } else {
      var content = '<div class="add_item_pic"><div class="pic"><img height="100" width="130" src="' + src + '"><input class="hidden_1" type="hidden" value="' + src + '" name="p_filename' + upload_infotype + '[]"><input class="hidden_2" type="hidden" value="0" name="p_fileids' + upload_infotype + '[]"></div><div class="fun"><a href="javascript:void(0);" class="label_pic" onClick="prevOrNextFun(this)">设为首图</a><a class="del_pic" href="javascript:void(0);" onClick="fun_hide_p(this);swfu' + upload_infotype + '.setButtonDisabled(false);">删除</a><a class="del_left" href="javascript:void(0);"  onClick="prevOrNextFun(this)">左移</a><a class="del_right" href="javascript:void(0);" onClick="prevOrNextFun(this)">右移</a> <p class="fun-bg">背景</p></div><span class="first-img"></span></div>';
    }
    $("#" + upload_nail).append(content);
  } else {
    $("#jsPicPreviewBoxM1").find(".progressBarStatus").html(src);
  }
}
//删除图片
