...
function uploadSuccess(file, serverData) {
  try {
    ...
    addImage(serverData, this.customSettings.upload_infotype, this.customSettings.upload_nail);
    ...
    var content = '<div class="mItem" style="">\n\
                            <div class="mItemInner">\n\
                                <div class="mPic">\n\
                                    ...
                                    <div class="funMtext">\n\
                                        <div  title="???" id="' + upload_infotype + '" class="delBtn" onclick="delImg(this);del(' + upload_infotype + ');" >删除</div>\n\
                                    </div>\n\
                                </div>\n\
                            </div>\n\
                        </div>';
