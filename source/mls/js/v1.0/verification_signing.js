    ...
    $.ajax({
      ...
      success: function (data) {
        if (data['result'] == 'ok') {
          ...
          openWin('js_pop');
          setTimeout(function () {
            location.href = "/collocation_contract/index"
          }, 2000);
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data['result'] == 'ok') {
          ...
          if (action == '1') {
            setTimeout(function () {
              location.href = "/collocation_contract/contract_detail/" + c_id + "/4"
            }, 2000);
          } else if (action == '2') {
            setTimeout(function () {
              location.href = "/collocation_contract/rent_contract_list/"
            }, 2000);
          }
          ...
          if (action == '1') {
            setTimeout(function () {
              location.href = "/collocation_contract/index" + c_id + "/4"
            }, 2000);
          } else if (action == '2') {
            setTimeout(function () {
              location.href = "/collocation_contract/rent_contract_list/"
