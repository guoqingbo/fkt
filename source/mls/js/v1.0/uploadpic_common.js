...
function addImage(src, upload_infotype, upload_nail) {
  ...
  if ($("#" + upload_nail + " img").size() >= oSwfu.customSettings.upload_limit) {
    ...
    $("#" + upload_nail).html('');
    var content = '<div class="add_item_pic"><div class="pic"><img height="100" width="130" src="' + src + '"></div><input type="hidden" value="' + src + '" name="photo"><div class="fun"><a class="del_pic" href="javascript:void(0)" id="' + upload_infotype + '" onClick="fun_hide_p(this)">删除</a> </div></div>';
