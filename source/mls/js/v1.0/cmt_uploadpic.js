...
function addImage(src, upload_infotype, upload_nail) {
  ...
  var content = '<div class="add_item1"><div class="pic"><img class="photo-over" height="60" width="80" src="' + src + '"></div><input type="hidden" value="' + src + '" name="p_filename' + upload_infotype + '[]"><input type="hidden" value="0" name="p_fileids' + upload_infotype + '[]"><div class="fun"><a class="del_pic" href="javascript:void(0)" id="' + upload_infotype + '" onClick="fun_hide_p(this);swfu' + upload_infotype + '.setButtonDisabled(false);">删除</a> </div></div>';
  $("#" + upload_nail).before(content);
  $(".photo-anniu").show();
}
